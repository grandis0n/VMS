...
Процедура ЗаполнитьТаблицуРегионов()
	...
	|	ЕСТЬNULL(РегистрНастроек.РегистрацияВНалоговомОргане,
	...
	|ИЗ
	|	Регионы КАК Регионы
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.НастройкиУчетаНалогаНаПрибыльГруппОбособленныхПодразделений.СрезПоследних(&Период,
	|			Организация = &Организация) КАК РегистрНастроек
	...
	Пока ВыборкаПоРегионам.Следующий() Цикл
		...
		СтрокаРегиона.Наименование = АдресныйКлассификаторБП.ПредставлениеРегионаПоКоду(
