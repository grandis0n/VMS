...
Процедура ПредставлениеКонтрагентаОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИннЗаполнен = ЗначениеЗаполнено(СтрЗаменить(КонтрагентИНН, "0", ""));
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "СоздатьКонтрагентаИнтерактивно" Тогда
		...
		КонецЕсли;
		ВидКонтрагента = ОбменСКонтрагентамиКлиентСервер.ВидКонтрагента(КонтрагентИНН, ТипКонтрагента);
...
Процедура ЗаполнитьДанные()
	...
	Автоматическое             = ДанныеПриглашения.Автоматическое;
	ТипКонтрагента = ДанныеПриглашения.ТипПользователя;
	
	СоздаватьКонтрагентовАвтоматически = НастройкиЭДО.СоздаватьКонтрагентовАвтоматически()
		И НЕ ТрансграничныйЭДО.ЗапрещеноАвтосозданиеКонтрагента(ИдентификаторКонтрагента);
...
Процедура НастроитьФорму()
	...
	Элементы.Отозвать.Заголовок = ?(Автоматическое, Нстр("ru = 'Разорвать связь'"), Нстр("ru = 'Отозвать приглашение'"));
...
Процедура УстановитьСтраницуСтатуса()
	...
	Если СтатусПодключения = Перечисления.СтатусыПриглашений.Принято И Автоматическое Тогда
		ИмяЭлемента = "ПринятоАвтоматически";
	Иначе
