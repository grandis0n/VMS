...
Функция ПредставлениеДокумента(ДокументСсылка, Знач МетаданныеДокумента = Неопределено) Экспорт
	...
	ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ЗаявлениеОВвозеТоваров") Тогда
		ВидОперации = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументСсылка, "ВидОперации");
		СтруктураПредставления = Документы.ЗаявлениеОВвозеТоваров.ПолучитьПредставлениеДокумента(
