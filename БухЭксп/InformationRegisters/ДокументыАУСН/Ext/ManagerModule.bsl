...
//  Идентификатор - Строка - поиск по идентификатору документа
//
// Возвращаемое значение:
...
//
Функция НайтиДокументы(Статус = Неопределено, Идентификатор = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(Идентификатор) Тогда
		ОператорЗапроса.Отбор.Добавить("ДокументыАУСН.Идентификатор = &Идентификатор");
	КонецЕсли;
