...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.ОрганизацияСсылка) Тогда
		...
		ЗаписьПоОрганизации = РегистрыСведений.УдалитьНастройкиОбменаБанкРоссии.СоздатьМенеджерЗаписи();
...
Процедура СертификатАбонентаПредставлениеОткрытие(Элемент, СтандартнаяОбработка)
	...
	Сертификат.Вставить("Отпечаток", Запись.СертификатАбонентаОтпечаток);
