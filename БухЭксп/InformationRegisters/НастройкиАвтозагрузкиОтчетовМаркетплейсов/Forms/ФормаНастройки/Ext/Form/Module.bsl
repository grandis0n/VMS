...
&НаКлиенте
Процедура СменаТипаТокенаWB(Команда)
...
Процедура ОткрытьНастройкуМаркетплейса(Маркетплейс, КоличествоНастроек = 0)
	...
	КонецЕсли;
	ПараметрыФормы.Вставить("ВидОперации", "ЗагрузкаОтчета");
	ЗначенияЗаполнения = Новый Структура("ВидМаркетплейса", Маркетплейс);
	ПараметрыФормы.Вставить("ЗначенияЗаполнения", ЗначенияЗаполнения);
...
Процедура УправлениеВидимостью()
	...
	Если КоличествоWB = 0 Тогда
		...
		Элементы.СменаТипаТокенаWB.Видимость = Ложь;
	Иначе
		...
		КонецЕсли;
		Элементы.СменаТипаТокенаWB.Видимость = ЕстьЛимитированныеТокеныWB;
	КонецЕсли;
...
Процедура ЗаполнитьНастройки()
	...
	НастройкиИнтеграцииСЛимитированнымиТокенамиWB = ИнтеграцияWildberries.НастройкиИнтеграцииСЛимитированнымиТокенами();
	ЕстьЛимитированныеТокеныWB = ЗначениеЗаполнено(НастройкиИнтеграцииСЛимитированнымиТокенамиWB);
