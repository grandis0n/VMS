...
Функция НоменклатураПоШтрихкодам(СписокШтрихкодов, ТочноеСоответствие) Экспорт
	...
	|	ОписаниеНоменклатурыИС.КлючВидовПродукции КАК КлючВидовПродукцииИС,
	...
	|		ПО ШтрихкодыНоменклатуры.Номенклатура = ОписаниеНоменклатурыИС.Номенклатура 
...
Функция НовыйТаблицаНоменклатурыПоШтрихкоду()
	...
	ТаблицаНоменклатуры.Колонки.Добавить("ВидПродукцииИС", ,          Новый ОписаниеТипов("СправочникСсылка.ВидыПродукцииИС"));
	ТаблицаНоменклатуры.Колонки.Добавить("КлючВидовПродукцииИС", ,    Новый ОписаниеТипов("СправочникСсылка.КлючиВидовПродукцииИС"));
