...
&НаКлиенте
Процедура ДекорацияЗагрузкаВыпискиОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДекорацияПроверкаРасчетаНДФЛОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("Отбор", Новый Структура("Организация", Объект.Организация));
	ОткрытьФорму("Документ.СписаниеСРасчетногоСчета.Форма.ФормаРасчетыНДФЛАУСН", ПараметрыФормы, ЭтотОбъект);
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ГруппаРезультатЗагрузкаВыписки.Видимость = Форма.ПрименяетсяАУСН И Форма.МожемПередатьНДФЛИзПрограммы;
	Элементы.ГруппаРезультатПроверкаРасчетаНДФЛ.Видимость = Форма.ПрименяетсяАУСН И Форма.МожемПередатьНДФЛИзПрограммы;
