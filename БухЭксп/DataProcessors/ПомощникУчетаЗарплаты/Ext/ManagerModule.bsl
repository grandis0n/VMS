...
Процедура ПодготовитьСведенияОВыплатеЗаработнойПлаты(ПараметрыОбработки)
	...
	|	СУММА(ВЫБОР
	|			КОГДА ВедомостьНаВыплатуЗарплатыВБанкНДФЛ.Ссылка ЕСТЬ NULL
	|				ТОГДА 0
	|			ИНАЧЕ ВедомостьНаВыплатуЗарплатыВБанкНДФЛ.Сумма + ВедомостьНаВыплатуЗарплатыВБанкНДФЛ.СуммаСПревышения + ВедомостьНаВыплатуЗарплатыВБанкНДФЛ.СуммаСПревышенияПоСтавке18 + ВедомостьНаВыплатуЗарплатыВБанкНДФЛ.СуммаСПревышенияПоСтавке20 + ВедомостьНаВыплатуЗарплатыВБанкНДФЛ.СуммаСПревышенияПоСтавке22
	|		КОНЕЦ) КАК СумаНДФЛПоДокументу
	|ИЗ
