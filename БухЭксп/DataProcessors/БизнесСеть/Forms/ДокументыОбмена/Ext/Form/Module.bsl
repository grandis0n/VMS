...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимИсходящихДокументов Тогда
		...
		НавигационнаяСсылка = ПолучитьНавигационнуюСсылку(Метаданные.Обработки.БизнесСеть.Команды.ИсходящиеДокументы);
	...
	Иначе
		...
		НавигационнаяСсылка = ПолучитьНавигационнуюСсылку(Метаданные.Обработки.БизнесСеть.Команды.ВходящиеДокументы);
...
Процедура НастроитьПолеВыбораОрганизации()
	...
	ПодключенныеОрганизации = БизнесСеть.ДоступныеПодключенныеОрганизации();
