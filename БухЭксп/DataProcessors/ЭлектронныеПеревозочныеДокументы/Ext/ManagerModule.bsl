...
Функция ЗапросПоДокументуОснования() Экспорт
	...
	ТекстЗапроса = 
		...
		|ГДЕ
		|	ЭлектронноеПоручениеЭкспедиторуДокументыОснования.ДокументОснование В (&ДокументОснование)
		|СГРУППИРОВАТЬ ПО
		|	ЭлектронноеПоручениеЭкспедиторуДокументыОснования.Ссылка
		|
		|ОБЪЕДИНИТЬ ВСЕ
		...
		|ГДЕ
		|	ЭлектроннаяЭкспедиторскаяРаспискаДокументыОснования.ДокументОснование В (&ДокументОснование)
		|СГРУППИРОВАТЬ ПО
		|	ЭлектроннаяЭкспедиторскаяРаспискаДокументыОснования.Ссылка
		|
		|ОБЪЕДИНИТЬ ВСЕ
		...
		|ГДЕ
		|	ЭлектроннаяCкладскаяРаспискаДокументыОснования.ДокументОснование В (&ДокументОснование)
		|СГРУППИРОВАТЬ ПО
		|	ЭлектроннаяCкладскаяРаспискаДокументыОснования.Ссылка
		|;
		|////////////////////////////////////////////////////////////////////////////////
