...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Мобильный клиент
	МобильныйЭДОПриСозданииНаСервере(Отказ);
...
#Область МобильныйЭДО

Процедура МобильныйЭДОПриСозданииНаСервере(Отказ)
	...
	Элементы.ВашиОрганизации.РастягиватьПоГоризонтали = Истина;
	Элементы.ГруппаФлажки.РастягиватьПоГоризонтали = Ложь;
	
	ЭлементыСтиля = ИнтерфейсМобильногоЭДОПовтИсп.ЭлементыСтиля();
	
	ИнтерфейсМобильногоЭДОКлиентСервер.ОформитьАкцентнуюКнопку(ЭлементыСтиля,
		Элементы.ОтправитьИПолучить);
