...
&НаКлиенте
Процедура ОбучениеРаботеВБизнесСтартНажатие(Элемент)
...
Процедура ПодготовитьФормуНаСервере()
	...
	ПоказатьОбучение = Обработки.ОбучениеРаботеВБизнесСтарт.ОбучениеДоступно();
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ГруппаОбучение.Видимость               = Форма.ПоказатьОбучение;
