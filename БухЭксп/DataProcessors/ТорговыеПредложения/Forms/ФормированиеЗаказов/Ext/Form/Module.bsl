...
Функция ВыполнитьЗаданиеВФоне(Знач Задание)
	...
	Если Задание.Наименование = НаименованиеДлительнойОперацииФормированиеДокументов() Тогда
		...
		Задание.ПараметрыПроцедуры.Вставить("Товары", Товары.Выгрузить());
		...
		ИменаКолонокКонтрагентовДляДоставки = 
			"ИдентификаторКонтрагента, Контрагент, СпособДоставки, АдресДоставки, АдресДоставкиЗначенияПолей";
		Доставка = Контрагенты.Выгрузить(, ИменаКолонокКонтрагентовДляДоставки);
		ДополнительныеПараметрыПроцедуры.Вставить("Доставка", Доставка);
	...
	ИначеЕсли Задание.Наименование = НаименованиеДлительнойОперацииОтправкаДокументовПоставщику() Тогда
		...
		Задание.ПараметрыПроцедуры.Вставить("Заказы", Заказы.Выгрузить());
