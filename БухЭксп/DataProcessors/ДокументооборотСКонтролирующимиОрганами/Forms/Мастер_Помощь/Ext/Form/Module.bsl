...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ДокументооборотСКОПовтИсп.ЭтоБизКуб() Тогда
		
		ИзменитьВидимостьКонтактнойИнформации("БизКуб");
		
	ИначеЕсли ПолучитьФункциональнуюОпцию("РаботаВМоделиСервиса") Тогда
		
		ИзменитьВидимостьКонтактнойИнформации("Фреш");
		
	КонецЕсли;
	
	Если НЕ ИнтерфейсыВзаимодействияБРО.ПодключенДокументооборотСКонтролирующимОрганом() Тогда
		Элементы.ЗаголовокОбратныйЗвонок.Видимость = Ложь;
...
&НаСервере
Процедура ИзменитьВидимостьКонтактнойИнформации(ВидПлатформы)
	
	Элементы.ТелефонОбщий.Видимость = Ложь;
	Элементы.EmailОбщий.Видимость = Ложь;
	
	Если ВидПлатформы = "Фреш" Тогда
		Элементы.ТелефонФреш.Видимость = Истина;
		Элементы.EmailФреш.Видимость = Истина;
	КонецЕсли;
	
	Если ВидПлатформы = "БизКуб" Тогда
		Элементы.ТелефонБизКуб.Видимость = Истина;
		Элементы.EmailБизКуб.Видимость = Истина;
	КонецЕсли;
