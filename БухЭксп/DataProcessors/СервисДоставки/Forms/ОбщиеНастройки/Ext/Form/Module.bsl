...
&НаКлиенте
Процедура ШаблонОчищаетПоляЗаказаПриИзменении(Элемент)
	ШаблонОчищаетПоляЗаказаПриИзмененииНаСервере();
КонецПроцедуры
...
Процедура ЗаписатьНастройкиПоУмолчанию(Отказ, ТекстОшибки)
	...
	Попытка
		...
		ЗаполнитьЗаписьЗначенияПоУмолчанию(НаборЗаписей, 
			СервисДоставкиКлиентСервер.ИмяНастройкиШаблонОчищаетПоляЗаказа());
...
&НаСервере
Процедура ШаблонОчищаетПоляЗаказаПриИзмененииНаСервере()
	
	ИмяНастройки = СервисДоставкиКлиентСервер.ИмяНастройкиШаблонОчищаетПоляЗаказа();
	
	РегистрыСведений.НастройкиОбщиеСервисДоставки.УстановитьЗначениеНастройки(
		ИмяНастройки, ТипГрузоперевозки, ЭтотОбъект[ИмяНастройки]);
