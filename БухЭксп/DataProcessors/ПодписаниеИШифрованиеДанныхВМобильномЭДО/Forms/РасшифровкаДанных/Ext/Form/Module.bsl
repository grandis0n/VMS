...
Процедура ПродолжитьОткрытиеЗавершение(Контекст, Результат = Неопределено)
	...
	ОповещениеПриступитьКРасшифровкеПослеЧтенияБиометрии =
		Новый ОписаниеОповещения("ПриступитьКРасшифровкеПослеЧтенияБиометрии", ЭтотОбъект);
...
Асинх Процедура РасшифроватьДанныеПослеВыполненияНаСторонеСервера(Результат, Контекст) Экспорт
	...
	Иначе
		...
		ПараметрыКомпонентыРутокен.ОписаниеОповещенияПослеОперации = Новый ОписаниеОповещения(
			"РасшифроватьДанныеПослеВыполненияНаСторонеКлиента",
			ЭтотОбъект,
			Контекст);
...
&НаКлиенте
Процедура ПриступитьКРасшифровкеПослеЧтенияБиометрии(Результат, ДополнительныеПараметры) Экспорт
