...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ВыполнениеСтроительныхРабот.Видимость = ЕстьПравоПросмотрРеализацияТоваровУслуг И Параметры.ЭтоТовары;
...
&НаКлиенте
Процедура ЭлектронныеПеревозочныеДокументы(Команда)
	
	ПараметрыФормы = Новый Структура("КлючНазначенияФормы", "ФормаСпискаЭПД");
	
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Обработка.ЭлектронныеПеревозочныеДокументы.Форма.ФормаСпискаЭПД",
...
&НаКлиенте
Процедура ВыполнениеСтроительныхРабот(Команда)
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("Заголовок", НСтр("ru='Выполнение строительных работ'"));
	
	ПростойИнтерфейсКлиент.ОткрытьФормуВОкнеФормы("Документ.РеализацияТоваровУслуг.Форма.ФормаСпискаСтроительныхРабот",
		ЭтотОбъект, ПараметрыФормы, , ОткрытыеФормы);
КонецПроцедуры
