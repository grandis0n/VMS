...
&НаКлиенте
Процедура АвизоПрочиеВходящие(Команда)
	
	УчетОбособленныхПодразделенийКлиент.ОткрытьАвизоПрочиеВходящие(ЭтотОбъект);
	
КонецПроцедуры

&НаКлиенте
Процедура АвизоПрочиеИсходящие(Команда)
	
	УчетОбособленныхПодразделенийКлиент.ОткрытьАвизоПрочиеИсходящие(ЭтотОбъект);
