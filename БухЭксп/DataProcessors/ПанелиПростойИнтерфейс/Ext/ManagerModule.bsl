...
Процедура ВидимостьКомандФормы_ПанельНастройки(Результат)
	...
	ФО_УстановкаМобильногоПриложения1СЭПД = ПолучитьФункциональнуюОпцию("УстановкаМобильногоПриложения1СЭПД");
	...
	Доступ_УстановкаМобильногоПриложения1СЭПД = ПравоДоступа("Использование", Метаданные.Обработки.ВзаимодействиеМПЭПД);
	...
	Результат.Вставить("ЭПД", Доступ_УстановкаМобильногоПриложения1СЭПД
		И ФО_УстановкаМобильногоПриложения1СЭПД);
...
Процедура ВидимостьКомандФормы_ПанельНастройкиИнтеграции(Результат)
	...
	Результат.Вставить("ИнтеграцияС1СДокументооборотом", ЭтоВерсияКОРП);
...
Процедура ВидимостьКомандФормы_ПанельНастройкиИнструменты(Результат)
	...
	Результат.Вставить("РаботаСНоменклатурой", Доступ_РаботаСНоменклатурой);
...
Процедура ЗаполнитьТаблицуПоиска_Основное(ТаблицаПоиска)
	...
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		"e1cib/command/Обработка.ПанелиПростойИнтерфейс.Команда.МобильныйКлиентБизнесСтарт",
		"ПанельНастройки", "МобильныйКлиентБизнесСтарт",
		НСтр("ru='1С:БизнесСтарт для мобильных устройств'"), НСтр("ru='1С:БизнесСтарт для мобильных устройств'"));
	
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		"e1cib/command/Обработка.ПанелиПростойИнтерфейс.Команда.МобильныйКлиент",
		"ПанельНастройки", "МобильныйКлиент",
		НСтр("ru='1С:Бухгалтерия для мобильных устройств'"), НСтр("ru='1С:Бухгалтерия для мобильных устройств'"));
	
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		"e1cib/command/Обработка.ПанелиПростойИнтерфейс.Команда.МобильныеПриложенияРаспознаванияДокументов",
		"ПанельНастройки", "СканерДокументов",
		НСтр("ru='1С:Сканер документов'"), НСтр("ru='Мобильные приложения, с помощью которых можно отправлять фотографии на распознавание'"));
		
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		"e1cib/command/Обработка.ПанелиПростойИнтерфейс.Команда.МобильноеПриложение1СЭПД",
		"ПанельНастройки", "ЭПД",
		НСтр("ru='1С:ЭПД'"), НСтр("ru='Мобильные приложения для работы с сервисом 1С:ЭПД'"));
...
Процедура ЗаполнитьТаблицуПоиска_НастройкиУчета(ТаблицаПоиска)
	...
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		"e1cib/list/РегистрСведений.СчетаУчетаНоменклатуры",
		"ПанельНастройкиНастройкиУчета", "СчетаУчетаНоменклатуры",
		НСтр("ru='Счета учета номенклатуры'"), НСтр("ru='Счета учета номенклатуры'"));
...
Процедура ЗаполнитьТаблицуПоиска_НастройкиИнтеграции(ТаблицаПоиска)
	...
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		...
		"ПанельНастройкиИнтеграции", "ИнтеграцияС1СДокументооборотом",
		НСтр("ru='Интеграция с 1С:Документооборотом'"), НСтр("ru='Интеграция с 1С:Документооборотом'"));
	
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		"e1cib/command/РегистрСведений.НастройкиИнтеграцииBnovo.Команда.НастройкаИнтеграцииBnovo",
		"ПанельНастройкиИнтеграции", "ИнтеграцияBNovo",
		НСтр("ru='Интеграция с Bnovo'"), НСтр("ru='Интеграция с Bnovo'"));
	
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		"e1cib/command/Обработка.ПанельАдминистрированияБП.Команда.ИнтеграцияСервисыДоставки",
		"ПанельНастройкиИнтеграции", "ИнтеграцияСервисыДоставки",
		НСтр("ru='Интеграция с сервисами доставки'"), НСтр("ru='Интеграция с сервисами доставки'"));
	
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		"e1cib/command/РегистрСведений.НастройкиYclients.Команда.ОбменСYclients",
		"ПанельНастройкиИнтеграции", "ОбменСYclients",
		НСтр("ru='Загрузка продаж из YCLIENTS'"), НСтр("ru='Загрузка продаж из YCLIENTS'"));
...
Процедура ЗаполнитьТаблицуПоиска_НастройкиИнструменты(ТаблицаПоиска)
	...
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		"e1cib/command/Справочник.ХранилищеШаблонов.Команда.ШаблоныЦенниковИЭтикеток",
		"ПанельНастройкиИнструменты", "ШаблоныЦенниковИЭтикеток",
		НСтр("ru='Шаблоны ценников и этикеток'"), НСтр("ru='Шаблоны ценников и этикеток'"));
	...
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		...
		"ПанельНастройкиИнструменты", "ОбменСОфлайнОборудованием",
		НСтр("ru='Обмен с подключаемым оборудованием offline'"),
		НСтр("ru='Обмен с подключаемым оборудованием offline'"));
	
	ДобавитьСтрокуВТаблицуПоиска(ТаблицаПоиска,
		"e1cib/app/Обработка.ПомощникПереходаСУСННаОСНО",
		"ПанельНастройкиИнструменты", "ПомощникПереходаСУСННаОСНО",
		НСтр("ru='Помощник перехода с УСН на ОСНО'"),
		НСтр("ru='Помощник перехода с УСН на ОСНО'"));
