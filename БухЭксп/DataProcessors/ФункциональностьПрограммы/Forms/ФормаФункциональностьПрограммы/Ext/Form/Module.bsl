...
&НаКлиенте
Процедура ЗакладкиИспользоватьУпаковкиНоменклатуры(Элемент)
...
&НаКлиенте
Процедура ГлавноеВестиСведенияДляДекларацийПоАлкогольнойПродукцииНажатие(Элемент)
	ОбработатьНажатиеОшибки(Элемент, "Главное");
КонецПроцедуры

&НаКлиенте
Процедура ГлавноеВестиУчетПодконтрольныхТоваровВЕТИСНажатие(Элемент)
	ОбработатьНажатиеОшибки(Элемент, "Главное");
КонецПроцедуры

&НаКлиенте
Процедура ГлавноеВестиУчетЗернаИПродуктовПереработкиЗЕРНОНажатие(Элемент)
	ОбработатьНажатиеОшибки(Элемент, "Главное");
КонецПроцедуры

&НаКлиенте
Процедура ГлавноеВестиУчетПестицидовАгрохимикатовТукосмесейСАТУРННажатие(Элемент)
	ОбработатьНажатиеОшибки(Элемент, "Главное");
КонецПроцедуры
