...
&НаКлиенте
Процедура ИспользоватьТорговыеПредложенияПриИзменении(Элемент)
...
Процедура ПрочитатьУстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если ЕстьТорговыеПредложения
		И (РеквизитПутьКДанным = "Константа_НеПоказыватьРекомендацииБизнесСеть" 
		ИЛИ РеквизитПутьКДанным = "Константа_ИспользоватьТорговыеПредложения" 
		ИЛИ РеквизитПутьКДанным = "") Тогда
		
		Константа_ПоказыватьРекомендацииБизнесСеть = Константы["ПоказыватьРекомендацииБизнесСеть"].Получить();
		Константа_ИспользоватьТорговыеПредложения = Константы["ИспользоватьТорговыеПредложения"].Получить();
		
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
			"ГруппаНастройкиБизнесСетьТорговыеПредложенияПубликация", "Доступность", Константа_ИспользоватьТорговыеПредложения);
	КонецЕсли;
