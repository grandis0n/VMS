...
Процедура НаСменуРаздела(Кэш) Экспорт
	...
	Если ЗначениеЗаполнено(МестныйКэш.Парам.ФильтрыПоРазделам["Полученные"]) Тогда
		МестныйКэш.ГлавноеОкно.сбисВосстановитьФильтр(МестныйКэш, МестныйКэш.Парам.ФильтрыПоРазделам["Полученные"]);
	Иначе
		ФильтрОчистить(МестныйКэш);
	КонецЕсли;
