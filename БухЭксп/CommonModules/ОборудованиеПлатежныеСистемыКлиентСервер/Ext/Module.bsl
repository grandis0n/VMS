...
Функция ПараметрыВыполненияЭквайринговойОперации() Экспорт;
	...
	Результат.Вставить("СкидкаЭлектроннымиСертификатами", 0); // Число,Необязательно - Сумма скидки за счет электронных сертификатов.  
	...
	Результат.Вставить("ИдентификаторОперацииНаОборудовании");  // Строка,Необязательно - Идентификатор операции на оборудовании.
	// Расширение
...
Функция ПолучитьXMLПакетДляОперации(ПараметрыОперации) Экспорт
	...
	Если ПараметрыОперации.Свойство("ИдентификаторОперацииНаОборудовании") И Не ПустаяСтрока(ПараметрыОперации.ИдентификаторОперацииНаОборудовании) Тогда   
		ЗаписьXML.ЗаписатьАтрибут("RequestID",  XMLСтрока(ПараметрыОперации.ИдентификаторОперацииНаОборудовании)); 
	КонецЕсли;
	...
	СкидкаЭлектроннымиСертификатами = ?(ПараметрыОперации.СкидкаЭлектроннымиСертификатами <> Неопределено, ПараметрыОперации.СкидкаЭлектроннымиСертификатами, 0);
	ЗаписьXML.ЗаписатьАтрибут("ElectronicCertificateDiscount", XMLСтрока(СкидкаЭлектроннымиСертификатами));
