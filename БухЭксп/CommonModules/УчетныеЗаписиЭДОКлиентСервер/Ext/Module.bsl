...
Функция НовоеОписаниеУчетнойЗаписи() Экспорт
	...
	Данные.Вставить("НеИспользоватьПриглашения", Ложь);
	Данные.Вставить("ВидУчетнойЗаписи", ПредопределенноеЗначение("Перечисление.ВидУчетнойЗаписиЭДО.ПустаяСсылка"));
	Данные.Вставить("КодыТиповДокументовКОбмену", Новый Массив);
...
// Параметры:
//  КодыТиповДокументов - ДанныеФормыКоллекция - Коды типов документов
// 
// Возвращаемое значение:
//  Массив из Строка - Коды типов выбранных документов
Функция КодыТиповДокументов(КодыТиповДокументов) Экспорт
	
	КодыТипов = Новый Массив;
	Для Каждого КодТипа Из КодыТиповДокументов Цикл
		Если КодТипа.Используется Тогда
			КодыТипов.Добавить(КодТипа.Код);
		КонецЕсли;
	КонецЦикла;
...
//   * АдресОрганизацииЗначение - Строка - адрес организации.
...
//   * НеИспользоватьПриглашения - Неопределено,Булево - признак необходимости получения приглашения перед началом ЭДО.
//   * КодыТиповДокументовКОбмену - Массив из Строка - Коды типов документов, указанные для обмена
//   * Комментарий - Строка
//   * Должность - Строка
//
Функция НовыеПараметрыПодключенияЭДО() Экспорт
	...
	Параметры.Вставить("ВидУчетнойЗаписи", ПредопределенноеЗначение("Перечисление.ВидУчетнойЗаписиЭДО.ПустаяСсылка"));
	...
	Параметры.Вставить("НеИспользоватьПриглашения", Неопределено);
	Параметры.Вставить("КодыТиповДокументовКОбмену", Новый Массив);
...
// Возвращаемое значение:
//  Булево - Признак, определяющий нужно ли получать приглашение от контрагента, прежде чем он сможет направлять электронные документы.
Функция ТребоватьПриглашенияПередНачаломЭДОЗначениеПоУмолчанию() Экспорт
...
// Возвращаемое значение:
//  Строка - количество символов, являющееся минимальной допустимой длиной назначения учетной записи ЭДО
Функция МинимальнаяДопустимаяДлинаНазначенияУчетнойЗаписи() Экспорт
