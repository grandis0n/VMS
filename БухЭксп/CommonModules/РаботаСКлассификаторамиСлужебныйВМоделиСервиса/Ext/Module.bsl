...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса.БазоваяФункциональность") Тогда
		Методы.Вставить("ОбновлениеРазделенныхДанныхНеРазделенногоКлассификатора");
		Методы.Вставить("ЗапланироватьОбновлениеДанныхОбластей");
		Методы.Вставить("ОбновлениеРазделенногоКлассификатора");
		Методы.Вставить("УдалитьКэшПоставляемыхКлассификаторов");
	КонецЕсли;
