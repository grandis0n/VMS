...
Процедура ЭтоФормаОбъекта(Форма, ЭтоФормаОбъекта) Экспорт
	...
	ЗарплатаКадрыБазовый.ЭтоФормаОбъекта(Форма, ЭтоФормаОбъекта);
...
Процедура ИмяРеквизитаФормыСодержащегоИнтегрируемыйОбъект(Форма, ИмяРеквизита) Экспорт
	...
	ЗарплатаКадрыБазовый.ИмяРеквизитаФормыСодержащегоИнтегрируемыйОбъект(Форма, ИмяРеквизита);
...
Процедура ТаблицаДанныхНСИДляВыгрузки(СсылкиНаОбъектыНСИ, СвойстваОбъектаXDTO, ТаблицаНСИ) Экспорт
	...
	ЗарплатаКадрыБазовый.ТаблицаДанныхНСИДляВыгрузки(СсылкиНаОбъектыНСИ, СвойстваОбъектаXDTO, ТаблицаНСИ);
...
Процедура СоздатьДокументыБИА(СсылкаНаОбъектИсточник, ДокументыБИА) Экспорт
	...
	ЗарплатаКадрыБазовый.СоздатьДокументыБИА(СсылкаНаОбъектИсточник, ДокументыБИА);
