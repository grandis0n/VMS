...
Функция ПодготовитьДанныеДляПодписанияНаРегистрациюВЭДО(ПараметрыРегистрации) Экспорт
	...
	КонецЕсли;
	Если ЗначениеЗаполнено(ПараметрыРегистрации.ВидУчетнойЗаписи) Тогда
		ДанныеОрганизации.ВидОрганизации = Перечисления.ВидУчетнойЗаписиЭДО.ВидОрганизацииПоВидуУчетнойЗаписи(ПараметрыРегистрации.ВидУчетнойЗаписи);
	КонецЕсли;
...
Процедура ЗафиксироватьНачалоПереходаВЦентрЭДО(ИдентификаторЭДО, УчетнаяЗаписьЦентраЭДО) Экспорт
	...
	Попытка
		...
		УчетныеЗаписиЭДО.УстановитьПризнакПереходаВЦентрЭДО(ИдентификаторЭДО);
...
//  * ВидОрганизации - Строка - ЮЛ, ИП, ФЛ
Функция НовыеДанныеОрганизацииДляРегистрацииВЭДО()
	...
	Данные.Вставить("ВидОрганизации", "");
	Возврат Данные;
КонецФункции
