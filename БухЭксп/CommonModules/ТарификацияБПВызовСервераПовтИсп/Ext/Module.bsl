...
// Возвращает Истина, если тариф не предусматривает ведение раздельного учета НДС,
// но у пользователя включен раздельный учет НДС.
// 
// Возвращаемое значение:
//   Булево
//
Функция ИспользуетсяНеразрешенныйРаздельныйУчетНДС() Экспорт
	
	УстановитьПривилегированныйРежим(Истина);
	
	ИспользуетсяНеразрешенныйРУНДС =
		РегистрыСведений.НастройкиУчетаНДС.ЕстьИспользованиеРаздельногоУчетаНДСБезТарифа();
	
	УстановитьПривилегированныйРежим(Ложь);
	
	Возврат ИспользуетсяНеразрешенныйРУНДС;
