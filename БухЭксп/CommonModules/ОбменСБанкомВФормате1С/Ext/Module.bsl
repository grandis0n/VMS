...
Функция НовыйДанныеИзБанка(ВерсияФормата = "1.03") Экспорт
	...
	ДанныеИзБанка.Документы.Колонки.Добавить("MCC",               ОбщегоНазначения.ОписаниеТипаСтрока(4));
	ДанныеИзБанка.Документы.Колонки.Добавить("ПлатежнаяСсылкаЦР", ТипСтрока);
...
Функция ЭлементыРеквизитовСчетаУчастника() Экспорт
	...
	ЭлементыРеквизитовСчетаУчастника.Добавить("ИдентификаторЦифровогоСчета");
