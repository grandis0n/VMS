...
// Проверяет наличие действующих патентов за указанный период по указанной организации.
//
// Параметры:
//  Организация - СправочникСсылка.Организации - Организация, для которой необходимо получить данные.
//  ДатаНачала - Дата - Дата начала проверяемого периода.
//  ДатаОкончания - Дата - Дата окончания проверяемого периода.
//
// Возвращаемое значение:
//  Булево - если Истина, имеется как минимум один патент, действующий в указанный период.
//
Функция ИмеютсяДействующиеПатентыЗаПериод(Организация, ДатаНачала, ДатаОкончания) Экспорт
