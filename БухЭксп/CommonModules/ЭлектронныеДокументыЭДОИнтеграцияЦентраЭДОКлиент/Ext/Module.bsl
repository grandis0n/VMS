...
Процедура ЗапуститьВыгрузкуВЦентрЭДО(ИдентификаторЭДО, ФормаВладелец) Экспорт
	...
	Оповещение = Новый ОписаниеОповещения("ЗапуститьВыгрузкуВЦентрЭДОПослеПодтверждения", ЭтотОбъект);
	ОткрытьФорму("РегистрСведений.СостоянияВыгрузкиВЦентрЭДО.Форма.ЗапускВыгрузки",
		ПараметрыФормы, ФормаВладелец,,,,Оповещение);
...
Процедура ОбработатьРезультатВыполненияДействийЭДОПослеОжиданияДействийЭДО(РезультатыДействий, КонтекстОбработки) Экспорт
	...
	Для Каждого РезультатДействийПоУчетнойЗаписи Из КонтекстОбработки.РезультатыДействий Цикл
		...
		Если ЗашифрованныеМаркеры <> Неопределено Тогда
...
// Параметры:
//  ПараметрыВыгрузки - Неопределено,Структура:
//  * ИдентификаторЭДО - Строка
//  * ДатаВыгрузкиДокументов - Дата
//  * ВыгружатьНезавершенные - Булево
//  Контекст - Неопределено
Процедура ЗапуститьВыгрузкуВЦентрЭДОПослеПодтверждения(ПараметрыВыгрузки, Контекст = Неопределено) Экспорт
	...
	СостояниеВыгрузки = ЭлектронныеДокументыЭДОИнтеграцияЦентраЭДОВызовСервера.ЗапуститьВыгрузкуВЦентрЭДО(
		ПараметрыВыгрузки.ИдентификаторЭДО,
		ПараметрыВыгрузки.ДатаВыгрузкиДокументов,
		ПараметрыВыгрузки.ВыгружатьНезавершенные);
	...
	ДействиеПриНажатии = Новый ОписаниеОповещения("ОткрытьФормуСостоянияВыгрузкиВЦентрЭДОПослеЗапуска",
		ЭлектронныеДокументыЭДОИнтеграцияЦентраЭДОКлиент, ПараметрыВыгрузки.ИдентификаторЭДО);
