...
// Возвращаемое значение:
//  См. ДлительныеОперации.ВыполнитьФункцию
Функция СформироватьПриглашенияВФоне(Знач Приглашения) Экспорт
	
	ПараметрыВыполненияВФоне = ДлительныеОперации.ПараметрыВыполненияФункции(Новый УникальныйИдентификатор);
	
	// см. ПриглашенияЭДОИнтеграцияЦентраЭДО.СформироватьПриглашенияВЦентреЭДО
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполненияВФоне,
		"ПриглашенияЭДОИнтеграцияЦентраЭДО.СформироватьПриглашенияВЦентреЭДО", Приглашения);
