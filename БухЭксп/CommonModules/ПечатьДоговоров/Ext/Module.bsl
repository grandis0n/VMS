...
Функция ПараметрыДоговораДляОбъекта(СсылкаНаОбъект) Экспорт
	
	Результат = НовыйПараметрыДоговора();
	
	ДоговорКонтрагента = ПечатьДоговоров.ДоговорКонтрагентаДляОбъекта(СсылкаНаОбъект);
	
	Если ЗначениеЗаполнено(ДоговорКонтрагента) Тогда
		РеквизитыДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДоговорКонтрагента, 
			"ФайлДоговора, ЭлектронныйФормат, ЭтоГруппа");
...
Функция НовыйПараметрыДоговора()
	
	Результат = Новый Структура;
	Результат.Вставить("ФайлДоговора", Справочники.ДоговорыКонтрагентовПрисоединенныеФайлы.ПустаяСсылка());
	Результат.Вставить("ЭлектронныйФормат", Ложь);
