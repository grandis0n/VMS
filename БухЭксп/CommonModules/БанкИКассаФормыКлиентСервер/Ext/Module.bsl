...
Функция ЧекНПДСформирован(Форма) Экспорт
	
	ТребуетсяСформироватьЧек = ЧекиНПДКлиентСервер.НужноНачатьФормированиеЧека(Форма.СведенияОЧекеНПД);
	Возврат Не ТребуетсяСформироватьЧек;
