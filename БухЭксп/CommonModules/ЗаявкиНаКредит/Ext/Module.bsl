...
Функция ЭлектронноеПредставлениеСообщения(ВидСообщения, ПараметрыПредставления) Экспорт
	...
	ПотокКомпоновщика = Новый ПотокВПамяти;
	Компоновщик = УниверсальныйОбменСБанкамиОбщегоНазначения.НовыйКомпоновщикXML(ПотокКомпоновщика, ПараметрыПредставления.Кодировка);
	...
	Возврат УниверсальныйОбменСБанкамиОбщегоНазначения.ДвоичныеДанныеКомпоновщикаXML(Компоновщик, ПотокКомпоновщика);
