...
Функция ИспользоватьПолучениеЧерезИнтервал()
	...
	Возврат ЭлектронныеДокументыЭДО.ЕстьПравоОбработкиДокументов()
		И ЕстьУчетныеЗаписиДляПолучения()
...
Функция ПолучитьПоТокенамДоступаКСервисуЭДО(СостоянияПолучения)
	...
	Для Каждого ИдентификаторЭДО Из ИдентификаторыЧерезСервис1СЭДО Цикл
		...
		РезультатДействийЭДО = ВыполнитьДействияДляПолученияПоЭДО(ПараметрыВыполнения);
...
Функция ПолучитьПоДаннымРасшифрованногоМаркера(ИдентификаторЭДО, РасшифрованныеДанные,
	...
	Возврат ВыполнитьДействияДляПолученияПоЭДО(ПараметрыВыполнения);
...
// Параметры:
//  ПараметрыВыполнения - см. ПараметрыВыполненияДействийДляПолученияПоЭДО
// 
// Возвращаемое значение:
//  См. ЭлектронныеДокументыЭДОСлужебный.НовыйРезультатДействийПоЭДО
Функция ВыполнитьДействияДляПолученияПоЭДО(ПараметрыВыполнения)
	
	РезультатДействийЭДО = ЭлектронныеДокументыЭДОСлужебный.ВыполнитьДействияЭДО(ПараметрыВыполнения);
	
	ОтправитьИзвещенияПоПолученнымДокументамЭДО(ПараметрыВыполнения, РезультатДействийЭДО);
...
// Параметры:
//  ПараметрыВыполненияПоДокументамЭДО - см. ПараметрыВыполненияДействийДляПолученияПоЭДО
//  РезультатДействийПоДокументамЭДО - см. ЭлектронныеДокументыЭДОСлужебный.НовыйРезультатДействийПоЭДО
Процедура ОтправитьИзвещенияПоПолученнымДокументамЭДО(ПараметрыВыполненияПоДокументамЭДО, РезультатДействийПоДокументамЭДО)
	
	ДокументыДляОбработкиИзвещений = РезультатДействийПоДокументамЭДО.ДокументыДляОбработкиИзвещений;
	Если Не ЗначениеЗаполнено(ДокументыДляОбработкиИзвещений) Тогда
		Возврат;
	КонецЕсли;
	
	ПараметрыВыполнения = ЭлектронныеДокументыЭДОКлиентСервер.НовыеПараметрыВыполненияДействийПоЭДО();
	ПараметрыВыполнения.ОбъектыДействий.ЭлектронныеДокументы = ОбщегоНазначения.ВыгрузитьКолонку(
		ДокументыДляОбработкиИзвещений, "Ключ");
	ПараметрыВыполнения.ОтпечаткиСертификатов = ПараметрыВыполненияПоДокументамЭДО.ОтпечаткиСертификатов;
	ПараметрыВыполнения.РасшифрованныеМаркеры = ПараметрыВыполненияПоДокументамЭДО.РасшифрованныеМаркеры;
	ПараметрыВыполнения.ИспользоватьТокеныДоступа = ПараметрыВыполненияПоДокументамЭДО.ИспользоватьТокеныДоступа;
