...
// Возвращает структуру для создания нового контрагента по переданным реквизитам
//
// Возвращаемое значение:
//    Структура:
...
//     * ВидКонтрагента - Строка - ЮЛ, ИП, ФЛ
//     * GLN - Строка - 13 значный международный числовой код
Функция НовыйДанныеКонтрагента() Экспорт
	
	Данные = Новый Структура;
	Данные.Вставить("ИНН", "");
	Данные.Вставить("КПП", "");
	Данные.Вставить("Наименование", "");
	Данные.Вставить("ВидКонтрагента", "");
	Данные.Вставить("GLN", "");
...
// Определяет вид контрагента по ИНН и типу пользователя позволяя разделять ИП от ФЛ
//
// Параметры:
//  ИНН - Строка - 10 или 12 символов
//  ТипПользователя - Строка - ФЛ или ""
//
// Возвращаемое значение:
//  - Строка - "", ЮЛ, ИП, ФЛ
Функция ВидКонтрагента(ИНН, ТипПользователя = "") Экспорт
	
	Если СтрДлина(ИНН) = 10 Тогда
		Возврат "ЮЛ";
	ИначеЕсли СтрДлина(ИНН) = 12
			И Не ЗначениеЗаполнено(ТипПользователя) Тогда
		Возврат "ИП";
	ИначеЕсли СтрДлина(ИНН) = 12
			И ТипПользователя = "ФЛ" Тогда
		Возврат "ФЛ";
	КонецЕсли;
