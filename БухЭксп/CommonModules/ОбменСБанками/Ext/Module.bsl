...
#Область ПроверкаМетодовВызываемыхКакПроизвольныйКод
...
Процедура ПриНастройкеПроверкиМетодовВызываемыхКакПроизвольныйКод(Настройки) Экспорт
	...
	ИсключениеПроверки.ПолноеИмяОбъекта   = "ОбщийМодуль.ОбменСБанкамиСлужебный";
	ИсключениеПроверки.ИмяПроцедуры       = "СформироватьФайлыДокументов";
	ИсключениеПроверки.ФрагментСодержания =
		"ОбщегоНазначения.ВыполнитьМетодКонфигурации(МетодЗаполненияДанных, ПараметрыПроцедуры)";
	
	ИсключениеПроверки = Настройки.ИсключенияПроверки.Добавить();
	ИсключениеПроверки.ПолноеИмяОбъекта   = "ОбщийМодуль.ОбменСБанкамиСлужебный";
	ИсключениеПроверки.ИмяПроцедуры       = "СформироватьФайлыДокументов";
	ИсключениеПроверки.ФрагментСодержания =
		"ОбщегоНазначения.ВыполнитьМетодКонфигурации(МетодФормированияЭД, ПараметрыПроцедуры)";
