...
Функция ЗагрузитьХарактеристикиДляНоменклатурыВФоне(ПараметрыСоздания, Знач УникальныйИдентификатор, ИдентификаторЗадания) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("РаботаСНоменклатурой.ЗагрузитьХарактеристики", 
		ПараметрыСоздания, 
		ПараметрыВыполнения);
...
Функция ПолучитьДанныеХарактеристикВФоне(ПараметрыЗапросаХарактеристик, Знач УникальныйИдентификатор, ИдентификаторЗадания) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("РаботаСНоменклатурой.ПолучитьДанныеХарактеристикСервиса", 
		ПараметрыЗапросаХарактеристик, 
		ПараметрыВыполнения);
...
Функция ПроверитьИспользованиеОбъектаВФоне(
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("РаботаСНоменклатурой.ПроверитьИспользованиеОбъекта", 
		ПараметрыМетода, 
		ПараметрыВыполнения);
...
Функция ЗагрузитьДополнительныеДанныеВФоне(ПараметрыСоздания, Знач УникальныйИдентификатор, ИдентификаторЗадания) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("РаботаСНоменклатурой.ЗагрузитьДополнительныеДанные", 
		ПараметрыСоздания, 
		ПараметрыВыполнения);
