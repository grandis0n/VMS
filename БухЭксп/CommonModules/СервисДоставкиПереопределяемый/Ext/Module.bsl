...
Процедура ПриЗаполненииСервисовДоставки(ДоступныеСервисы, СтандартнаяОбработка) Экспорт
...
Процедура ПриОпределенииОрганизацийДоступныхПользователю(СписокОрганизаций, СтандартнаяОбработка) Экспорт
