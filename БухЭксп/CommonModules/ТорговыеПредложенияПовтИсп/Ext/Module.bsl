...
Функция СтавкаНДССериализованная(СтавкаНДС) Экспорт
	...
	ИначеЕсли ИмяСтавкиНДС = "НДС0"Тогда
		Результат = "VAT_0"
	ИначеЕсли ИмяСтавкиНДС = "НДС5" Или ИмяСтавкиНДС = "НДС5_105" Тогда
		Результат = "VAT_5"
	ИначеЕсли ИмяСтавкиНДС = "НДС7" Или ИмяСтавкиНДС = "НДС7_107" Тогда
		Результат = "VAT_7"
...
//
// Параметры:
//  СтавкаСтрокой	 - Строка - наименование ставки НДС (БезНДС, НДС5, НДС7, НДС10, НДС18, НДС20, НДС22).
// 
// Возвращаемое значение:
