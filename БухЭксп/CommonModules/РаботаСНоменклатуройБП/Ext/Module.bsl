...
// См. РаботаСНоменклатурой.РезультатПоискаНоменклатурыСервиса
// Обертка для запуска в фоне.
Функция РезультатПоискаНоменклатурыСервиса(Знач ПараметрыПоиска) Экспорт
	
	Возврат РаботаСНоменклатурой.РезультатПоискаНоменклатурыСервиса(ПараметрыПоиска);
...
//
Процедура ПриСозданииНаСервереФормаСпискаНоменклатуры(Форма, ГруппаРодитель, ЭлементДинамическийСписок) Экспорт
	...
	ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("РаботаСНоменклатурой_ИмяТаблицыФормы",
		Новый ОписаниеТипов("Строка")));
	ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("РаботаСНоменклатурой_ПравоИзмененияДанных",
		Новый ОписаниеТипов("Строка")));
		
	Форма.ИзменитьРеквизиты(ДобавляемыеРеквизиты);
	
	Форма.РаботаСНоменклатурой_ИмяТаблицыФормы = ЭлементДинамическийСписок.Имя; // кэширование имени таблицы
	Форма.РаботаСНоменклатурой_ПравоИзмененияДанных = РаботаСНоменклатурой.ПравоИзмененияДанных();
...
Процедура ДобавитьКомандыФормыСпискаНоменклатуры(Форма, ГруппаРодитель)
	...
	НоваяКомандаФормы.Заголовок = НСтр("ru = 'Номенклатуру из сервиса 1С:Номенклатура'");
	...
	НовыйЭлемент            = Форма.Элементы.Добавить("РаботаСНоменклатуройПодобратьНоменклатуруИзСервиса",
		Тип("КнопкаФормы"), ГруппаКнопок);
