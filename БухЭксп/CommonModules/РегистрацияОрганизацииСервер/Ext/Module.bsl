...
// Возвращает номера телефона в разрешенном формате для заполнения заявления на регистрацию ООО/ИП.
// Также может использоваться для заполнения уведомления о переходе на УСН.
//
// Параметры:
//   ЗначениеСтрокой - Строка - исходный номер телефона в произвольном формате
//   ИмяФормы - Строка - имя формы заявления на регистрацию ООО/ИП
//
// Возвращаемое значение:
//   Строка - номер телефона в разрешенном формате
//
Функция НомерТелефонаВРазрешенномФормате(ЗначениеСтрокой, ИмяФормы = Неопределено) Экспорт
