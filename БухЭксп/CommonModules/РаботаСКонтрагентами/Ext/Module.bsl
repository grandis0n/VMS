...
//    * ИНН - Строка - ИНН юридического лица.
//    * ЕГРЮЛ - Неопределено, Структура - сведения из ЕГРЮЛ:
//      ** ИНН - Строка - ИНН юридического лица.
//      ** КПП - Строка, Неопределено - КПП юридического лица.
//      ** Наименование - Строка, Неопределено - представление юридического лица в учетной программе.
//      ** НаименованиеПолное - Строка, Неопределено - полное наименование юридического лица.
//      ** НаименованиеСокращенное - Строка, Неопределено - сокращенное наименование юридического лица.
//      ** НаименованиеПолноеЕГРЮЛ - Строка, Неопределено - полное наименование юридического лица в ЕГРЮЛ.
//      ** НаименованиеСокращенноеЕГРЮЛ - Строка, Неопределено - сокращенное наименование юридического лица в ЕГРЮЛ.
...
//      ** РегистрационныйНомер - Строка, Неопределено - ОГРН юридического лица.
//      ** Статус - Неопределено, Структура - текущий статус юридического лица.
//                                            см. НовыйДанныеСтатуса.
//      ** РегистрирующийОрган - Неопределено, Структура - орган, зарегистрировавший юридическое лицо.
//                                                         см. НовыйДанныеРегистрирующегоОргана.
...
//      ** ЮридическийАдрес - Неопределено, Структура - данные о юридическом адресе:
...
//      ** ЭлектроннаяПочта - Строка, Неопределено - адрес электронной почты;
...
//                                             см. НоваяТаблицаРуководителей.
//      ** РегистрацияВНалоговомОргане - Неопределено, Структура - данные о регистрации в ИФНС.
//                                                                 см. НоваяРегистрацияВНалоговомОргане.
...
//      ** РегистрацияВПенсионномФонде - Неопределено, Структура - данные о регистрации в ПФР.
//                                                                 см. НоваяРегистрацияВПенсионномФонде.
//      ** РегистрацияВФСС - Неопределено, Структура - данные о регистрации в ФСС.
//                                                     см. НоваяРегистрацияВФСС.
//      ** РегистрацияВСФР - Неопределено, Структура - данные о регистрации в СФР.
//                                                     см. НоваяРегистрацияВСФР.
//      ** ВидДеятельности - Неопределено, Структура - описание основного вида экономической деятельности.
//                                                     см. НовыйОписаниеВидаДеятельности.
//      ** ОткрытыеГосударственныеДанныеФНС - ТаблицаЗначений - открытые государственные данные ФНС.
//                                                              см. НоваяТаблицаОткрытыеГосударственныеДанныеФНС.
//      ** ИсторияРеквизитов - Структура - история изменений реквизитов юридического лица.
//                                         см. НовыйИсторияРеквизитовЮридическогоЛица.
//      ** ОписаниеОшибки - Строка - текст ошибки при получении данных
//      ** КодОКВЭД - Строка, Неопределено - устарело, следует использовать ВидДеятельности.Код, код основного
//                                     вида деятельности по классификатору ОКВЭД.
//      ** ЭтоОКВЭД2 - Булево - устарело, следует использовать ВидДеятельности.Классификатор, код ОКВЭД
//                                      приведен по классификатору редакции 2 или редакции 1.
//      ** Руководитель - Неопределено, Структура - устарело, информация о руководителе:
//        *** Фамилия - Строка - фамилия руководителя;
//        *** Имя - Строка - имя руководителя;
//        *** Отчество - Строка - отчество руководителя;
...
//      ** РегистрацияВНалоговомОргане - Неопределено, Структура - информация о регистрации представительства в налоговом органе:
...
//      ** ЮридическийАдрес - Неопределено, Структура - юридический адрес:
//        *** КонтактнаяИнформация - Строка - данные в формате JSON для заполнения реквизита;
//          "Значение" контактной информации в табличной части КонтактнаяИнформация объекта
//          (см. описание подсистемы "Контактная информация" Библиотеки стандартных подсистем).
//        *** Представление - Строка - представление адреса;
...
//      ** Руководитель - Неопределено, Структура - информация о руководителе:
//        *** Фамилия - Строка - фамилия руководителя;
//        *** Имя - Строка - имя руководителя;
//        *** Отчество - Строка - отчество руководителя;
//        *** Представление - Строка - ФИО руководителя;
//        *** ДатаЗаписи - Дата - дата записи о руководителе;
//      ** Аккредитация - Неопределено, Структура - информация об аккредитации представительства. Поля:
...
//      ** ИностранноеЮридическоеЛицо - Неопределено, Структура - данные иностранной компании. Поля:
...
//    * ОписаниеОшибки - Строка, Неопределено - описание возникшей ошибки.
...
//    * Наименование - Неопределено, Строка - представление предпринимателя в учетной программе.
//    * НаименованиеПолное - Неопределено, Строка - фамилия, имя, отчество предпринимателя.
//    * НаименованиеСокращенное - Неопределено, Строка - фамилия, имя, отчество предпринимателя.
//    * ВидИП - Неопределено, Строка - вид предпринимателя.
//    * Фамилия - Неопределено, Строка - фамилия предпринимателя.
//    * Имя - Неопределено, Строка - имя предпринимателя.
//    * Отчество - Неопределено, Строка - отчество предпринимателя.
//    * ФамилияНаАнглийском - Неопределено, Строка - фамилия предпринимателя на английском.
//    * ИмяНаАнглийском - Неопределено, Строка - имя предпринимателя на английском.
//    * ОтчествоНаАнглийском - Неопределено, Строка - отчество предпринимателя на английском.
//    * РегистрационныйНомер - Неопределено, Строка - ОГРНИП.
//    * Пол - Неопределено, Строка - "1" - Мужской, "2" - Женский.
//    * КодСтраныГражданства - Неопределено, Строка - код страны.
//    * РегистрацияВНалоговомОргане - Неопределено, Структура - данные о регистрации в ИФНС:
//      ** Код - Строка - код налогового органа.
//      ** Наименование - Строка - наименование налогового органа.
...
//    * ДатаРегистрации - Неопределено, Дата - дата регистрации предпринимателя.
//    * СвидетельствоОРегистрации - Неопределено, Структура - данные свидетельства:
//      ** Серия - Строка - серия свидетельства.
//      ** Номер - Строка - номер свидетельства.
//      ** Дата - Дата - дата выдачи свидетельства. 
//    * ВидДеятельности - Неопределено, Структура - описание вида экономической деятельности:
//      ** Код - Строка - код вида деятельности;
//      ** Наименование - Строка - наименование вида деятельности;
//      ** Классификатор - Строка - тип классификатор экономической деятельности, согласно которому указаны код и наименование.
//                         Значения: "ОКВЭД", "ОКВЭД2";
//    * Статус - Неопределено, Структура - текущий статус предпринимателя:
//      ** Код - Строка - код статуса;
//      ** Наименование - Строка - наименование статуса.
//    * ЭлектроннаяПочта - Неопределено, Строка - электронная почта.  
//    * ЯвляетсяГлавойКФХ - Булево - признак, что является главой КФХ.
//    * ЯвляетсяГлавойКФХОписание - Строка - описание признака, что является главой КФХ.
//    * ИсторияРеквизитов - Структура - история изменения реквизитов предпринимателя.
//                                      см. НовыйИсторияРеквизитовПредпринимателя
//    * ОписаниеОшибки - Неопределено, Строка - описание возникшей ошибки.
//                       Для обработки ошибки на клиентской части необходимо использовать метод
//                       РаботаСКонтрагентамиКлиент.ОбработатьОшибку.
//    * КодОКВЭД - Неопределено, Строка - устарело, следует использовать ВидДеятельности.Код, код основного
//                                     вида деятельности по классификатору ОКВЭД.
//    * ЭтоОКВЭД2 - Булево - устарело, следует использовать ВидДеятельности.Классификатор, код ОКВЭД
//                                      приведен по классификатору редакции 2 или редакции 1.
//
...
//      ** РегистрирующийОрган - Неопределено, Структура - орган, зарегистрировавший юридическое лицо.
//                                                         см. НовыйДанныеРегистрирующегоОргана.
//      ** НомерТиповогоУстава - Неопределено - не используется в текущем методе.
//      ** ПравоваяФорма - Строка, Неопределено - правовая форма юридического лица.
//      ** ЮридическийАдрес - Неопределено, Структура - данные о юридическом адресе:
//        *** КонтактнаяИнформация - Строка - данные в формате JSON для заполнения реквизита
//            "Значение" контактной информации в табличной части КонтактнаяИнформация объекта
...
//      ** ОткрытыеГосударственныеДанныеФНС - ТаблицаЗначений - не используется в текущем методе.
//      ** Подразделения - Неопределено, Массив из Структура - данные подразделений юридического лица.
//                                                             см. НовыйДанныеПодразделения.
...
Функция ЮридическиеЛицаПоНаименованию(Знач Наименование, Знач КодРегиона = "", Знач Адрес = "") Экспорт
	...
	Если ТипЗнч(ЗначениеCorporations) = Тип("Массив") Тогда
		Для Каждого ТекущееCorporation Из ЗначениеCorporations Цикл
			...
			РеквизитыОрганизации.ДатаРегистрации = ДатаИзJSON(
				ТекущееCorporation.Получить("registrationDate"));
			РеквизитыОрганизации.ДатаПрекращенияДеятельности = ДатаИзJSON(
				ТекущееCorporation.Получить("terminationDate"));
...
//    * ИНН - Строка, Неопределено - ИНН юридического лица
//    * КПП - Строка, Неопределено - КПП юридического лица
//    * Наименование - Строка, Неопределено - представление юридического лица в учетной программе
//    * НаименованиеПолное - Строка, Неопределено - полное наименование юридического лица
//    * НаименованиеСокращенное - Строка, Неопределено - сокращенное наименование юридического лица
...
//    * НаименованиеПолноеНаАнглийском - Строка, Неопределено - полное наименование юридического лица на английском.
//    * НаименованиеСокращенноеНаАнглийском - Строка, Неопределено - сокращенное наименование юридического лица на английском
//    * РегистрационныйНомер - Неопределено, Строка - ОГРН юридического лица
//    * Статус - Неопределено, Структура - текущий статус юридического лица.
//                                         см. НовыйДанныеСтатуса.
//    * РегистрирующийОрган - Неопределено, Структура - орган, зарегистрировавший юридическое лицо.
//                                                      см. НовыйДанныеРегистрирующегоОргана.
//    * НомерТиповогоУстава - Строка, Неопределено - Номер типового устава юридического лица.
//    * ПравоваяФорма - Неопределено, Строка - правовая форма юридического лица.
//    * ЮридическийАдрес - Неопределено, Структура - данные о юридическом адресе:
//      ** КонтактнаяИнформация - Строка - данные в формате JSON для заполнения реквизита
//            "Значение" контактной информации в табличной части КонтактнаяИнформация объекта
//            (см. описание подсистемы "Контактная информация" Библиотеки стандартных подсистем).
...
//      ** ПредставлениеСкрытыхДанных - Строка - представление скрытых данных о руководителях.
//                                                  Заполняется если СкрытыеДанные = Истина
//      ** Руководители - ТаблицаЗначений - сведения о руководителях. Заполняется если СкрытыеДанные = Ложь.
//           см. НоваяТаблицаРуководителей.
//    * РегистрацияВНалоговомОргане - Неопределено, Структура - данные о регистрации в ИФНС.
//                                                             см. НоваяРегистрацияВНалоговомОргане.
//    * ДатаРегистрации - Неопределено, Дата - дата регистрации юридического лица
//    * ДатаПрекращенияДеятельности - Дата, Неопределено - дата прекращения деятельности юридического лица.
//    * РегистрацияВПенсионномФонде - Неопределено, Структура - данные о регистрации в ПФР.
//                                                              см. НоваяРегистрацияВПенсионномФонде.
//    * РегистрацияВФСС - Неопределено, Структура - данные о регистрации в ФСС.
...
//    * ДанныеПравопреемников - Неопределено, Структура - данные о правопреемниках организации:
//      ** СкрытыеДанные - Булево - признак скрытых данных о правопреемниках организации.
//      ** ПредставлениеСкрытыхДанных - Строка - представление скрытых данных о правопреемниках.
//         Заполняется если СкрытыеДанные = Истина.
//      ** Правопреемники - Массив из см. НовыеДанныеПравопреемника - сведения о правопреемниках.
//    * ДанныеПравопредшественников - Неопределено, Структура - данные о правопредшественниках организации:
//      ** СкрытыеДанные - Булево - признак скрытых данных о правопредшественниках организации.
//      ** ПредставлениеСкрытыхДанных - Строка - представление скрытых данных о правопредшественниках.
//         Заполняется если СкрытыеДанные = Истина.
//      ** Правопредшественники - Массив из см. НовыеДанныеПравопредшественника - сведения о правопредшественниках.
//    * СтатусМКФ - Строка, Неопределено - сведения о том, что юридическое лицо является
//                                         международной компанией или международным фондом.
//    * КорпоративныйДоговор - Строка, Неопределено - сведения о наличии корпоративного договора.
//    * ДержательРеестраАкционеров - Неопределено, Структура - сведения о держателе реестра акционеров акционерного общества:
//      ** ОГРН - Строка - ОГРН держателя реестра акционеров;
//      ** ИНН - Строка - ИНН держателя реестра акционеров
//      ** Наименование - Строка - ОГРН держателя реестра акционеров.
...
//    * СведенияОРегистрацииНаДеньПринятия - Структура - сведения о регистрации на день принятия в Российскую Федерацию:
//      ** ИдентификационныйКод - Строка - идентификационный код юридического лица;
//      ** НаименованиеРегистрирующегоОргана - Строка - наименование органа, зарегистрировавшего юридическое лицо;
//      ** РегистрационныйНомер - Строка - регистрационный номер, присвоенный юридическому лицу.
//    * ДействующиеОтИмениЮридическогоЛица - Массив из Структура - сведения о юридическом лице,
//                                           имеющем право без доверенности действовать от имени юридического лица:
//      ** ИНН - Строка - ИНН юридического лица;
//      ** ОГРН - Строка - ОГРН юридического лица;
//      ** Наименование - Строка - Наименование юридического лица.
//    * ВидПолномочий - Строка - Сведения о полномочиях нескольких лиц выступать от имени юридического лица.
//                               Принимает значение:
//        "1" - если лица, имеющие право выступать от имени юридического лица, действуют совместно;
//        "2" - если лица, имеющие право выступать от имени юридического лица, действуют независимо друг от друга.
...
//      ** НомерЛицензии - Строка - номер лицензии;
//      ** НомерЛицензииВЕдиномРеестре - Строка - номер лицензии, присвоенный в Едином реестре учета лицензий.
...
//    * Учредители - ТаблицаЗначений - рекомендуется использовать свойство "ДанныеУчредителей".
//                                     Устарело. Учредители этой организации:
...
//    * ДанныеУчредителей - Структура - сведения об учредителях:
...
//    * ОрганизацииГдеРуководитель - ТаблицаЗначений - (устарело) данные об организациях, где руководитель этой организации также является руководителем:
//                                                      следует использовать Руководители[0].ОрганизацииГдеРуководитель
//      Колонки:
//      ** НаименованиеОрганизации - Строка - наименование организации.
//      ** ИНН - Строка - ИНН организации.
//      ** КодСтатуса - Строка - код текущего статуса организации.
...
Функция ИнформацияОСвязяхЮридическогоЛицаПоИНН(Знач ИНН) Экспорт
	...
	ДатаПрекращенияДеятельности = ТелоОтветаОбъект.Получить("terminationDate");
	Если ДатаПрекращенияДеятельности <> Неопределено Тогда
		Результат.ДатаПрекращенияДеятельности = ДатаИзJSON(ДатаПрекращенияДеятельности);
	КонецЕсли;
	
	НомерТиповогоУстава = ТелоОтветаОбъект.Получить("standardCharterNumber");
	Если НомерТиповогоУстава <> Неопределено Тогда
		Результат.НомерТиповогоУстава = НомерТиповогоУстава;
	КонецЕсли;
	...
	ЗаполнитьЭлектроннуюПочту(ТелоОтветаОбъект.Получить("email"), Результат);
	...
	ЗаполнитьСведенияОРегистрацииНаДеньПринятия(ТелоОтветаОбъект, Результат);
	...
	ЗаполнитьВидПолномочий(ТелоОтветаОбъект, Результат);
	...
	ЗаполнитьИнформациюОДействующихОтИмениЮридическогоЛица(ТелоОтветаОбъект, Результат);
	ЗаполнитьИнформациюОбУставномКапитале(ТелоОтветаОбъект, Результат);
	ЗаполнитьИнформациюОСтатусеМКФ(ТелоОтветаОбъект, Результат);
	ЗаполнитьИнформациюОКорпоративномДоговоре(ТелоОтветаОбъект, Результат);
	ЗаполнитьИнформациюОДержателеРеестраАкционеров(ТелоОтветаОбъект, Результат);
	ЗаполнитьИнформациюОПравопреемниках(ТелоОтветаОбъект, Результат);
	ЗаполнитьИнформациюОПравопредшественниках(ТелоОтветаОбъект, Результат);
...
//    * ИНН - Неопределено, Строка - ИНН предпринимателя.
//    * Наименование - Неопределено, Строка - представление предпринимателя в учетной программе.
//    * НаименованиеПолное - Неопределено, Строка - фамилия, имя, отчество предпринимателя.
//    * НаименованиеСокращенное - Неопределено, Строка - фамилия, имя, отчество предпринимателя.
//    * ВидИП - Неопределено, Строка - вид предпринимателя.
...
//    * ЭтоОКВЭД2 - Булево - устарело, следует использовать ВидДеятельности.Классификатор, код ОКВЭД
//                                      приведен по классификатору редакции 2 или редакции 1.
//    * ВидыДеятельности - ТаблицаЗначений - информация о видах деятельности. см. НоваяТаблицаВидыДеятельности
//    * Лицензии - ТаблицаЗначений - данные о полученных лицензиях. см. НоваяТаблицаЛицензии.
//    * ОрганизацииГдеРуководитель - ТаблицаЗначений - данные об организациях, где этот предприниматель является руководителем.
//                                                     см. НоваяТаблицаОрганизации.
...
//                                                   см. НоваяТаблицаОрганизацииГдеУчредитель.
...
//                                            см. НоваяТаблицаИзмененияВРеестре.
//    * ОжиданиеОтвета - Булево - если возвращается Истина - требуется повторный вызов метода с этими же параметрами.
//    * НаименованиеСтатуса - Строка, Неопределено - устарело, необходимо использовать Статус.Наименование - наименование текущего статуса;
//    * КодСтатуса - Строка, Неопределено - устарело, необходимо использовать Статус.Код - код текущего статуса.
//
...
//    * Проверки - Соответствие из Строка, ТаблицаЗначений - информация о проверках:
//      ** Ключ - Строка - ИНН;
...
//    * РегистрирующийОрганИП - Неопределено, Структура - реквизиты регистрирующего
...
//    * РегистрирующийОрганЮЛ - Неопределено, Структура - реквизиты регистрирующего органа юридических лиц.
...
//
// Параметры:
//  ХостыСервисовИнтернетПоддержки - Соответствие из Строка, Строка - хост и название используемого сервиса.
//
...
// Новые сведения юридического лица.
// 
// Параметры:
//  ИНН - Строка - ИНН
// 
// Возвращаемое значение:
//  Структура - Новые сведения юридического лица:
//   * ИНН - Строка - ИНН юридического лица;
//   * ЕГРЮЛ - Неопределено, Структура - сведения из ЕГРЮЛ;
//   * РАФП - ТаблицаЗначений - сведения из РАФП. см. НоваяТаблицаРАФП;
//   * ОписаниеОшибки - Неопределено, Строка - описание возникшей ошибки.
//                    Для обработки ошибки на клиентской части необходимо использовать метод
//                    РаботаСКонтрагентамиКлиент.ОбработатьОшибку.
//
...
// Возвращает структуру реквизитов юридического лица для заполнения данными из ЕГРЮЛ.
//
// Возвращаемое значение:
//  Структура:
//    * ИНН - Строка, Неопределено - ИНН юридического лица
...
Функция НовыеРеквизитыЮридическогоЛица()
	...
	РеквизитыОрганизации.Вставить("ЭлектроннаяПочта");
...
// Возвращает описание данных из РАФП.
// 
// Возвращаемое значение:
//  ТаблицаЗначений - сведения из РАФП:
//    * КПП - Строка - КПП юридического лица;
//    * ВидОбособленногоПодразделения - Строка - вид обособленного подразделения;
//    * НаименованиеПолное - Строка - полное наименование представительства;
//    * РегистрацияВНалоговомОргане - Неопределено,  Структура - информация о регистрации представительства в налоговом органе:
...
//    * ВидДеятельности - Неопределено, Структура - описание основного вида экономической деятельности.
//                                                  см. НовыйОписаниеВидаДеятельности.
//    * ПрочиеВидыДеятельности - Неопределено, ТаблицаЗначений - описание прочих видов экономической деятельности.
//         Колонки:
//      ** Код - Строка - код вида деятельности;
//      ** Наименование - Строка - наименование вида деятельности;
//      ** Классификатор - Строка - тип классификатор экономической деятельности, согласно которому указаны код и наименование.
...
//      ** Представление - Строка - ФИО руководителя;
//      ** ДатаЗаписи - Дата - дата записи о руководителе; 
//    * Аккредитация - Неопределено, Структура - информация об аккредитации представительства:
//      ** НомерЗаписиОбАккредитации - Строка - номер записи об аккредитации;
//      ** ДатаАккредитации - Дата - дата аккредитации;
//      ** КодУполномоченногоНалоговогоОргана - Строка - код уполномоченного налогового органа,
//          выполнившего аккредитацию представительства;
...
//      ** ДатаПродленияАккредитации - Дата - дата принятия решения о продлении срока аккредитации;
//      ** ДатаОкончанияСрокаПродленияАккредитации - Дата - дата окончания срока продления аккредитации;
//    * ИностранноеЮридическоеЛицо - Неопределено, Структура - данные иностранной компании:
//      ** НаименованиеПолное - Строка - полное наименование иностранного юридического лица;
//      ** КодСтраны - Число - код страны регистрации по ОКСМ;
//      ** Страна - Строка - наименование страны регистрации;
//      ** Адрес - Строка - адрес иностранного юридического лица в стране регистрации;
...
// Возвращает описание данных истории изменений реквизитов юридического лица.
// 
// Возвращаемое значение:
//  Структура - данные истории реквизитов юридического лица:
...
//      ** Дата - Строка - полное наименование юридического лица;
...
// Возвращает структуру реквизитов предпринимателя.
// 
// Возвращаемое значение:
//  Структура - реквизиты индивидуального предпринимателя:
//    * ИНН - Неопределено, Строка - ИНН предпринимателя.
...
Функция НовыеРеквизитыПредпринимателя()
	...
	РеквизитыПредпринимателя.Вставить("ФамилияНаАнглийском");
	РеквизитыПредпринимателя.Вставить("ИмяНаАнглийском");
	РеквизитыПредпринимателя.Вставить("ОтчествоНаАнглийском");
	...
	РеквизитыПредпринимателя.Вставить("ЭлектроннаяПочта");
	РеквизитыПредпринимателя.Вставить("ЯвляетсяГлавойКФХ", Ложь);
	РеквизитыПредпринимателя.Вставить("ЯвляетсяГлавойКФХОписание", "");
...
// Новая таблица руководителей.
// 
// Возвращаемое значение:
//  ТаблицаЗначений - Новая таблица руководителей:
//    * Должность - Строка - должность руководителя.
//    * Фамилия - Строка - фамилия руководителя.
//    * Имя - Строка - имя руководителя.
//    * Отчество - Строка - отчество руководителя.
...
//    * ИНН - Строка - ИНН руководителя.
//    * ДатаЗаписи - Дата - дата записи о руководителе.
//    * ОрганизацииГдеРуководитель - ТаблицаЗначений - сведения об организациях, где руководитель.
//    * ОрганизацииГдеУчредитель - ТаблицаЗначений - сведения об организациях, где учредитель.
//    * ОрганизацииГдеРуководительПоФИО - Булево - если Истина, поиск проводился по ФИО руководителя, иначе по ИНН.
//    * ОрганизацииГдеУчредительПоФИО - Булево - если Истина, поиск проводился по ФИО руководителя, иначе по ИНН.
//
...
// Возвращает данные регистрации в ИФНС.
// 
// Возвращаемое значение:
//  Структура - данные регистрация в ИФНС:
//    * Код - Строка, Неопределено - код налогового органа.
//    * Наименование - Строка, Неопределено - наименование налогового органа.
//    * ОКТМО - Строка, Неопределено - код ОКТМО налогового органа.
//    * ОКАТО - Строка, Неопределено - код ОКАТО налогового органа.
//    * ДатаРегистрации - Дата, Неопределено - дата постановки на учет в налоговом органе.
//
...
// Возвращает данные о регистрации в ПФР.
// 
// Возвращаемое значение:
//  Структура - данные регистрации в ПФР:
//    * РегистрационныйНомерПФР - Строка, Неопределено - регистрационный номер юридического лица в ПФР.
//    * КодОрганаПФР - Строка, Неопределено - код органа ПФР.
//    * НаименованиеОрганаПФР - Строка, Неопределено - наименование органа ПФР.
//    * ДатаРегистрации - Дата, Неопределено - дата постановки на учет в ПФР.
//
...
// Возвращает данные о регистрации в ФСС.
// 
// Возвращаемое значение:
//  Структура - данные регистрации в ФСС:
//    * РегистрационныйНомерФСС - Строка, Неопределено - регистрационный номер юридического лица в ФСС.
//    * КодПодчиненности - Строка, Неопределено - код подчиненности органа ФСС.
//    * КодОрганаФСС - Строка, Неопределено - код органа ФСС.
//    * НаименованиеОрганаФСС - Строка, Неопределено - наименование органа ФСС.
//    * ДатаРегистрации - Дата, Неопределено - дата постановки на учет в ФСС.
//
...
// Возвращает данные о регистрации в СФР.
// 
// Возвращаемое значение:
//  Структура - данные регистрации в СФР:
//    * РегистрационныйНомерСФР - Строка, Неопределено - регистрационный номер юридического лица в СФР.
//    * КодОрганаСФР - Строка, Неопределено - код органа СФР.
//    * НаименованиеОрганаСФР - Строка, Неопределено - наименование органа СФР.
//    * ДатаРегистрации - Дата, Неопределено - дата постановки на учет в СФР.
//
...
// Возвращает описание полученных видов деятельности.
// 
// Возвращаемое значение:
//  ТаблицаЗначений - информация о видах деятельности:
//    * Код - Строка - код вида деятельности;
//    * Наименование - Строка - наименование вида деятельности;
//    * Классификатор - Строка - тип классификатор экономической деятельности, согласно которому указаны код и наименование;
//                                Значения: "ОКВЭД", "ОКВЭД2"
...
// Возвращает таблицу для описания данных лицензии.
// 
// Возвращаемое значение:
//  ТаблицаЗначений - данные о полученных лицензиях:
//    * Лицензия - Строка - наименование лицензии;
//    * ОписаниеЛицензии - Строка - подробное описание лицензии;
//    * НомерЛицензии - Строка - номер лицензии;
//    * НомерЛицензииВЕдиномРеестре - Строка - номер лицензии, присвоенный в Едином реестре учета лицензий.
...
Функция НоваяТаблицаЛицензии()
	...
	Результат.Колонки.Добавить("НомерЛицензии",               Новый ОписаниеТипов("Строка"));
	Результат.Колонки.Добавить("НомерЛицензииВЕдиномРеестре", Новый ОписаниеТипов("Строка"));
	Возврат Результат;

КонецФункции

// Возвращает описание изменений в реестре по лицу.
// 
// Возвращаемое значение:
//  ТаблицаЗначений - данные об изменениях в реестре по этому лицу:
//    * ДатаИзменения - Дата - дата внесения изменения.
//    * ГосударственныйОрган - Строка - орган, который внес изменение.
//    * ОписаниеИзменения - Строка - описание изменения;
//
...
// Возвращает описание данных об организациях.
// 
// Возвращаемое значение:
//  ТаблицаЗначений - данные об организациях:
//    * НаименованиеОрганизации - Строка - наименование организации.
//    * ИНН - Строка - ИНН организации.
//    * КодСтатуса - Строка - код текущего статуса организации.
//    * НаименованиеСтатуса - Строка - наименование текущего статуса организации.
...
// Возвращает описание данных организаций, где физическое лицо является учредителем.
// 
// Возвращаемое значение:
//  ТаблицаЗначений - описание данных организаций, где физическое лицо является учредителем:
//    * НаименованиеОрганизации - Строка - наименование организации.
//    * ИНН - Строка - ИНН организации.
//    * КодСтатуса - Строка - код текущего статуса организации.
//    * НаименованиеСтатуса - Строка - наименование текущего статуса организации.
...
Функция НовыеДанныеПравопреемников()

	Результат = Новый Структура;
	Результат.Вставить("СкрытыеДанные",              Ложь);
	Результат.Вставить("ПредставлениеСкрытыхДанных", "");
	Результат.Вставить("Правопреемники",             Новый Массив);
	
	Возврат Результат;

КонецФункции

Функция НовыеДанныеПравопредшественников()

	Результат = Новый Структура;
	Результат.Вставить("СкрытыеДанные",              Ложь);
	Результат.Вставить("ПредставлениеСкрытыхДанных", "");
	Результат.Вставить("Правопредшественники",       Новый Массив);
	
	Возврат Результат;

КонецФункции

Функция НовыеДанныеПравопреемника()
...
Функция НовыеДанныеПравопредшественника()
...
Функция НоваяИнформацияОСвязяхЮридическогоЛица() Экспорт
	...
	ИнформацияОСвязях.Вставить("ДанныеПравопреемников", НовыеДанныеПравопреемников());
	ИнформацияОСвязях.Вставить("ДанныеПравопредшественников", НовыеДанныеПравопредшественников());
	ИнформацияОСвязях.Вставить("СтатусМКФ");
	ИнформацияОСвязях.Вставить("КорпоративныйДоговор");
	ИнформацияОСвязях.Вставить("ДержательРеестраАкционеров");
	ИнформацияОСвязях.Вставить("ВидыДеятельности", НоваяТаблицаВидыДеятельности());
	ИнформацияОСвязях.Вставить("СведенияОРегистрацииНаДеньПринятия");
	ИнформацияОСвязях.Вставить("ДействующиеОтИмениЮридическогоЛица");
	ИнформацияОСвязях.Вставить("ВидПолномочий");
	...
	// Устарело. Дополнительная информация о юридическом лице и его связях.
...
Процедура ЗаполнитьДанныеЮридическогоЛица(
	...
	Если ДанныеЮридическогоЛица <> Неопределено Тогда
		...
		РеквизитыЮридическогоЛица.ДатаРегистрации = ДатаИзJSON(
			ДанныеЮридическогоЛица.Получить("registrationDate"));
		РеквизитыЮридическогоЛица.ДатаПрекращенияДеятельности = ДатаИзJSON(
			ДанныеЮридическогоЛица.Получить("terminationDate"));
		
		РеквизитыЮридическогоЛица.НомерТиповогоУстава = ДанныеЮридическогоЛица.Получить("standardCharterNumber");
		...
		ЗаполнитьЭлектроннуюПочту(ДанныеЮридическогоЛица.Получить("email"), РеквизитыЮридическогоЛица);
...
Процедура ЗаполнитьНаименованияЮридическогоЛица(НаименованиеJSON, Реквизиты)
	...
	Если НаименованиеJSON <> Неопределено Тогда
		...
		Реквизиты.НаименованиеСокращенноеНаАнглийском = НаименованиеJSON.Получить("shortEnNameFromEgrul");
		Реквизиты.НаименованиеПолноеНаАнглийском = НаименованиеJSON.Получить("fullEnNameFromEgrul");
...
// Возвращает описание вида деятельности.
// 
// Возвращаемое значение:
//  Структура - Новый описание вида деятельности:
//    * Код - Строка - код вида деятельности;
//   * Наименование - Строка- наименование вида деятельности;
//   * Классификатор - Строка - тип классификатор экономической деятельности,
//                              согласно которому указаны код и наименование;
//                              Значения: "ОКВЭД", "ОКВЭД2"
//
...
Процедура ЗаполнитьИнформациюОЛицензиях(ТелоОтветаОбъект, ИнформацияОСвязях)
	...
	Для Каждого ТекущееLicenseInfos Из ЗначениеLicenseInfos Цикл
		...
		НоваяСтрока.НомерЛицензии = ТекущееLicenseInfos.Получить("number");
		НоваяСтрока.НомерЛицензииВЕдиномРеестре = ТекущееLicenseInfos.Получить("erulNumber");
		НомерЛицензии = ?(ПустаяСтрока(НоваяСтрока.НомерЛицензии),
			НоваяСтрока.НомерЛицензииВЕдиномРеестре,
			НоваяСтрока.НомерЛицензии);
...
Процедура ЗаполнитьИнформациюОДействующихОтИмениЮридическогоЛица(ТелоОтветаОбъект, ИнформацияОСвязях)
	
	ЗначенияManagementOrganizations = ТелоОтветаОбъект.Получить("managementOrganizations");
	Если ЗначенияManagementOrganizations = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	ДействующиеОтИмениЮридическогоЛица = Новый Массив;
	Для Каждого ЗначениеManagementOrganizations Из ЗначенияManagementOrganizations Цикл
		
		ДействующийОтИмениЮридическогоЛица = Новый Структура;
		ДействующийОтИмениЮридическогоЛица.Вставить("ИНН", ЗначениеManagementOrganizations.Получить("inn"));
		ДействующийОтИмениЮридическогоЛица.Вставить("ОГРН", ЗначениеManagementOrganizations.Получить("ogrn"));
		ДействующийОтИмениЮридическогоЛица.Вставить("Наименование", ЗначениеManagementOrganizations.Получить("fullName"));
		
		ДействующиеОтИмениЮридическогоЛица.Добавить(ДействующийОтИмениЮридическогоЛица);
		
	КонецЦикла;
	
	ИнформацияОСвязях.ДействующиеОтИмениЮридическогоЛица = ДействующиеОтИмениЮридическогоЛица;
	
КонецПроцедуры

Процедура ЗаполнитьИнформациюОбУставномКапитале(ТелоОтветаОбъект, ИнформацияОСвязях)
	
	ЗначениеAuthorizedCapital = ТелоОтветаОбъект.Получить("authorizedCapital");
...
Процедура ЗаполнитьИнформациюОСтатусеМКФ(ТелоОтветаОбъект, ИнформацияОСвязях)
	
	ИнформацияОСвязях.СтатусМКФ = ТелоОтветаОбъект.Получить("registrationInfoInternationalStatus");
	
КонецПроцедуры

Процедура ЗаполнитьИнформациюОКорпоративномДоговоре(ТелоОтветаОбъект, ИнформацияОСвязях)
	
	ЗначениеКорпоративныйДоговор = ТелоОтветаОбъект.Получить("corporateAgreements");
	Если ЗначениеКорпоративныйДоговор <> Неопределено Тогда
		Тип = ЗначениеКорпоративныйДоговор[0].Получить("type");
		Если Тип = "1" Тогда
			ИнформацияОСвязях.КорпоративныйДоговор = НСтр("ru='Корпоративным договором предусмотрен объем правомочий участников хозяйственного общества непропорционально размерам принадлежащих им долей в уставном капитале хозяйственного общества'");
		ИначеЕсли Тип = "2" Тогда
			ИнформацияОСвязях.КорпоративныйДоговор = НСтр("ru='Корпоративным договором предусмотрены ограничения и условия отчуждения долей (акций)'");
		КонецЕсли;
	КонецЕсли;
	
КонецПроцедуры

Процедура ЗаполнитьИнформациюОДержателеРеестраАкционеров(ТелоОтветаОбъект, ИнформацияОСвязях)
	
	ДержательРеестраАкционеров = ТелоОтветаОбъект.Получить("shareholdersRegisterHolder");
	Если ДержательРеестраАкционеров <> Неопределено Тогда
		ДанныеОДержателе = Новый Структура;
		ДанныеОДержателе.Вставить("ОГРН", ДержательРеестраАкционеров.Получить("holderOgrn"));
		ДанныеОДержателе.Вставить("ИНН", ДержательРеестраАкционеров.Получить("holderInn"));
		ДанныеОДержателе.Вставить("Наименование", ДержательРеестраАкционеров.Получить("holderName"));
		ИнформацияОСвязях.ДержательРеестраАкционеров = ДанныеОДержателе;
	КонецЕсли;
	
КонецПроцедуры

Процедура ЗаполнитьИнформациюОПравопреемниках(ТелоОтветаОбъект, ИнформацияОСвязях)
	
	ДанныеОПравопреемниках = ТелоОтветаОбъект.Получить("legalSuccessorInfos");
	Если ДанныеОПравопреемниках = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	ОткрытыеДанные = Ложь;
	Правопреемники = Новый Массив;
	Для Каждого ДанныеОПравопреемнике Из ДанныеОПравопреемниках Цикл
		Правопреемник = НовыеДанныеПравопреемника();
		ПредставлениеСкрытыхДанных = ДанныеОПравопреемнике.Получить("accessRestriction");
		Если ПредставлениеСкрытыхДанных = Неопределено Тогда
			Правопреемник.ИНН = ДанныеОПравопреемнике.Получить("inn");
			Правопреемник.Наименование = ДанныеОПравопреемнике.Получить("fullName");
		Иначе
			Правопреемник.СкрытыеДанные = Истина;
			Правопреемник.ПредставлениеСкрытыхДанных = ПредставлениеСкрытыхДанных;
		КонецЕсли;
		Правопреемники.Добавить(Правопреемник);
		ОткрытыеДанные = ОткрытыеДанные Или Не Правопреемник.СкрытыеДанные
	КонецЦикла;
	ИнформацияОСвязях.ДанныеПравопреемников.Правопреемники = Правопреемники;
	
	Если Не ОткрытыеДанные Тогда
		ИнформацияОСвязях.ДанныеПравопреемников.СкрытыеДанные = Истина;
		ИнформацияОСвязях.ДанныеПравопреемников.ПредставлениеСкрытыхДанных = Правопреемники[0].ПредставлениеСкрытыхДанных;
	КонецЕсли;
	
КонецПроцедуры

Процедура ЗаполнитьИнформациюОПравопредшественниках(ТелоОтветаОбъект, ИнформацияОСвязях)
	
	ДанныеОПравопредшественниках = ТелоОтветаОбъект.Получить("legalPredecessorInfos");
	Если ДанныеОПравопредшественниках = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	ОткрытыеДанные = Ложь;
	Правопредшественники = Новый Массив;
	Для Каждого ДанныеОПравопредшественнике Из ДанныеОПравопредшественниках Цикл
		Правопредшественник = НовыеДанныеПравопредшественника();
		ПредставлениеСкрытыхДанных = ДанныеОПравопредшественнике.Получить("accessRestriction");
		Если ПредставлениеСкрытыхДанных = Неопределено Тогда
			Правопредшественник.ИНН = ДанныеОПравопредшественнике.Получить("inn");
			Правопредшественник.Наименование = ДанныеОПравопредшественнике.Получить("fullName");
		Иначе
			Правопредшественник.СкрытыеДанные = Истина;
			Правопредшественник.ПредставлениеСкрытыхДанных = ПредставлениеСкрытыхДанных;
		КонецЕсли;
		Правопредшественники.Добавить(Правопредшественник);
		ОткрытыеДанные = ОткрытыеДанные Или Не Правопредшественник.СкрытыеДанные
	КонецЦикла;
	ИнформацияОСвязях.ДанныеПравопредшественников.Правопредшественники = Правопредшественники;
	
	Если Не ОткрытыеДанные Тогда
		ИнформацияОСвязях.ДанныеПравопредшественников.СкрытыеДанные = Истина;
		ИнформацияОСвязях.ДанныеПравопредшественников.ПредставлениеСкрытыхДанных =
			Правопредшественники[0].ПредставлениеСкрытыхДанных;
	КонецЕсли;
...
Процедура ЗаполнитьОсновныеРеквизитыПредпринимателя(
	...
	Если ТипЗнч(ЗначениеPerson) = Тип("Соответствие") Тогда
		...
		Реквизиты.ФамилияНаАнглийском  = ЗначениеPerson.Получить("lastNameEn");
		Реквизиты.ИмяНаАнглийском      = ЗначениеPerson.Получить("nameEn");
		Реквизиты.ОтчествоНаАнглийском = ЗначениеPerson.Получить("patronymicEn");
	...
	ЗначениеFarmHeadStatus = ТелоОтветаОбъект.Получить("farmHeadStatus");
	Если ЗначениеFarmHeadStatus <> Неопределено Тогда
		Реквизиты.ЯвляетсяГлавойКФХ = Истина;
		Реквизиты.ЯвляетсяГлавойКФХОписание = ЗначениеFarmHeadStatus;
	КонецЕсли;
...
Процедура ЗаполнитьЭлектроннуюПочту(ЭлектроннаяПочта, Реквизиты)
	
	Реквизиты.ЭлектроннаяПочта = ЭлектроннаяПочта;
...
Процедура ЗаполнитьВидПолномочий(ТелоОтветаОбъект, Реквизиты)
	
	Реквизиты.ВидПолномочий = ТелоОтветаОбъект.Получить("powersType");
...
// Новый данные подразделения.
// 
// Возвращаемое значение:
//  Структура - Новый данные подразделения:
//    * ИНН - Строка - ИНН юридического лица
//    * Наименование - Строка - наименование подразделения
//    * Идентификатор - Строка, Неопределено - идентификатор подразделения в сервисе
//    * ЮридическийАдрес - Неопределено, Структура  - данные о юридическом адресе:
//      ** КонтактнаяИнформация - Строка - данные в формате JSON для заполнения реквизита
//            "Значение" контактной информации в табличной части КонтактнаяИнформация объекта
//            (см. описание подсистемы "Контактная информация" Библиотеки стандартных подсистем).
...
Процедура ЗаполнитьИсторияКПП(ИсторияКПП, Таблица)
	
	Если ТипЗнч(ИсторияКПП) <> Тип("Массив") Тогда
		Возврат;
	КонецЕсли;
	
	Для Каждого ТекущееИсторияКПП Из ИсторияКПП Цикл
		
		НоваяСтрока = Таблица.Добавить();
		НоваяСтрока.Дата     = ДатаИзJSON(ТекущееИсторияКПП.Получить("fromDate"));
		НоваяСтрока.Значение = ТекущееИсторияКПП.Получить("value");
		
	КонецЦикла;
	
КонецПроцедуры

Процедура ЗаполнитьИсторияНаименование(ЗначениеНаименования, Таблица)
	
	Если ТипЗнч(ЗначениеНаименования) <> Тип("Массив") Тогда
		Возврат;
	КонецЕсли;
	
	Для Каждого ЭлементСписка Из ЗначениеНаименования Цикл
...
Процедура ЗаполнитьИсторияАдрес(ЗначениеАдреса, Таблица)
	
	Если ТипЗнч(ЗначениеАдреса) <> Тип("Массив") Тогда
		Возврат;
	КонецЕсли;
	
	Для Каждого ЭлементСписка Из ЗначениеАдреса Цикл
...
Процедура ЗаполнитьИсторияСтатус(ЗначениеСтатусы, Таблица)
	
	Если ТипЗнч(ЗначениеСтатусы) <> Тип("Массив") Тогда
		Возврат;
	КонецЕсли;
	
	Для Каждого ЭлементСписка Из ЗначениеСтатусы Цикл
...
Процедура ЗаполнитьИсторияРеквизитыДиректора(ЗначениеРуководители, Таблица)
	
	Если ТипЗнч(ЗначениеРуководители) <> Тип("Массив") Тогда
		Возврат;
	КонецЕсли;
	
	Для Каждого ЭлементСписка Из ЗначениеРуководители Цикл
...
Функция ЗаполнитьСтрокуОбОрганизации(ОрганизацияОбъект, ТаблицаДанных)
	...
	СокращенноеНаименование = Неопределено;
	Наименования = ОрганизацияОбъект.Получить("name");
	Если Наименования <> Неопределено Тогда
		СокращенноеНаименование = СокрЛП(Строка(Наименования.Получить("shortName")));
	КонецЕсли;
	
	НоваяСтрока = ТаблицаДанных.Добавить();
	НоваяСтрока.НаименованиеОрганизации = СокращенноеНаименование;
			...
			Если ПроверкиЗаМесяц.InspectionUnregular294 <> Неопределено Тогда
				...
				Для Каждого СтрокаПроверки Из ПроверкиЗаМесяц.InspectionUnregular294 Цикл
					...
					НоваяСтрока.АдресПроверки = ?(ЗначениеЗаполнено(СтрокаПроверки.ADR_SEC_II),
						СокрЛП(СтрокаПроверки.ADR_SEC_II),
		...
		Для Каждого ПроверкиЗаМесяц Из ОбъектXDTO.InspectionsRegular294 Цикл
			Если ПроверкиЗаМесяц.InspectionRegular294 <> Неопределено Тогда
				...
				Для Каждого СтрокаПроверки Из ПроверкиЗаМесяц.InspectionRegular294 Цикл
					...
					КонецЕсли;
					НоваяСтрока.КонтролирующийОрган = СокрЛП(СтрокаПроверки.KO_NAME);
					НоваяСтрока.АдресПроверки = ?(ЗначениеЗаполнено(СтрокаПроверки.ADR_SEC_IV),
						СокрЛП(СтрокаПроверки.ADR_SEC_IV),
						?(ЗначениеЗаполнено(СтрокаПроверки.ADR_SEC_III),
							СокрЛП(СтрокаПроверки.ADR_SEC_III), 
							СокрЛП(СтрокаПроверки.ADR_SEC_I)));
					НоваяСтрока.ЦельПроверки = СокрЛП(СтрокаПроверки.INSP_TARGET);
					НоваяСтрока.Нарушения    = НоваяТаблицаНарушенияВыявленныеКонтролирующимиОрганами();
...
// Возвращает данные регистрирующего органа.
// 
// Возвращаемое значение:
//  Структура - данные регистрирующего органа:
//    * Код - Строка - код органа; 
//    * Наименование - Строка - наименование органа;
//
...
Процедура ЗаполнитьСведенияОРегистрацииНаДеньПринятия(ТелоОтветаОбъект, Данные)
	
	ЗначениеRegistrationInfoIdCode = ТелоОтветаОбъект.Получить("registrationInfoIdCode");
	Если ЗначениеRegistrationInfoIdCode = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	Сведения = НовыйСведенияОРегистрацииНаДеньПринятия();
	Сведения.ИдентификационныйКод = ЗначениеRegistrationInfoIdCode;
	Сведения.НаименованиеРегистрирующегоОргана = ТелоОтветаОбъект.Получить("registrationInfoInspectionName");
	Сведения.РегистрационныйНомер = ТелоОтветаОбъект.Получить("registrationInfoNumber");
	
	Данные.СведенияОРегистрацииНаДеньПринятия = Сведения;
	
КонецПроцедуры

Функция НовыйСведенияОРегистрацииНаДеньПринятия()
	
	Результат = Новый Структура;
	Результат.Вставить("ИдентификационныйКод");
	Результат.Вставить("НаименованиеРегистрирующегоОргана");
...
Процедура ЗаполнитьИнформациюОДанныхУчредителей(Объект, ИнформацияОСвязях)
	...
	ДанныеУчредителей = Объект.Получить("founderInfoMeta");
	Если ТипЗнч(ДанныеУчредителей) = Тип("Соответствие")
		И ДанныеУчредителей.Получить("text") <> Неопределено Тогда
		ИнформацияОСвязях.ДанныеУчредителей.СкрытыеДанные = Истина;
		ИнформацияОСвязях.ДанныеУчредителей.ПредставлениеСкрытыхДанных = ДанныеУчредителей.Получить("text");
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьДанныеОРуководителях(ТелоОтветаОбъект, Реквизиты)
	...
	ДанныеРуководителей = ТелоОтветаОбъект.Получить("headPersonMeta");
	Если ТипЗнч(ДанныеРуководителей) = Тип("Соответствие")
		И ДанныеРуководителей.Получить("text") <> Неопределено Тогда
		Реквизиты.ДанныеРуководителей.СкрытыеДанные = Истина;
		Реквизиты.ДанныеРуководителей.ПредставлениеСкрытыхДанных = ДанныеРуководителей.Получить("text");
		Возврат;
	КонецЕсли;
