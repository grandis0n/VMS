...
Процедура НачатьОтправкуСертификатовДляРегистрацииВЭДО(ОповещениеОЗавершении, ПараметрыРегистрации, ФормаВладелец) Экспорт
	...
	КонтекстРегистрации.ВидУчетнойЗаписи = ПараметрыРегистрации.ВидУчетнойЗаписи;
...
Функция НовыйКонтекстРегистрацииСертификатовВЭДО()
	...
	Контекст.Вставить("УчетнаяЗаписьЦентраЭДО", Неопределено);
	Контекст.Вставить("ВидУчетнойЗаписи", ПредопределенноеЗначение("Перечисление.ВидУчетнойЗаписиЭДО.ПустаяСсылка"));
	Возврат Контекст;
КонецФункции
