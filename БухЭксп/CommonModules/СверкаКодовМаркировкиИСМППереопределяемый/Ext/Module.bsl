...
//  ТаблицаПродукции - ТаблицаЗначений - таблица продукции для заполнения. 
//  Колонки: - Номенклатура - ОпределяемыйТип.Номенклатура - номенклатура.
//
Процедура ПриОпеределенииТаблицыПродукцииПринятойБезРасхождений(ДокументОснование, НоменклатураПоДаннымЭДО, ТаблицаПродукции) Экспорт
	...
	ИнтеграцияИСМПБП.ПриОпеределенииТаблицыПродукцииПринятойБезРасхождений(ДокументОснование, НоменклатураПоДаннымЭДО, ТаблицаПродукции);
...
Процедура ПриОпределенииМаркируемойПродукцииДокумента(Знач ДокументСсылка, ТаблицаМаркируемойПродукции) Экспорт
	...
	ИнтеграцияИСМПБП.ЗаполнитьМаркируемуюПродукциюДокумента(ДокументСсылка, ТаблицаМаркируемойПродукции);
...
Процедура ПриОпределенииНеобходимостиОбработкиКодовМаркировкиВДокументе(ДокументОбъект, ПараметрыИнтеграции, ТребуетсяОбработка) Экспорт
	...
	СтруктураОтбора = Новый Структура("Признан", Перечисления.ВариантыДействийПоРасхождениямКодовМаркировкиИСМП.ПустаяСсылка());
