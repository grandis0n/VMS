...
Функция ЭтоИдентификаторЦифровогоСчета(Идентификатор) Экспорт
	...
	// g\.[a-z]{2}\.cbrdc\.wlt\.[a-z0-9]{2,5}\.[a-f0-9]{8}-[a-f0-9]{4}-4[a-f0-9]{3}-[89ab][a-f0-9]{3}-[a-f0-9]{12}
	Результат = ОбменСБанкамиЦифровойРубль.ЭтоИдентификаторЦифровогоСчета(Идентификатор);
