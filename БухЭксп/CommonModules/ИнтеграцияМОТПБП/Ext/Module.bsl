...
Процедура ОтразитьИзмененияТабличнойЧастиШтрихкодыУпаковок(ДокументОбъект, ТаблицаШтрихкодовВерхнегоУровня) Экспорт
	...
	ДокументОбъект.ШтрихкодыУпаковок.Загрузить(ТаблицаШтрихкодовВерхнегоУровня);
...
Процедура ОтразитьРезультатыПроверкиИПодбораВИсходящемДокументе(ПараметрыОкончанияСканирования, ТипОбъекта)
	...
	ОтразитьИзмененияТабличнойЧастиТовары(ДокументОбъект, ПараметрыОкончанияСканирования);
	//БгосИС 2.0.7 Для приходных и расходных документов (ПоступлениеТоваровУслуг, РеализацияТоваровУслуг и т.д) 
	//исключить заполнение прикладной табличной части Товары по товарам фармацевтического сырья
