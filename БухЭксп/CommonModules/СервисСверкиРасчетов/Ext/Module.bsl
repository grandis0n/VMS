...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОтправитьСведенияНаСервисРегламентноеЗадание");
	Методы.Вставить("ВключитьРегЗаданияСверки");
	Методы.Вставить("ОчиститьРегистрыСверкиДоДатыНачалаСверки");
	Методы.Вставить("ОбработатьУчастниковСверкиПослеОбновленияИдентификаторов");
	Методы.Вставить("СверитьРасчетыРегламентноеЗадание");
...
Функция СообщениеОНовыхРасхожденияхДляПользователя(ВыборкаПоОрганизациям, ПользовательВсегоНДС, ПользовательВсегоРасхождений, ПользовательВсегоСумма)
	...
	Пока ВыборкаПоОрганизациям.Следующий() Цикл
		...
		Пока ВыборкаПоКонтрагентам.Следующий() Цикл
			...
			Если НЕ СообщениеПоОрганизацииСформировано Тогда
				ЧастиСообщения.Добавить(Символы.ПС);
				ЧастиСообщения.Добавить(Новый ФорматированнаяСтрока(НСтр("ru='  Контрагент:'"),,ЦветаСтиля.СервисСверкиРасчетовЦветТекстаПодсказки));
				ЧастиСообщения.Добавить(Символы.ПС);
