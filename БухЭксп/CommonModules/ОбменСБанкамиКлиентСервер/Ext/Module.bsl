...
//   * НастройкаОбмена - Неопределено, СправочникСсылка.НастройкиОбменСБанками - настройка, через которую
//                       запрашивается выписка.
//   * Организация - Неопределено, ОпределяемыйТип.Организация - организация для запроса выписки.
//
