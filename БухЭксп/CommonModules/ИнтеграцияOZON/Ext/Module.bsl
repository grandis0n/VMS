...
Процедура ПодготовитьДокументыКСозданию(СписокЗагрузки, ДанныеМаркеплейса, ПараметрыИнтеграции, Ошибки) Экспорт
	...
	Если ДанныеМаркеплейса.ВидДокумента = ЭлектронноеВзаимодействиеБП.ВидДокументаОтчетOzonВыкуп()
		Или ДанныеМаркеплейса.ВидДокумента = ЭлектронноеВзаимодействиеБП.ВидДокументаДетализацияПоВыкупленнымТоварамOzon() Тогда
...
Функция ПолучитьПорциюСписокТоваров(СписокТоваров, ПараметрыЗапроса, НастройкиИнтеграцииМаркетплейс, СообщениеОбОшибке, Отказ)
	...
	Возврат ИнформацияОТоварах.Количество() = ПараметрыЗапроса.МаксимальноеКоличествоВОтвете 
...
Функция ПрочитатьФинансовыйОтчет(ПараметрыОтчета, Метод, СообщениеОбОшибке)
	...
	ОписаниеФайла.Вставить("ДвоичныеДанные", Новый ДвоичныеДанные(ИмяФайлаРеестра));
	ФайловаяСистема.УдалитьВременныйФайл(ИмяФайлаРеестра);
