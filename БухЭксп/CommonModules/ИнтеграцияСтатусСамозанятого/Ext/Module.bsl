...
Процедура ПриСозданииФормыИнтернетПоддержкаИСервисы(Форма) Экспорт
	...
	ГруппаСтатусСамозанятого.Заголовок = ИнтеграцияСтатусСамозанятогоКлиентСервер.НаименованиеСервиса();
	...
	ПодробнееСтатусСамозанятого.Заголовок = СтроковыеФункции.ФорматированнаяСтрока(
		НСтр("ru = 'Подробнее о сервисе <a href = ""%1"">%2</a>'"),
		ИнтеграцияСтатусСамозанятогоКлиентСервер.ФормаСервисСтатусСамозанятого(),
		ИнтеграцияСтатусСамозанятогоКлиентСервер.НаименованиеСервиса());
