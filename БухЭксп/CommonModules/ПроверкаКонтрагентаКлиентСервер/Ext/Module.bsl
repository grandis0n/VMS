...
// Возвращает наименование контрагента с сокращенными организационно-правовыми формами.
//
// Параметры:
//   Наименование - Строка - полное наименование контрагента или организации.
//
// Возвращаемое значение:
//   Строка - наименование с замененными полными названиями организационно-правовых форм на сокращения.
//
Функция СократитьНаименование(Наименование) Экспорт
	
	Результат = Наименование;
	
	СписокОПФ = Новый Соответствие;
	СписокОПФ.Вставить("Общество с ограниченной ответственностью", "ООО");
	СписокОПФ.Вставить("Публичное акционерное общество", "ПАО");
	СписокОПФ.Вставить("Открытое акционерное общество", "ОАО");
	СписокОПФ.Вставить("Закрытое акционерное общество", "ЗАО");
	СписокОПФ.Вставить("Акционерное общество", "АО");
	СписокОПФ.Вставить("Индивидуальный предприниматель", "ИП");
	СписокОПФ.Вставить("Федеральное государственное унитарное предприятие", "ФГУП");
	
	Для Каждого ОПФ Из СписокОПФ Цикл
		Результат = СтрЗаменить(Результат, ОПФ.Ключ, ОПФ.Значение);
		Результат = СтрЗаменить(Результат, ВРег(ОПФ.Ключ), ОПФ.Значение);
	КонецЦикла;
