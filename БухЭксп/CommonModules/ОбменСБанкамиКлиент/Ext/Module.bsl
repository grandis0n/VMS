...
Процедура СинхронизироватьСБанком(Организация = Неопределено, Банк = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(Организация) И ЗначениеЗаполнено(Банк) Тогда
		...
		Если ОбменСБанкамиСлужебныйКлиент.ЭтоМобильныйКлиент()
			...
			Реквизиты = Новый Структура("ПрограммаБанка,Банк,ИспользуетсяКриптография");
			ОбменСБанкамиСлужебныйВызовСервера.ПолучитьЗначенияРеквизитовНастройкиОбмена(НастройкаОбмена, Реквизиты);
			ДоступенОбмен = ОбменСБанкамиСлужебныйКлиент.ДоступнаРаботаНаМобильномКлиенте(Реквизиты.ПрограммаБанка,
				Реквизиты.ИспользуетсяКриптография);
			Если Не ДоступенОбмен Тогда
...
Процедура ПриНажатииНаГиперссылку(ДокументСсылка, СтандартнаяОбработка) Экспорт
	...
	Если ОбменСБанкамиСлужебныйКлиент.ЭтоМобильныйКлиент()
		И ЗначениеЗаполнено(РеквизитыЭД.ПрограммаБанка) Тогда
			
		ДоступенОбмен = ОбменСБанкамиСлужебныйКлиент.ДоступнаРаботаНаМобильномКлиенте(РеквизитыЭД.ПрограммаБанка,
			РеквизитыЭД.ИспользуетсяКриптография);
		Если НЕ ДоступенОбмен Тогда
...
Процедура ОбработатьПолучениеВыписки(Оповещение, ПараметрыОбмена, ДатаНачала, ДатаОкончания)
	...
	Если ОбменСБанкамиСлужебныйКлиент.ЭтоМобильныйКлиент() Тогда
		ДоступенОбмен = ОбменСБанкамиСлужебныйКлиент.ДоступнаРаботаНаМобильномКлиенте(
			РеквизитыНастройкиОбмена.ПрограммаБанка,
			РеквизитыНастройкиОбмена.ИспользуетсяКриптография);
