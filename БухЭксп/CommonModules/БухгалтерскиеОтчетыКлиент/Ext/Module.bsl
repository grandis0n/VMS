...
Процедура ПриОткрытии(Форма, Отказ) Экспорт
	...
	Если МобильныйКлиентБПКлиент.ЭтоМобильныйКлиент() Тогда
		//В мобильном клиенте Авто разыменовывается как Компактный
		Форма.УстановитьРежимОтображенияРезультата(РежимОтображенияРезультатаОтчета.Обычный);
	ИначеЕсли Форма.ПолучитьРежимОтображенияРезультата() = РежимОтображенияРезультатаОтчета.Компактный Тогда
