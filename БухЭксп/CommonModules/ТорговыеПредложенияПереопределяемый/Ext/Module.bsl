...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	ТорговыеПредложенияБП.ПриОпределенииНастроек(Настройки);
КонецПроцедуры
...
Процедура ФункциональнаяОпцияИспользуется(Знач ИмяФормы, Результат) Экспорт
	ТорговыеПредложенияБП.ФункциональнаяОпцияИспользуется(ИмяФормы, Результат);
КонецПроцедуры
...
//  ИмяСтавкиНДС - Строка - идентификатор ставки НДС, вида: "НДС0", "НДС5", "НДС5_105", "НДС7", "НДС7_107", "НДС10",
//  ........................"НДС10_110", "НДС18", "НДС18_118", "НДС20", "НДС20_120", "НДС22", "НДС22_122", "БезНДС".
//
Процедура ПолучитьИмяСтавкиНДС(Знач Ссылка, ИмяСтавкиНДС) Экспорт
	
	ТорговыеПредложенияБП.ПолучитьИмяСтавкиНДС(Ссылка, ИмяСтавкиНДС);
...
//  .........................например "НДС0", "НДС5", "НДС7", "НДС10", "НДС18", "НДС20", "НДС22", "БезНДС".
//  Ссылка		 - СправочникСсылка, ПеречислениеСсылка - ссылка на значение ставки НДС прикладного решения.
//
Процедура ПолучитьЗначениеСтавкиНДС(Знач ИмяСтавкиНДС, Ссылка) Экспорт
	
	ТорговыеПредложенияБП.ПолучитьЗначениеСтавкиНДС(ИмяСтавкиНДС, Ссылка);
...
Процедура ПолучитьПараметрыЕдиницыИзмерения(Знач Код, Ссылка, Представление) Экспорт
	ТорговыеПредложенияБП.ПолучитьПараметрыЕдиницыИзмерения(Код, Ссылка, Представление);
КонецПроцедуры
...
Процедура ЗаполнитьСведенияОНоменклатуре(ДанныеНоменклатуры) Экспорт
	ТорговыеПредложенияБП.ЗаполнитьСведенияОНоменклатуре(ДанныеНоменклатуры);
КонецПроцедуры
...
Процедура ПолучитьСвойстваТорговогоПредложения(Знач Источник, ЗначенияСвойств) Экспорт
	ТорговыеПредложенияБП.ПолучитьСвойстваТорговогоПредложения(Источник, ЗначенияСвойств);
КонецПроцедуры
...
Процедура ДобавитьСлужебныеКолонкиТовары(Товары, Знач ПолучатьШтрихКоды = Ложь) Экспорт
	ТорговыеПредложенияБП.ДобавитьСлужебныеКолонкиТовары(Товары, ПолучатьШтрихКоды);
КонецПроцедуры
...
Процедура ОпределитьКодЕдиницыИзмерения(ЕдиницаИзмерения, КодЕдиницыИзмерения) Экспорт
	ТорговыеПредложенияБП.ОпределитьКодЕдиницыИзмерения(ЕдиницаИзмерения, КодЕдиницыИзмерения);
КонецПроцедуры
...
Процедура ИнициализацияЗапросаПубликуемыхТоваров(Запрос) Экспорт
	ТорговыеПредложенияБП.ИнициализацияЗапросаПубликуемыхТоваров(Запрос);
КонецПроцедуры
...
Процедура ОпределитьОбрабатываемыеРеквизитыКарточкиТорговогоПредложения(Реквизиты) Экспорт 
	ТорговыеПредложенияБП.ОпределитьОбрабатываемыеРеквизитыКарточкиТорговогоПредложения(Реквизиты);
КонецПроцедуры
...
Процедура ОпределитьВладельцевНезаполненныхРеквизитов(ПроверяемыйРеквизит, СтрокаТорговогоПредложения, 
	...
	ТорговыеПредложенияБП.ОпределитьВладельцевНезаполненныхРеквизитов(ПроверяемыйРеквизит, СтрокаТорговогоПредложения, ДополнительныйРеквизит, СсылкаНаОбъект, ПутьКДанным, ТекстСообщения);
КонецПроцедуры
...
Процедура ОпределитьОбрабатываемыеПричиныИсключенияИзПубликации(Причины) Экспорт 
	ТорговыеПредложенияБП.ОпределитьОбрабатываемыеПричиныИсключенияИзПубликации(Причины);
КонецПроцедуры
