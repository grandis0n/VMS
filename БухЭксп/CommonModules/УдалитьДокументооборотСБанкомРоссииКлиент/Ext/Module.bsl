...
Процедура ОтправитьОтчет(Организация, СсылкаНаОтчет, ВладелецФормы = Неопределено) Экспорт
	...
	УдалитьДокументооборотСБанкомРоссииСлужебныйКлиент.ОтправитьОтчет(Организация, СсылкаНаОтчет, ВладелецФормы);
...
Процедура ПолучитьСтатусОтчета(ОповещениеОЗавершении, Отправка, ВладелецФормы = Неопределено) Экспорт
	...
	УдалитьДокументооборотСБанкомРоссииСлужебныйКлиент.ПолучитьСтатусОтчета(ОповещениеОЗавершении, Отправка, ВладелецФормы);
...
Процедура ПроверитьВозможностьВыполненияОперации(ОповещениеОЗавершении, ВладелецФормы = Неопределено, ПараметрыАутентификации = Неопределено) Экспорт
	...
	УдалитьДокументооборотСБанкомРоссииСлужебныйКлиент.ПроверитьВозможностьВыполненияОперации(
...
Функция ПолучитьНеЗавершенныеОтправки(Организация) Экспорт
	...
	Возврат УдалитьДокументооборотСБанкомРоссииВызовСервера.ПолучитьНеЗавершенныеОтправки(Организация);
...
Процедура ОткрытьФормуНастройки(Организация, ФормаВладелец = Неопределено, Окно = Неопределено) Экспорт 
	...
	Если ЗначениеЗаполнено(Организация) Тогда
		...
		ОткрытьФорму(
			"РегистрСведений.УдалитьНастройкиОбменаБанкРоссии.ФормаЗаписи",
			ПараметрыФормы,,,,,, 
			РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	Иначе
		ПараметрыОткрытия = Новый Структура;
		ПараметрыОткрытия.Вставить("ВидНастроек", ПредопределенноеЗначение("Перечисление.ТипыКонтролирующихОрганов.УдалитьБанкРоссии"));
		ОткрытьФорму(
...
Функция ПолучитьПоследнююОтправкуОтчета(ОтчетСсылка) Экспорт
	...
	Возврат УдалитьДокументооборотСБанкомРоссииВызовСервера.ПолучитьПоследнююОтправкуОтчета(ОтчетСсылка);
