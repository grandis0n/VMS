...
Процедура СохранитьДанныеВФайлКэша(ДокументЭДО, СвойстваВизуализации) Экспорт
	...
	Иначе
		...
		Если РасширениеОригинальногоФайлаВизуализацииPDF(СвойстваВизуализации) Тогда
			ПараметрыДобавленияФайла.ИмяБезРасширения = ИмяФайлаВизуализацииБезРасширения(СвойстваВизуализации);
		Иначе
...
// Возвращаемое значение:
//  Булево
Функция РасширениеОригинальногоФайлаВизуализацииPDF(СвойстваВизуализации)
	
	РасширениеФайла = ОбщегоНазначенияКлиентСервер.ПолучитьРасширениеИмениФайла(СвойстваВизуализации.ИмяФайла);
	Возврат РаботаСФайламиБЭДКлиентСервер.ЭтоРасширениеФайлаPDF(РасширениеФайла);
...
// Возвращаемое значение:
//  Строка
Функция ИмяФайлаВизуализацииБезРасширения(СвойстваВизуализации)
	
	СтруктураИмениФайла = ОбщегоНазначенияКлиентСервер.РазложитьПолноеИмяФайла(СвойстваВизуализации.ИмяФайла);
	Возврат СтруктураИмениФайла.ИмяБезРасширения;
...
Функция ПриРаспознаванииДокумента(ДанныеДокумента)
	...
	ИначеЕсли ЗначениеЗаполнено(ДанныеДокумента.ПроверкаЗаписанногоДокумента) 
		И ЗначениеЗаполнено(ДанныеДокумента.ПроверкаЗаписанногоДокумента.Ссылка) Тогда
		ДанныеДокументаДляРаспознавания = ДанныеДокумента.ПроверкаЗаписанногоДокумента;
	ИначеЕсли ЗначениеЗаполнено(ДанныеДокумента.ПроверкаНовогоДокумента) Тогда
		ДанныеДокументаДляРаспознавания = ДанныеДокумента.ПроверкаНовогоДокумента;
	Иначе
		Возврат РезультатРаспознавания;
	КонецЕсли;
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЭлектронноеВзаимодействие.ЭлектронноеАктированиеЕИС") Тогда
		МодульПодсистемы = ОбщегоНазначения.ОбщийМодуль("ЭлектронноеАктированиеЕИСПолучениеВходящих");
		МодульПодсистемы.ПриРаспознанииДокумента(ДанныеДокументаДляРаспознавания.ВидДокумента, РезультатРаспознавания);
	КонецЕсли;
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ЭлектронноеВзаимодействие.ОбменСГИСЭПД") Тогда
		МодульПодсистемы = ОбщегоНазначения.ОбщийМодуль("ОбменСГИСЭПД");
		МодульПодсистемы.ПриРаспознанииДокумента(ДанныеДокументаДляРаспознавания, РезультатРаспознавания);
	КонецЕсли;
	Возврат РезультатРаспознавания;
КонецФункции
