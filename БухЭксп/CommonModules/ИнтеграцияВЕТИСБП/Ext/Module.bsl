...
Процедура ЗаполнитьСырьеПродукцию(ДокументОбъект, ДанныеЗаполнения)
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ОписаниеНоменклатурыИС КАК ОписаниеНоменклатурыИС
	|		ПО Продукция.Номенклатура = ОписаниеНоменклатурыИС.Номенклатура
	|ГДЕ
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ОписаниеНоменклатурыИС КАК ОписаниеНоменклатурыИС
	|		ПО Материалы.Номенклатура = ОписаниеНоменклатурыИС.Номенклатура
	|ГДЕ
...
Функция УсловиеПродукцияВЕТИС()
	...
	Условие = "ОписаниеНоменклатурыИС.КлючВидовПродукции.ВидПродукцииВЕТИС <> ЗНАЧЕНИЕ(Справочник.ВидыПродукцииИС.ПустаяСсылка)";
