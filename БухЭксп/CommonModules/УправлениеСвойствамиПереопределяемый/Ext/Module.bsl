...
Процедура ПриПолученииПредопределенныхНаборовСвойств(Наборы) Экспорт
	...
	Документы.ОтражениеЗарплатыВБухучете.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ВедомостьНаВыплатуЗарплаты.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	Документы.ОтражениеДОППВДекларацииПоКосвеннымНалогам.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
