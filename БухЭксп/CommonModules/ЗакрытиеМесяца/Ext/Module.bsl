...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("АвтоматическоеЗакрытиеМесяцаРегламентноеЗадание");
...
//
// Параметры:
//  Организация - СправочникСсылка.Организации -  по этой организации выполняется проверка
//  Период - Дата - на эту дату выполняется проверка
//
// Возвращаемое значение:
//  Булево - Истина, есть неактуальные операции
//
