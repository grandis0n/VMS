...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса.БазоваяФункциональность") Тогда
		Методы.Вставить("ПолучениеУведомленийОтОнлайнОплат");
	КонецЕсли;
...
#Область НастройкиОнлайнОплат

Функция НастройкиОнлайнОплат()
	
	НастройкиОнлайнОплат = НовыйНастройкиОнлайнОплат();
	
	ИнтеграцияПодсистемБИП.ПриНастройкеОнлайнОплат(
		НастройкиОнлайнОплат);
	
	ОнлайнОплатыПереопределяемый.ПриНастройкеОнлайнОплат(
		НастройкиОнлайнОплат);
	
	Возврат НастройкиОнлайнОплат;
	
КонецФункции

Функция НовыйНастройкиОнлайнОплат()
...
Процедура УстановитьИспользованиеШаблоновСообщений() Экспорт
	...
	НастройкиОнлайнОплат = НастройкиОнлайнОплат();
	
	ИнтернетПоддержкаПользователей.УстановитьИспользованиеОтправкиШаблоновСообщений(
		НастройкиОнлайнОплат.ИспользоватьПодсистемуВзаимодействия);
