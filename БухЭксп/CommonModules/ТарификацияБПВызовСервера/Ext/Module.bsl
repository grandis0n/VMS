...
Функция ПараметрыОткрытияНастроекНДСОрганизации() Экспорт
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("ТекущаяЗакладка", "НДС");
	ПараметрыФормы.Вставить("Организация", РегистрыСведений.НастройкиУчетаНДС.ОрганизацияИспользующаяРаздельныйУчетНДС());
