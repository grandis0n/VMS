...
Функция НовыйПараметрыОбновленияСведенийОСформированныхЧеках() Экспорт
	
	ПараметрыОбновления = Новый Структура;
	ПараметрыОбновления.Вставить("Организация", ПредопределенноеЗначение("Справочник.Организации.ПустаяСсылка"));
	ПараметрыОбновления.Вставить("НачалоПериода", '00010101');
	ПараметрыОбновления.Вставить("КонецПериода", '00010101');
	ПараметрыОбновления.Вставить("УникальныйИдентификатор", Неопределено);
	ПараметрыОбновления.Вставить("ДокументОснование", Неопределено);
	ПараметрыОбновления.Вставить("СписокАннулированныхЧеков", Неопределено);
