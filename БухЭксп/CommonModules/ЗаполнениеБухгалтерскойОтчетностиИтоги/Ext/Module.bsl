...
Функция Счет(УсловныйКодСчета) Экспорт
	...
	ИначеЕсли УсловныйКодСчета = "68.43" Тогда
		Результат = Хозрасчетный.АкцизТаможенныйСоюзКУплате;
...
Функция СчетаСРеквизитами() Экспорт
	...
	ДобавитьПредопределенныйСчет(Матрикс, "68.43", "АкцизТаможенныйСоюзКУплате");
