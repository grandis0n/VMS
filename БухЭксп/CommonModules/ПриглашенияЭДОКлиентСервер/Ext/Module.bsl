...
Функция НовоеВходящееПриглашение(КлючПриглашения = "") Экспорт
	...
	Приглашение.Вставить("ВидУчетнойЗаписи", ПредопределенноеЗначение("Перечисление.ВидУчетнойЗаписиЭДО.ПустаяСсылка"));
...
Функция НовоеИсходящееПриглашение(ТипПриглашения) Экспорт
	...
	Результат.Вставить("ВидУчетнойЗаписи", ПредопределенноеЗначение("Перечисление.ВидУчетнойЗаписиЭДО.ПустаяСсылка"));
