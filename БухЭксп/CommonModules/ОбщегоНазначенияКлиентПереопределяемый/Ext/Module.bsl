...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	ОбщегоНазначенияБПКлиент.ПриНачалеРаботыСистемы();
...
Процедура ПослеНачалаРаботыСистемы() Экспорт
	...
	Если ПараметрыРаботыКлиента.ДоступноИспользованиеРазделенныхДанных Тогда
		...
		Если ПараметрыРаботыКлиента.Свойство("ИспользуетсяНеразрешенныйРаздельныйУчетНДС") Тогда
			ОткрытьФорму("РегистрСведений.НастройкиУчетаНДС.Форма.ИспользуетсяНедоступнаяФункциональность");
			// Если используется недоступная функциональность, то ничего больше не показываем - только окно недоступной функциональности.
			Возврат;
		КонецЕсли;
		...
		Если ПараметрыРаботыКлиента.Свойство("АктивироватьПрограмму")
			...
			Если Не ПользователиБПВызовСервера.ЭтоНеразделенныйПользовательИБ() Тогда
		...
		ИначеЕсли ПараметрыРаботыКлиента.Свойство("ПоказатьОбучение") 
			И ПараметрыРаботыКлиента.ПоказатьОбучение Тогда
			
			ОбщегоНазначенияБПКлиент.ОткрытьОбучение();
