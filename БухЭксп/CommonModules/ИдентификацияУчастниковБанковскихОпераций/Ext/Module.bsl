...
Функция ИдентификаторПоНомеруБанковскогоСчета(УчастникиОпераций,
	...
	Если ТипЗнч(БИК) = Тип("Строка") И Не ПустаяСтрока(БИК) Тогда
		...
		БазовыйИдентификатор = ИдентификаторПоНомеруБанковскогоСчета(
			УчастникиОпераций, НомерБанковскогоСчета, "", ИспользуетсяБанкДляРасчетов);
...
Функция ИдентификаторПоИдентификаторуЦифровогоРубля(УчастникиОпераций, ИдентификаторЦифровогоСчета, НомерСчета, БИК) Экспорт
	...
	ЦифровойСчет = БанковскиеСчетаСервер.ЭтоИдентификаторЦифровогоСчета(ИдентификаторЦифровогоСчета);
	...
	Состав = Новый Структура;
	Состав.Вставить("ИдентификаторЦифровогоСчета", ИдентификаторЦифровогоСчета);
	Состав.Вставить("БИК",                         БИК);
	Состав.Вставить("НомерБанковскогоСчета",       НомерСчета);
	...
	Возврат УстановитьИдентификатор(УчастникиОпераций, "DBAN", ИдентификаторЦифровогоСчета, Состав, Истина, "");
...
Процедура НайтиДоговорыКонтрагентовВИнформационнойБазе(УчастникиОпераций,
													   ОтборКонтрагент = Неопределено,
													   КешИдентификаторов = Неопределено) Экспорт
	...
	Пока ВыборкаИдентификаторы.Следующий() Цикл
		...
		Пока ВыборкаСсылки.Следующий() Цикл
			ДобавитьСсылку(УчастникиОпераций, ОписаниеИдентификатора, ВыборкаСсылки.Ссылка, ВыборкаСсылки, КешИдентификаторов);
		КонецЦикла;
	КонецЦикла;
