...
// Открывает форму настроек НДС органиазации.
//
Процедура ПерейтиВНастройкиНДСОрганизации() Экспорт
	
	ОткрытьФорму("ОбщаяФорма.НалогиИОтчеты", ТарификацияБПВызовСервера.ПараметрыОткрытияНастроекНДСОрганизации());
