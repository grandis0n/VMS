...
// Проверяет доступен ли обмен без приглашений по идентификатору иностранного контрагента
//
// Параметры:
//  ИдентификаторУчастника - Строка
//
// Возвращаемое значение:
//  Булево - доступен обмен без приглашений
//
Функция ИностранномуКонтрагентуДоступенОбменБезПриглашений(ИдентификаторУчастника) Экспорт
...
// Проверяет возможность автосоздания контрагента.
// 
// Параметры:
...
//  Булево
//
Функция ЗапрещеноАвтосозданиеКонтрагента(ИдентификаторКонтрагента) Экспорт
	Возврат ЭтоИностранныйОператор(ИдентификаторКонтрагента);
КонецФункции
