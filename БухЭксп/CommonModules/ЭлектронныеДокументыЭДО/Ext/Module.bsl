...
// Возвращает виды документов которые являются Счетом-Фактурой или Корректировочным Счетом-Фактурой
// 
// Возвращаемое значение:
//  Структура - Описание:
// * СФ - СправочникСсылка.ВидыДокументовЭДО - Ссылка на вид документа СФ.
// * КСФ - СправочникСсылка.ВидыДокументовЭДО - Ссылка на вид документа КСФ.
Функция ВидыДокументовСФ() Экспорт

	Результат = Новый Структура;
	Результат.Вставить("СФ", Справочники.ВидыДокументовЭДО.ПустаяСсылка());
	Результат.Вставить("КСФ", Справочники.ВидыДокументовЭДО.ПустаяСсылка());
	...
	Результат.СФ = ВидыДокументовПоТипам[Перечисления.ТипыДокументовЭДО.СчетФактура];
	Результат.КСФ = ВидыДокументовПоТипам[Перечисления.ТипыДокументовЭДО.КорректировочныйСчетФактура];
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	Списки.Вставить(Метаданные.Документы.ЧерновикЭлектронногоДокументаЭДО, Истина);
...
#Область ПервыйЗапуск
	...
	Обработчик.Процедура = "ЭлектронныеДокументыЭДО.ПервыйЗапуск";
...
#Область ОбновлениеЗамеровПроизводительности
...
Процедура СоздатьКлючевыеОперацииЗамеровПроизводительности()
	...
	Если Не ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ОценкаПроизводительности") Тогда
		Возврат;
	КонецЕсли;
	...
	МодульОценкаПроизводительности.СоздатьКлючевыеОперации(КлючевыеОперации);
