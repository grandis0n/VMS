...
// Сформирует приглашение в центре ЭДО.
// 
// Параметры:
//  ОповещениеОЗавершении - ОписаниеОповещения
//  Приглашения - Массив из см. ПриглашенияЭДОКлиентСервер.НовоеИсходящееПриглашение
Процедура СформироватьАвтоматическиеПриглашения(ОповещениеОЗавершении, Приглашения) Экспорт
	
	ПараметрыДействия = ПараметрыДействияСПриглашениями(ОповещениеОЗавершении, Приглашения);
	
	ДлительнаяОперация = ПриглашенияЭДОИнтеграцияЦентраЭДОВызовСервера.СформироватьПриглашенияВФоне(Приглашения);
