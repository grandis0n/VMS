...
Функция СоответствиеТитуловТипамМП(ПоТитулам = Ложь) Экспорт
	...
	Результат.Вставить("acceptance_rejection", ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_ОткП"));
	Результат.Вставить("unloading", ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_Титул4"));
	Результат.Вставить("unloading_rejection", ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_ОткТ3"));
...
Функция ИндексРаботыПоТитулу(Титул) Экспорт
	...
	Если Титул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_Титул2") 
		...
		Или Титул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_ОткТ3") Тогда
		Возврат ИндексРаботыВодитель();
		
	ИначеЕсли Титул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭПЛ_Титул2")
		Или Титул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭПЛ_ОткМ") Тогда
		Возврат ИндексРаботыМедработникДоРейса();
