...
Процедура ОткрытьСменуПослеВыбораУстройства(РезультатВыбора, КлючФормы) Экспорт
	...
	ДанныеКассира = МенеджерОборудованияКлиентСервер.ТекущийКассирДляФискальныхОпераций(РезультатВыбора.ИдентификаторУстройства);
	ЗаполнитьЗначенияСвойств(ПараметрыОперации, ДанныеКассира);
