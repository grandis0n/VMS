...
Функция ЭтоСчетРасчетовСПоставщиками(Счет) Экспорт
	...
	Возврат УчетВзаиморасчетов.ЭтоСчетРасчетовСПоставщиками(Счет);
...
Функция ЭтоСчетРасчетовСПокупателями(Счет) Экспорт
	...
	Возврат УчетВзаиморасчетов.ЭтоСчетРасчетовСПокупателями(Счет);
...
Функция ДатаПереходаНаОСНОЗаПериод(Организация, НачалоПериода, КонецПериода) Экспорт
	...
	Возврат Обработки.ПомощникПереходаСУСННаОСНО.ДатаПереходаНаОСНОЗаПериод(Организация, НачалоПериода, КонецПериода);
