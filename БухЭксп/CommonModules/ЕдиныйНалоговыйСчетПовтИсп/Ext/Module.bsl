...
Функция ВидыНалоговУплачиваемыеОтдельно(Период) Экспорт
	...
	Если ПолучитьФункциональнуюОпцию("ВедетсяУчетИмпортаТоваров") Тогда
		МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.ОбеспечительныйПлатежПриВвозеТоваровИзЕАЭС);
	КонецЕсли;
...
Функция ВидыНалоговУплачиваемыеБезУведомлений() Экспорт
	...
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_СпиртПищевой);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_СпиртПищевойДистилляты);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_СпиртНепищевой);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_СпиртосодержащаяПродукция);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_ВиноградноеСусло);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_Табак);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_Бензин);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_Автомобили);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_Дизель);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_МоторныеМасла);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_Вина);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_ВинаИгристые);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_Пиво);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_АлкогольСвыше9);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_Сидр);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_АлкогольДо9);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_БензинПрямогонный);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_СредниеДистилляты);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_НикотиносодержащиеЖидкости);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_ТабакНагреваемый);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_СахоросодержащиеНапитки);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_ФармацевтическаяСубстанция);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_НикотиновоеСырье);
	МассивВидовНалогов.Добавить(Перечисления.ВидыНалогов.АкцизыЕАЭС_БестабачнаяНикотиноваяСмесь);
