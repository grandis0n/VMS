...
// Обработчик регламентного задания ОбновлениеИдентификаторовБизнесСети
Процедура АктуализироватьИдентификаторыОрганизацийКонтрагентов() Экспорт
	
	// Обработчик БСП
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(
		Метаданные.РегламентныеЗадания.ОбновлениеИдентификаторовБизнесСети);
	...
	РегистрыСведений.КонтрагентыБизнесСеть.Актуализировать();
	РегистрыСведений.ОрганизацииБизнесСеть.Актуализировать();
...
Процедура ПриПолученииСпискаШаблонов(ШаблоныЗаданий) Экспорт
	...
	ШаблоныЗаданий.Добавить(Метаданные.РегламентныеЗадания.ОбновлениеИдентификаторовБизнесСети.Имя);
...
Процедура ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам) Экспорт
	...
	СоответствиеИменПсевдонимам.Вставить(Метаданные.РегламентныеЗадания.ОбновлениеИдентификаторовБизнесСети.ИмяМетода);
	СоответствиеИменПсевдонимам.Вставить(
		"БизнесСеть.АктуализироватьКэшДанныхКонтрагентов", 
		Метаданные.РегламентныеЗадания.ОбновлениеИдентификаторовБизнесСети.ИмяМетода);
...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	НоваяСтрока.РегламентноеЗадание = Метаданные.РегламентныеЗадания["ОбновлениеИдентификаторовБизнесСети"];
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("АктуализироватьИдентификаторыОрганизацийКонтрагентов", Истина);
...
Процедура УдалитьКлючДоступаИзЛокальногоХранилища(ИдентификаторОрганизации) Экспорт
...
Процедура ЗаписатьИдентификаторОрганизации(Организация, Идентификатор)
	...
	Попытка
		...
		НоваяЗапись.ИНН           = ДанныеОрганизации.ИНН;
		НоваяЗапись.КПП           = ДанныеОрганизации.КПП;
