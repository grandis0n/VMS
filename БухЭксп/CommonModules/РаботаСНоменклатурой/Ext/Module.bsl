...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗагрузитьХарактеристики", Истина);
	Методы.Вставить("ПолучитьДанныеХарактеристикСервиса", Истина);
	Методы.Вставить("ПроверитьИспользованиеОбъекта", Истина);
	Методы.Вставить("ЗагрузитьДополнительныеДанные", Истина);
