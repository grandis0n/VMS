...
//        Допустимые значения :
//          "1" - устарело. Для кассовой ссылки будет сформирован макет формата А5 широкий;
//          "2" - устарело. Для кассовой ссылки будет сформирован макет формата А5 только логотипы;
//          "3" - устарело. Для кассовой ссылки будет сформирован макет формата А5 узкий;
//          "4" - устарело. Для кассовой ссылки будет сформирован макет формата А5 узкий горизонтальный;
//          "5" - устарело. Для кассовой ссылки будет сформирован макет формата А6 квадратный;
//          "6" - устарело. Для кассовой ссылки будет сформирован макет формата А6 круглый.
//          "7" - для кассовой ссылки будет сформирован макет формата А5 с УПК горизонтальный;
//          "8" - для кассовой ссылки будет сформирован макет формата А5 с УПК вертикальный;
//
// Возвращаемое значение:
...
Функция КарточкаКассовойСсылки(
	...
	ИначеЕсли ПараметрыПечати.ТипПечати = 7 Тогда
		Макет = СистемаБыстрыхПлатежейСлужебный.ПолучитьМакетСБП("CashLinkHorizontalUPC");
	ИначеЕсли ПараметрыПечати.ТипПечати = 8 Тогда
		Макет = СистемаБыстрыхПлатежейСлужебный.ПолучитьМакетСБП("CashLinkVerticalUPC");
...
Функция ПлатежныеСсылкиПоДокументамОпераций(
	...
	ПереводыСБПc2bСлужебный.ПроверитьПраваНаЧтениеОпераций();
