...
Функция НастройкиПримененияСт54ПолучитьКоличествоДокументов(СтруктураПараметров, УникальныйИдентификатор) Экспорт
	
	ДлительнаяОперация = Обработки.ИсправитьДокументыПриИзмененииНастроекСт54НК.ЗапуститьПолучениеТаблицыДокументовВФоне(
		СтруктураПараметров, УникальныйИдентификатор, Истина);
