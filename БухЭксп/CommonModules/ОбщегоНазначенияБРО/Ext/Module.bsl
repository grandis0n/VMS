...
Процедура ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ИнтеграцияСОтчетность24") Тогда
		МодульИнтеграцияСОтчетность24 = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияСОтчетность24");
		МодульИнтеграцияСОтчетность24.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	КонецЕсли;
...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ИнтеграцияСОтчетность24") Тогда
		МодульИнтеграцияСОтчетность24 = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияСОтчетность24");
		МодульИнтеграцияСОтчетность24.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	КонецЕсли;
...
Процедура ПриПолученииСпискаШаблонов(ШаблоныЗаданий) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("РегламентированнаяОтчетность.ИнтеграцияСОтчетность24") Тогда
		МодульИнтеграцияСОтчетность24 = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияСОтчетность24");
		МодульИнтеграцияСОтчетность24.ПриПолученииСпискаШаблонов(ШаблоныЗаданий);
	КонецЕсли;
