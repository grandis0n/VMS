...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОбновитьПараметрыРегистрацииОборудования");
	Методы.Вставить("ОтключитьИспользованиеРегламентногоЗадания");
	Методы.Вставить("ОбновитьМакетыЭтикеток");
	Методы.Вставить("СоздатьВидыКонтактнойИнформации");
	Методы.Вставить("ОбновитьШаблоныЭтикетокИЦенников");
	Методы.Вставить("ОбновитьПодключаемоеОборудование");
	Методы.Вставить("ОбновитьПоставляемыеДрайвера");
	Методы.Вставить("УстановитьСрокХраненияОперацийСОборудованием");
	Методы.Вставить("УстановитьСрокХраненияОпераций");
