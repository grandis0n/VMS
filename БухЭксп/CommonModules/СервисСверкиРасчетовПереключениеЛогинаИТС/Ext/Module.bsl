...
Функция ДанныеЗаявления(Организации)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(ПодписиОрганизации) Тогда 
			Если ПодписиОрганизации.Свойство("ФаксимилеПечать") Тогда
				Если ЗначениеЗаполнено(ПодписиОрганизации.ФаксимилеПечать) Тогда
					ДанныеЗаявления.ФаксимилеПечать = Новый ХранилищеЗначения(ПодписиОрганизации.ФаксимилеПечать);
				КонецЕсли;
			КонецЕсли;
			Если ПодписиОрганизации.Свойство("ФаксимилеРуководитель") Тогда
				Если ЗначениеЗаполнено(ПодписиОрганизации.ФаксимилеРуководитель) Тогда
		...
		ДанныеЗаявления.Пользователь = ДанныеЗаявления.ФИОРуководителя;
