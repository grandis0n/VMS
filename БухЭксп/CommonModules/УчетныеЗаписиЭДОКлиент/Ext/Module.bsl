...
Процедура ЗаписатьДолжностьСертификатаУчетнойЗаписи(Должность, Сертификат, ИдентификаторЭДО) Экспорт
	...
	УчетныеЗаписиЭДОСлужебныйВызовСервера.ЗаписатьДолжностьСертификатаУчетнойЗаписи(
		Должность, Сертификат, ИдентификаторЭДО);
...
Функция ДолжностьПоСертификатуУчетнойЗаписи(ИдентификаторЭДО, Сертификат) Экспорт
	...
	Возврат УчетныеЗаписиЭДОСлужебныйВызовСервера.ДолжностьПоСертификатуУчетнойЗаписи(ИдентификаторЭДО, Сертификат);
