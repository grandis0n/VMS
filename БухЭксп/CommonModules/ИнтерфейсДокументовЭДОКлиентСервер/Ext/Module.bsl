...
Функция НовыеПараметрыСозданияДокументаПоФайлу() Экспорт
	...
	Параметры.Вставить("Черновик", Неопределено);
	Возврат Параметры;
...
Функция ПредставлениеДокументаПоСвойствам(СвойстваДокумента, ЭтоНовый = Ложь) Экспорт
	...
	ПриОпределенииПредставленияДокументаПоСвойствам(Представление, СвойстваДокумента);
...
Процедура ОбработкаПолученияПолейПредставленияДокумента(Поля, СтандартнаяОбработка) Экспорт
	...
	ПриОпределенииПолейПредставленияДокумента(Поля);
КонецПроцедуры
...
// Параметры:
//  Поля - Массив из Строка
Процедура ПриОпределенииПолейПредставленияДокумента(Поля)
	ЧерновикиЭДОКлиентСервер.ПриОпределенииПолейПредставленияДокумента(Поля);
КонецПроцедуры

// Параметры:
//  Представление - Строка
//  СвойстваДокумента - См. ПредставлениеДокументаПоСвойствам.СвойстваДокумента
Процедура ПриОпределенииПредставленияДокументаПоСвойствам(Представление, СвойстваДокумента)
	ЧерновикиЭДОКлиентСервер.ПриОпределенииПредставленияДокументаПоСвойствам(Представление, СвойстваДокумента);
КонецПроцедуры
