...
Процедура УстановитьДоступностьФормы(ТипДокумента, Параметры) Экспорт
	...
	Если РезультатПроверки.ЕстьНедоступнаяСистемаНалогообложения
		...
		Или РезультатПроверки.ЕстьНедоступныйВидОрганизации
		Или РезультатПроверки.ЕстьНеразрешенныйРаздельныйУчетНДС Тогда
...
Процедура ПроверитьТарифыОбработкаПроверкиЗаполнения(Источник, Отказ, ПроверяемыеРеквизиты) Экспорт
	...
	Если РезультатПроверкиУсловийТарифа.ЕстьНедоступнаяФункциональность
		...
		Или РезультатПроверкиУсловийТарифа.ЕстьНедоступныйВидОрганизации
		Или РезультатПроверкиУсловийТарифа.ЕстьНеразрешенныйРаздельныйУчетНДС Тогда
...
Функция РезультатПроверкиУсловийТарифа() Экспорт
	...
	РезультатПроверки.Вставить("ЕстьНеразрешенныйРаздельныйУчетНДС", Ложь);
	...
	ЕстьНеразрешенныйРаздельныйУчетНДС =
		ТарификацияБПВызовСервераПовтИсп.ИспользуетсяНеразрешенныйРаздельныйУчетНДС();
	...
	Если ЕстьНеразрешенныйРаздельныйУчетНДС Тогда
		
		ТекстСообщения.Добавить(НСтр("ru = 'В программе используется раздельный учет НДС, который не входит в ваш тариф.
			|Чтобы продолжить работу на текущем тарифе, отключите раздельный учет НДС в ""Настройках налогов и отчетов"".'"));
	...
	РезультатПроверки.ЕстьНеразрешенныйРаздельныйУчетНДС = ЕстьНеразрешенныйРаздельныйУчетНДС;
