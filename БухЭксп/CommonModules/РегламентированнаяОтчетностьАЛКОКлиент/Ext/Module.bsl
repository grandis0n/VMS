...
Процедура ПослеВыполненияДлительнойОперацииАЛКО(Форма,
		СтрукРеквизитовФормы = Неопределено) Экспорт
...
Процедура ЗаполнитьАвтоЗавершениеАЛКО(Отказ, Форма) Экспорт
	...
	РегламентированнаяОтчетностьКлиентПереопределяемый.ПроверитьВозможностьЗаполненияИзУчетныхБаз(Форма.ИмяФормы, ЗаполнениеИзУчетнойБазы);
