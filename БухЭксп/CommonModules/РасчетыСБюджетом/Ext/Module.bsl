...
Функция ТаблицаСоответствияСчетовУчета()
	...
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_СпиртПищевой,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_СпиртПищевойДистилляты,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_СпиртНепищевой,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_СпиртосодержащаяПродукция,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_ВиноградноеСусло,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_Табак,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_Бензин,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_Автомобили,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_Дизель,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_МоторныеМасла,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_Вина,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_ВинаИгристые,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_Пиво,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_АлкогольСвыше9,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_Сидр,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_АлкогольДо9,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_БензинПрямогонный,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_СредниеДистилляты,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_НикотиносодержащиеЖидкости,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_ТабакНагреваемый,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_СахоросодержащиеНапитки,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_ФармацевтическаяСубстанция,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_НикотиновоеСырье,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
	ДобавитьСчетУчета(
		ТаблицаЗначений,
		Перечисления.ВидыНалогов.АкцизыЕАЭС_БестабачнаяНикотиноваяСмесь,
		ПланыСчетов.Хозрасчетный.АкцизТаможенныйСоюзКУплате);
