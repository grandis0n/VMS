...
//  
// Параметры:
//  ПротоколыОбмена - Массив - Протоколы обмена ФЭС НСПК
//
Процедура ДоступныеПротоколыОбменаФЭСНСПК(ПротоколыОбмена) Экспорт
...
// Возвращает для каких типов идентификаторов будет заполняться тег 1163 (код товара).
//
// Параметры:
