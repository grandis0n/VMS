	...
	Если ШтрихкодыУпаковок <> Неопределено Тогда
		...
		Для каждого СтрокаШтрихкодыУпаковок Из ШтрихкодыУпаковок Цикл
			...
			СтрокаШтрихкодыУпаковок.ЕдиничныйКод = РазборКодаМаркировкиИССлужебныйКлиентСервер.НормализоватьКодМаркировки(
													РезультатРазбора, ,ПараметрыНормализацииМОТП);
			...
			ДанныеПоШтрихкодамEANТаблица = ДанныеПоШтрихкодамEAN.ДанныеПоШтрихкодамEAN;
			
			Если ДанныеПоШтрихкодамEANТаблица.Количество() > 0 Тогда
				
				ВидУпаковки = ДанныеПоШтрихкодамEANТаблица[0].ВидУпаковкиИС;
...
Функция ТекстЗапросаТоварыСтатформаЭкспорт(ИмяДокумента)
	...
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(СправочникНоменклатура.Производитель, ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)) = ЗНАЧЕНИЕ(Справочник.Контрагенты.ПустаяСсылка)
	|			ТОГДА """"
	|		КОГДА СправочникНоменклатура.Производитель.НаименованиеПолное = """"
	|			ТОГДА СправочникНоменклатура.Производитель.Наименование
	|		ИНАЧЕ СправочникНоменклатура.Производитель.НаименованиеПолное
...
Процедура ПолучитьСведенияОПоказателяхОтчетаКосвенныеНалогиПриИмпорте(ИДРедакцииОтчета, ПоказателиОтчета) Экспорт
	
	Если ИДРедакцииОтчета = "ФормаОтчета2026Кв2" Тогда
		
		ПолучитьСведенияОПоказателяхОтчетаКосвенныеНалогиПриИмпортеФормаОтчета2026Кв2(ПоказателиОтчета);
		УчетНДСОтчетыПереопределяемый.ПолучитьСведенияОПоказателяхОтчетаКосвенныеНалогиПриИмпортеТоваровФорма2026Кв2(ПоказателиОтчета);
		
	ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2023Кв3" Тогда
	
		ПолучитьСведенияОПоказателяхОтчетаКосвенныеНалогиПриИмпортеФормаОтчета2023Кв3(ПоказателиОтчета);
		
	ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2017Кв4" Тогда
		
		ПолучитьСведенияОПоказателяхОтчетаКосвенныеНалогиПриИмпортеФормаОтчета2017Кв4(ПоказателиОтчета);
...
Процедура ЗаполнитьОтчетКосвенныеНалогиПриИмпорте(ИДРедакцииОтчета, ПараметрыОтчета, Контейнер) Экспорт

	Если ИДРедакцииОтчета = "ФормаОтчета2026Кв2" Тогда
		
		ЗаполнитьОтчетКосвенныеНалогиПриИмпортеФормаОтчета2026Кв2(ПараметрыОтчета, Контейнер);
		УчетНДСОтчетыПереопределяемый.ЗаполнитьОтчетКосвенныеНалогиПриИмпортеТоваровФормаОтчета2026Кв2(ПараметрыОтчета, Контейнер);
		
	ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2023Кв3" Тогда
		
		ЗаполнитьОтчетКосвенныеНалогиПриИмпортеФормаОтчета2023Кв3(ПараметрыОтчета, Контейнер);
		
	ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2017Кв4" Тогда
		
		ЗаполнитьОтчетКосвенныеНалогиПриИмпортеФормаОтчета2017Кв4(ПараметрыОтчета, Контейнер);
...
Процедура ЗаполнитьОтчетКосвенныеНалогиПриИмпортеФормаОтчета2017Кв4(ПараметрыОтчета, Контейнер)
	
	ЗаполнитьДекларациюПоКосвеннымНалогамРаздел1(ПараметрыОтчета, Контейнер);
...
Процедура ПолучитьСведенияОПоказателяхОтчетаКосвенныеНалогиПриИмпортеФормаОтчета2017Кв4(ПоказателиОтчета)
	
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000010003103", Истина, Ложь);
	
КонецПроцедуры

Процедура ЗаполнитьОтчетКосвенныеНалогиПриИмпортеФормаОтчета2023Кв3(ПараметрыОтчета, Контейнер)
...
Процедура ЗаполнитьДекларациюПоКосвеннымНалогамРаздел1(ПараметрыОтчета, Контейнер)
...
Процедура ЗаполнитьДекларациюПоКосвеннымНалогамРаздел4(ПараметрыОтчета, Контейнер)
	...
	УчетНДСПереопределяемый.ТекстЗапросаКосвенныеНалогиСведенияИзДОПП(Запрос);
	...
	ОчиститьРаздел4ДекларацииПоКосвеннымНалогам(Раздел4, Результат.Пустой());
	
	Если Не Результат.Пустой() Тогда
		
		НоваяСтраница = Раздел4.Строки.Добавить();
		
		НоваяСтраница.Данные = Новый Структура();
		НоваяСтраница.ДанныеМногострочныхЧастей = Новый Структура("П00004М1", ДеревоЗначенийРеестрНДСПриложение());
		
		ВыборкаПоКБК = Результат.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
		Пока ВыборкаПоКБК.Следующий() Цикл
			
			НовыйКБК = НоваяСтраница.ДанныеМногострочныхЧастей.П00004М1.Строки.Добавить();
			
			СтруктураДанныхДекларации = Новый Структура;
			СтруктураДанныхДекларации.Вставить("П00004М101000", ВыборкаПоКБК.КБК);
			
			НовыйКБК.Данные = СтруктураДанныхДекларации;
			НовыйКБК.ДанныеМногострочныхЧастей = Новый Структура("П00004М2", ДеревоЗначенийРеестрНДСПриложение());
			
			ВыборкаПоДОПП = ВыборкаПоКБК.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
			Пока ВыборкаПоДОПП.Следующий() Цикл
				
				НовыйДОПП = НовыйКБК.ДанныеМногострочныхЧастей.П00004М2.Строки.Добавить();
				
				СтруктураДанныхСуммы = Новый Структура;
				СтруктураДанныхСуммы.Вставить("П00004М202000", ВыборкаПоДОПП.ДОПП);
				СтруктураДанныхСуммы.Вставить("П00004М203000", ВыборкаПоДОПП.СуммаНалогаАкциза);	
				
				НовыйДОПП.Данные = СтруктураДанныхСуммы;
				НовыйДОПП.ДанныеМногострочныхЧастей = Новый Структура();
...
Процедура ОчиститьРаздел4ДекларацииПоКосвеннымНалогам(Раздел, НетДанных)
	
	Раздел.Строки.Очистить();
	
	Если НетДанных Тогда
	
		НоваяСтраница = Раздел.Строки.Добавить();
		НоваяСтраница.Данные = Новый Структура();
		НоваяСтраница.ДанныеМногострочныхЧастей = Новый Структура("П00004М1", ДеревоЗначенийРеестрНДСПриложение());
		...
		СтруктураДанныхДекларации = Новый Структура;
		СтруктураДанныхДекларации.Вставить("П00004М101000", "");
		...
		НовыйДОПП = НовыйКБК.ДанныеМногострочныхЧастей.П00004М2.Строки.Добавить();
		СтруктураДанныхСуммы = Новый Структура;
		СтруктураДанныхСуммы.Вставить("П00004М202000", "");
		СтруктураДанныхСуммы.Вставить("П00004М203000", 0);
...
// Создает список показателей декларации по косвенным налогам при импорте товаров, которые будут автоматически заполняться.
// Для версии отчета ФормаОтчета2023Кв3.
Процедура ПолучитьСведенияОПоказателяхОтчетаКосвенныеНалогиПриИмпортеФормаОтчета2023Кв3(ПоказателиОтчета)
	
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000010003103", Истина, Ложь);
	
КонецПроцедуры

Процедура ПолучитьСведенияОПоказателяхОтчетаКосвенныеНалогиПриИмпортеФормаОтчета2026Кв2(ПоказателиОтчета)
	
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П000010003103", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П00004М101000", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П00004М202000", Истина, Ложь);
	РегламентированнаяОтчетность.ВставитьПоказательВСтруктуру(ПоказателиОтчета, "П00004М203000", Истина, Ложь);
	
КонецПроцедуры

Процедура ЗаполнитьОтчетКосвенныеНалогиПриИмпортеФормаОтчета2026Кв2(ПараметрыОтчета, Контейнер)
	
	ЗаполнитьДекларациюПоКосвеннымНалогамРаздел1(ПараметрыОтчета, Контейнер);
	ЗаполнитьДекларациюПоКосвеннымНалогамРаздел4(ПараметрыОтчета, Контейнер);
...
#Область ПодготовкаОбщихДанных
	...
	ИначеЕсли НЕ ПараметрыОтчета.Свойство("ТолькоПоказателиДекларацииНДС") 
		И Не ПараметрыОтчета.Свойство("ИсточникДанныхДляОблака") // ИнтеграцияСОтчетность24
		Тогда 
		Возврат;
	КонецЕсли;
...
#Область ОбщиеПараметрыМногостраничныхРазделов
	...
	Если ПараметрыОтчета.Свойство("ТолькоПоказателиДекларацииНДС")
		И Не ПараметрыОтчета.Свойство("ИсточникДанныхДляОблака") // ИнтеграцияСОтчетность24
		Тогда
		Возврат;
	КонецЕсли;
...
#Область ИнтеграцияСОтчетность24
		Если ПараметрыОтчета.Свойство("ИсточникДанныхДляОблака") Тогда
			СтруктураДанныхРаздела = Новый Структура("ИтогиРаздел, ТаблицаРаздел", 
				ПараметрыРаздел8.ИтогиРаздел8, ПараметрыРаздел8.ТаблицаРаздел8);
			Контейнер.Вставить("ДанныеРаздел8", СтруктураДанныхРаздела);
	
			СтруктураДанныхРаздела = Новый Структура("ИтогиРаздел, ТаблицаРаздел", 
				ПараметрыРаздел8.ИтогиРаздел81, ПараметрыРаздел8.ТаблицаРаздел81);
			Контейнер.Вставить("ДанныеРаздел81", СтруктураДанныхРаздела);
		КонецЕсли;
#КонецОбласти
...
#Область ИнтеграцияСОтчетность24
	Если ПараметрыОтчета.Свойство("ИсточникДанныхДляОблака") Тогда
		Если Не Контейнер.Свойство("ДанныеРаздел81") Тогда
			СтруктураДанныхРаздела = Новый Структура("ИтогиРаздел, ТаблицаРаздел", 
				ПараметрыРаздел8.ИтогиРаздел81, ПараметрыРаздел8.ТаблицаРаздел81);
		Иначе
			СтруктураДанныхРаздела.ИтогиРаздел = ПараметрыРаздел8.ИтогиРаздел81;
			СтруктураДанныхРаздела.ТаблицаРаздел = ПараметрыРаздел8.ТаблицаРаздел81;
		КонецЕсли;
		Контейнер.Вставить("ДанныеРаздел81", СтруктураДанныхРаздела);
	КонецЕсли;
#КонецОбласти
...
#Область ИнтеграцияСОтчетность24
	Если ПараметрыОтчета.Свойство("ИсточникДанныхДляОблака") Тогда
		СтруктураДанныхРаздела = Новый Структура("ИтогиРаздел, ТаблицаРаздел", ПараметрыРаздел9.ИтогиРаздел9, ПараметрыРаздел9.ТаблицаРаздел9);
		Контейнер.Вставить("ДанныеРаздел9", СтруктураДанныхРаздела);
		
		СтруктураДанныхРаздела = Новый Структура("ИтогиРаздел, ТаблицаРаздел", 
			ПараметрыРаздел9.ИтогиРаздел91, ПараметрыРаздел9.ТаблицаРаздел91);
		Контейнер.Вставить("ДанныеРаздел91", СтруктураДанныхРаздела);
	КонецЕсли;
#КонецОбласти
...
#Область ИнтеграцияСОтчетность24
	Если ПараметрыОтчета.Свойство("ИсточникДанныхДляОблака") Тогда
		Если Не Контейнер.Свойство("ДанныеРаздел91") Тогда
			СтруктураДанныхРаздела = Новый Структура("ИтогиРаздел, ТаблицаРаздел", 
				ПараметрыРаздел9.ИтогиРаздел91, ПараметрыРаздел9.ТаблицаРаздел91);
		Иначе
			СтруктураДанныхРаздела.ИтогиРаздел = ПараметрыРаздел9.ИтогиРаздел91;
			СтруктураДанныхРаздела.ТаблицаРаздел = ПараметрыРаздел9.ТаблицаРаздел91;
		КонецЕсли;
		Контейнер.Вставить("ДанныеРаздел91", СтруктураДанныхРаздела);
	КонецЕсли;
#КонецОбласти
...
#Область ИнтеграцияСОтчетность24
	Если ПараметрыОтчета.Свойство("ИсточникДанныхДляОблака") Тогда
		ПараметрыРаздела = ПолучитьИзВременногоХранилища(АдресХранилища);
		СтруктураДанныхРаздела = Новый Структура("ТаблицаРаздел", ПараметрыРаздела.ТаблицаРаздел10);
		Контейнер.Вставить("ДанныеРаздел10", СтруктураДанныхРаздела);
		СтруктураДанныхРаздела = Новый Структура("ТаблицаРаздел", ПараметрыРаздела.ТаблицаРаздел11);
		Контейнер.Вставить("ДанныеРаздел11", СтруктураДанныхРаздела);
	КонецЕсли;
#КонецОбласти
...
#Область ИнтеграцияСОтчетность24
		Если ПараметрыОтчета.Свойство("ИсточникДанныхДляОблака") Тогда
			СтруктураДанныхРаздела = Новый Структура("ТаблицаРаздел", ТаблицаРаздел12);
			Контейнер.Вставить("ДанныеРаздел12", СтруктураДанныхРаздела);
		КонецЕсли;
#КонецОбласти
