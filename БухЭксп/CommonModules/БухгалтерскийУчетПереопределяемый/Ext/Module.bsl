...
Функция ПолучитьСведенияОСпискеНоменклатуры(Знач СписокНоменклатуры, ПараметрыОбъекта, ОпределятьСчета = Истина, ОпределятьЦены = Истина) Экспорт
	...
	ИменаРеквизитов =
		...
		|ПериодичностьУслуги, ПрослеживаемыйТовар, ПрослеживаемыйКомплект,
	...
	Для Каждого Номенклатура Из СписокНоменклатуры Цикл
		...
		Если ТипЗнч(Номенклатура) = Тип("СправочникСсылка.Номенклатура") Тогда
			СвойстваНоменклатурыИС = ОбщегоНазначенияИС.СвойстваМаркируемойПродукции(Номенклатура);
			СведенияОНоменклатуре.Вставить("ВидПродукцииИС", СвойстваНоменклатурыИС.ВидПродукции);
			СведенияОНоменклатуре.Вставить("МаркируемаяПродукция", СвойстваНоменклатурыИС.МаркируемаяПродукция);
		Иначе
			СведенияОНоменклатуре.Вставить("ВидПродукцииИС", Справочники.КлючиВидовПродукцииИС.ПустаяСсылка());
			СведенияОНоменклатуре.Вставить("МаркируемаяПродукция", Ложь);
		КонецЕсли;
		//Конец БгосИС 2.0
		...
		ЭтоМаркируемаяПродукцияЕГАИС = ПолучитьФункциональнуюОпцию("ВестиСведенияДляДекларацийПоАлкогольнойПродукции") 
			И КонструкторИСОбщегоНазначенияКлиентСервер.ЭтоМаркируемаяПродукцияЕГАИС(СведенияОНоменклатуре.ВидПродукцииИС);
		
		СведенияОНоменклатуре.Вставить("АлкогольнаяПродукция", ЭтоМаркируемаяПродукцияЕГАИС);
		...
		Если НЕ ПолучитьФункциональнуюОпцию("ИспользоватьКонтрольныеЗнакиГИСМ")
		 ...
		 ИЛИ НЕ КонструкторИСОбщегоНазначенияКлиентСервер.ЭтоПродукцияМЕХ(СведенияОНоменклатуре.ВидПродукцииИС) Тогда
