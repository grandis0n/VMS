...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса.БазоваяФункциональность") Тогда
		Методы.Вставить("ЗагрузкаСтатусовОнлайнЗаказов");
	КонецЕсли;
...
#Область НастройкиОнлайнЗаказов

Функция НастройкиОнлайнЗаказов()
	
	НастройкиОнлайнЗаказов = НовыйНастройкиОнлайнЗаказов();
	
	ИнтеграцияПодсистемБИП.ПриНастройкеОнлайнЗаказов(
		НастройкиОнлайнЗаказов);
	
	ОнлайнЗаказыПереопределяемый.ПриНастройкеОнлайнЗаказов(
		НастройкиОнлайнЗаказов);
		
	Возврат НастройкиОнлайнЗаказов;
	
КонецФункции

Функция НовыйНастройкиОнлайнЗаказов()
	
	Результат = Новый Структура;
	Результат.Вставить(
		"ИспользоватьПодсистемуВзаимодействия",
		ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.Взаимодействия"));
...
Процедура УстановитьИспользованиеШаблоновСообщений() Экспорт
	...
	НастройкиОнлайнЗаказов = НастройкиОнлайнЗаказов();
	
	ИнтернетПоддержкаПользователей.УстановитьИспользованиеОтправкиШаблоновСообщений(
		НастройкиОнлайнЗаказов.ИспользоватьПодсистемуВзаимодействия);
