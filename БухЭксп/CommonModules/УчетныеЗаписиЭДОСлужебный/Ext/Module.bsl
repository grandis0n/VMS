...
Функция СоздатьУчетнуюЗапись(ОписаниеУчетнойЗаписи, АдресИзменен = Ложь) Экспорт
...
Процедура ЗаполнитьДанныеУчетнойЗаписи(НоваяУчетнаяЗапись, ОписаниеУчетнойЗаписи) Экспорт
	...
	ЗаполнитьЗначенияСвойств(НоваяУчетнаяЗапись, ПараметрыУведомлений,
		"УведомлятьОНовыхПриглашениях, УведомлятьОбОтветахНаПриглашения, УведомлятьОНовыхДокументах,
		|УведомлятьОНеОбработанныхДокументах, УведомлятьОбОкончанииСрокаДействияСертификата");
	НоваяУчетнаяЗапись.ЭлектроннаяПочтаДляУведомлений = ПараметрыУведомлений.АдресУведомлений;
	
	ЗаполнитьЗначенияСвойств(НоваяУчетнаяЗапись, ОписаниеУчетнойЗаписи,
		"Организация, АдресОрганизации, АдресОрганизацииЗначение, КодНалоговогоОргана, ПринятыУсловияИспользования,
		|ИспользоватьЦентрЭДО, НеИспользоватьПриглашения");
	...
	НоваяУчетнаяЗапись.КодыТиповДокументовКОбмену = 
		ОбщегоНазначения.ЗначениеВJSON(ОписаниеУчетнойЗаписи.КодыТиповДокументовКОбмену);
	
	НоваяУчетнаяЗапись.ВидУчетнойЗаписи = ОписаниеУчетнойЗаписи.ВидУчетнойЗаписи;
	Если НоваяУчетнаяЗапись.ВидУчетнойЗаписи = Перечисления.ВидУчетнойЗаписиЭДО.ФизическоеЛицо Тогда
		НоваяУчетнаяЗапись.КодНалоговогоОргана = "";
	КонецЕсли;
...
Функция НеСохраненныеРеквизитыУчетнойЗаписи(ИдентификаторУчетнойЗаписи, ИзмененыПараметрыУчетнойЗаписи,
	...
	Если ИзмененыНастройкиУведомлений Тогда
		...
		МассивСтрок.Добавить("УчетныеЗаписиЭДО.УведомлятьОбОтветахНаПриглашения КАК УведомлятьОбОтветахНаПриглашения");
		МассивСтрок.Добавить("УчетныеЗаписиЭДО.УведомлятьОНовыхДокументах КАК УведомлятьОНовыхДокументах");
		МассивСтрок.Добавить("УчетныеЗаписиЭДО.ЭлектроннаяПочтаДляУведомлений КАК ЭлектроннаяПочтаДляУведомлений");
		МассивСтрок.Добавить("УчетныеЗаписиЭДО.УведомлятьОНеОбработанныхДокументах КАК УведомлятьОНеОбработанныхДокументах");
		МассивСтрок.Добавить("УчетныеЗаписиЭДО.УведомлятьОбОкончанииСрокаДействияСертификата КАК УведомлятьОбОкончанииСрокаДействияСертификата");
	...
	Если ИзмененыПараметрыУчетнойЗаписи Тогда
		...
		МассивСтрок.Добавить("УчетныеЗаписиЭДО.ПодробноеОписаниеУчетнойЗаписи КАК ПодробноеОписаниеУчетнойЗаписи");
		МассивСтрок.Добавить("УчетныеЗаписиЭДО.НеИспользоватьПриглашения КАК НеИспользоватьПриглашения");
		МассивСтрок.Добавить("УчетныеЗаписиЭДО.КодыТиповДокументовКОбмену КАК КодыТиповДокументовКОбмену");
	...
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "&ПоляЗапроса", СтрСоединить(МассивСтрок, ","));
...
Функция ТребуетсяДоверенностьДляРегистрацииУчетнойЗаписи(Организация, Сертификат, СпособОбмена,
	...
	ТребуетсяДоверенность = ТребуетсяДоверенностьДляРегистрацииУчетнойЗаписиПоИНН(ДанныеОрганизации.ИНН,
		Сертификат, СпособОбмена, ИдентификаторОператора, ТипУчастникаЭДО);
...
// 	Сертификат - СправочникСсылка.СертификатыКлючейЭлектроннойПодписиИШифрования
// 	СпособОбмена - ПеречислениеСсылка.СпособыОбменаЭД
// 	ИдентификаторОператора - Неопределено,
// 							 Строка
// 	ТипУчастникаЭДО - Неопределено,
// 					  ПеречислениеСсылка.ВидУчетнойЗаписиЭДО
// Возвращаемое значение:
// 	Булево
Функция ТребуетсяДоверенностьДляРегистрацииУчетнойЗаписиПоИНН(ИНН, Сертификат, СпособОбмена,
	ИдентификаторОператора = Неопределено, ТипУчастникаЭДО = Неопределено) Экспорт
	...
	ИначеЕсли ВидСертификата = ВидыСертификатов.СертификатФЛ
			И (Не ОрганизацияУчетнойЗаписиСовпадаетСВладельцемСертификата
				Или ТипУчастникаЭДО <> Неопределено
					И Не ТипУчастникаЭДО.ЭтоФизЛицо) Тогда
...
Функция ТребуетсяЗаполнитьДолжностьДляСертификатаПоИНН(Знач ИННОрганизации, Сертификат) Экспорт
	...
	Если ВидСертификата = ВидыСертификатов.СертификатИП
			Или ВидСертификата = ВидыСертификатов.СертификатФЛ Тогда
