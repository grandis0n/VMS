...
Функция ЭтоБрокерский(БалансовыйСчет) Экспорт
	...
	Возврат БалансовыйСчет = "30601"  // Средства клиентов по брокерским операциям с финансовыми и другими активами
		Или БалансовыйСчет = "30606"; // Средства клиентов-нерезидентов по брокерским операциям с финансовыми и другими активами
