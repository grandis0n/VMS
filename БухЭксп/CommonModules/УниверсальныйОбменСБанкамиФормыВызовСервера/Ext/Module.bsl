...
Функция ДанныеШаблона(ОписаниеШаблона) Экспорт
	...
	ИмяФайлаШаблона = ОбщегоНазначенияКлиентСервер.ЗаменитьНедопустимыеСимволыВИмениФайла(
		ИскомыйШаблон.Имя);
	
	ДвоичныеДанныеШаблона = Новый ДвоичныеДанные(ПапкаШаблона + ИмяФайлаШаблона);
