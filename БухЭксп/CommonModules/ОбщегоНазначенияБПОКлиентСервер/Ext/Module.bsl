...
//  Булево.
//
Функция ДоступенОблачныйПИоТ() Экспорт
...
// Преобразовать дату JSON
// 
Функция ПреобразоватьДатуJSON(Строка) Экспорт                   

#Если Не ВебКлиент Тогда
	Возврат ПрочитатьДатуJSON(Строка, ФорматДатыJSON.ISO); 
#Иначе
	Возврат ОбщегоНазначенияБПОСлужебныйВызовСервера.ПреобразоватьДатуJSON(Строка);
#КонецЕсли
	
КонецФункции

// Получает представление ревизия интерфейса драйвера.
//          
// Параметры:
//  РевизияИнтерфейса - Чтсло
// Возвращаемое значение:
//  Строка - 
//
Функция ПредставлениеРевизияИнтерфейса(РевизияИнтерфейса) Экспорт
	
	Если РевизияИнтерфейса >= 6000 Тогда
		Результат = "6." + Строка(РевизияИнтерфейса - 6000);
	ИначеЕсли РевизияИнтерфейса >= 5000 Тогда
...
//  Число - 
//
Функция ПоддерживаемыеРевизииИнтерфейсаДрайверов() Экспорт
	
	РевизииИнтерфейса = Новый Структура();
	РевизииИнтерфейса.Вставить("Минимальная" , 3000); 
	РевизииИнтерфейса.Вставить("Максимальная", 5000);
	Возврат РевизииИнтерфейса;
