...
//  Форма - ФормаКлиентскогоПриложения - Форма:
//  ДанныеЗаполнения - произвольный - данные для заполнения
Процедура ОбработкаЗаполненияНаФормеЭПЭ(Форма, ДанныеЗаполнения) Экспорт
КонецПроцедуры  
...
//  Форма - ФормаКлиентскогоПриложения - Форма:
//  ДанныеЗаполнения - произвольный - данные для заполнения
Процедура ОбработкаЗаполненияНаФормеЭЭР(Форма, ДанныеЗаполнения) Экспорт
КонецПроцедуры
...
//  Форма - ФормаКлиентскогоПриложения - Форма:
//  ДанныеЗаполнения - произвольный - данные для заполнения
Процедура ОбработкаЗаполненияНаФормеЭСР(Форма, ДанныеЗаполнения) Экспорт
КонецПроцедуры
...
// Заполнение договора начало выбора. Позволяет сделать отбор по организации и контрагенту
// 
// Параметры:
...
//  ВыборДобавлением Выбор добавлением
//  СтандартнаяОбработка Стандартная обработка
Процедура ЗаполнениеДоговораНачалоВыбора(Организация, Контрагент, Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка) Экспорт
