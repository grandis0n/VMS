...
//        С 1 февраля 2027 Минимальное значение - 5 минут, максимальное значение - 43200 минут (тридцать дней в минутах).
//          В случае передачи значения меньше описанного диапазона возвращается ошибка "НеверныйФорматЗапроса".
//          В случае передачи значения больше описанного диапазона, срок жизни будет уменьшен до 43200 минут.
//        До 1 февраля 2027 Минимальное значение - 5 минут, максимальное значение - 129 600 минут (90 дней в минутах).
//          В случае передачи значения не входящего в выше описанный диапазон возвращается ошибка "НеверныйФорматЗапроса".
