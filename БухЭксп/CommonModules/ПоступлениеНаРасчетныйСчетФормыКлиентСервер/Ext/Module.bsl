...
Процедура ВыводПредупрежденияОНастройкеПорядкаОтраженияКомиссииВРасходах(Форма, ЕстьТабличнаяЧасть) Экспорт
	...
	Если СуммаУслуг > 0
		...
		И Не Форма.СвойстваПлатежа.ВидОплатыРеквизиты.УчитыватьНДСПоКомиссии
		И Форма.СвойстваПлатежа.ВидОплатыРеквизиты.ТипОплаты
			<> ПредопределенноеЗначение("Перечисление.ТипыОплат.ЦифровойРубль") Тогда
