...
// Открывает по гиперссылке "Начните Обучение по ..." обучение на нужном месте.
//
// Параметры:
//   ИмяМакета            - Строка - Имя макета обучения
//   ИмяПодраздела        - Строка - Имя подраздела в макете для позиционирования (тег в макете <a id="ИмяПодраздела">)
//   СтандартнаяОбработка - Булево - Стандартная обработка события после вызова не выполняется
//
Процедура НадписьОбучениеОбработкаНавигационнойСсылки(ИмяМакета, ИмяПодраздела, СтандартнаяОбработка) Экспорт
	
	СтандартнаяОбработка = Ложь;
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("ИмяТекущегоМакета", ИмяМакета);
	ПараметрыФормы.Вставить("ТекущийИдентификатор", ИмяПодраздела);
	ОткрытьФорму("Обработка.ОбучениеРаботеВБизнесСтарт.Форма", ПараметрыФормы);
...
Процедура СоветПоРаботеОбработкаНавигационнойСсылки(Форма, Элемент, НавигационнаяСсылка, СтандартнаяОбработка) Экспорт
	...
	Если НавигационнаяСсылка = "ДиректБанк" Тогда
		...
		ПараметрыВыполнения.Вставить("Банк", УправлениеПанельюПодсказкиВызовСервера.ЗначениеРеквизитаОбъекта(Форма.ОтборБанковскийСчет, "Банк"));
