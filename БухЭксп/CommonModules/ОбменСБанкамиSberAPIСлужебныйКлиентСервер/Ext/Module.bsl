...
Процедура ОбработатьОшибку(ВидОперации,
	...
	ПодробныйТекстОшибки = СтрЗаменить(ПодробныйТекстОшибки, "Мы уже работаем над её устранением.", "");
	ТекстСообщения = СтрЗаменить(ТекстСообщения, "Мы уже работаем над её устранением.", "");
...
Функция АдресЛичногоКабинета() Экспорт
	...
	Возврат "https://sbi.sberbank.ru:9443/ic/dcb/";
