...
Функция НовыеПараметрыМетодаВзаимодействия(МетодВзаимодействия) Экспорт
	...
	ИначеЕсли МетодВзаимодействия = "ПометитьОповещениеПрочитанным"
...
// Возвращает адрес страницы налогов сервиса
//
// Возвращаемое значение:
//   Строка - адрес страницы
//
Функция АдресСтраницыНалогиСервиса() Экспорт
	
	Возврат АдресСервиса() + "/taxes";
