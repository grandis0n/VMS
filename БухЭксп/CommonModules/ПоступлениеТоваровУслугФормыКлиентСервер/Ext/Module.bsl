...
Процедура УстановитьВидимостьКолонокРасхождения(Форма, Префиксы) Экспорт
	...
	Для каждого Префикс Из СтрРазделить(Префиксы, ",") Цикл
		СписокРеквизитовФормыДляИзменения = СписокРеквизитовФормы;
		Если ПолучитьРеквизитФормы(Форма, "ИспользуютсяУпаковки") И Префикс = "Товары" Тогда
			СписокРеквизитовФормыДляИзменения = СтрЗаменить(СписокРеквизитовФормыДляИзменения, "КоличествоПоДокументу"	, "КоличествоУпаковокПоДокументу");
			СписокРеквизитовФормыДляИзменения = СтрЗаменить(СписокРеквизитовФормыДляИзменения, "КоличествоОтклонение"	, "КоличествоУпаковокОтклонение");
			СписокРеквизитовФормыДляИзменения = СтрЗаменить(СписокРеквизитовФормыДляИзменения, "ЦенаПоДокументу"		, "ЦенаЗаУпаковкуПоДокументу");
			СписокРеквизитовФормыДляИзменения = СтрЗаменить(СписокРеквизитовФормыДляИзменения, "ЦенаОтклонение"			, "ЦенаЗаУпаковкуОтклонение");
		КонецЕсли;
		
		Для каждого ИмяРеквизита Из СтрРазделить(СписокРеквизитовФормыДляИзменения, ",") Цикл
