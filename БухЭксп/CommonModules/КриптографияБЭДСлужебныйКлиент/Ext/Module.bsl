...
#Область ПодписаниеВМобильномЭДО
...
Процедура ПреобразоватьДанныеНабораДанныхИзОписанияОповещения(ОписаниеДанных) Экспорт
	...
	Если ОписаниеДанных.Свойство("НаборДанных") Тогда
	...
	Если  ОписаниеДанных.Свойство("Данные") Тогда
		...
		Если ТипЗнч(ОписаниеДанных.Данные) <> Тип("ОписаниеОповещения") Тогда
			Возврат;
		КонецЕсли;
		...
		ПараметрыВыполнения.Вставить("Оповещение",
			...
			ЭтотОбъект,
			ОписаниеДанных));
		ВыполнитьОбработкуОповещения(ОписаниеДанных.Данные, ПараметрыВыполнения);
	КонецЕсли;
...
Процедура ОбработатьРезультатДанныхИзОповещения(Результат, Данные) Экспорт
	...
	Данные.Данные = ?(ТипЗнч(Результат) = Тип("Структура"), Результат.Данные, Результат);
