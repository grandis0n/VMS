...
#КонецОбласти
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.199.9";
	Обработчик.Процедура           = "РегистрыСведений.ДокументыНДФЛАУСН.ЗаполнитьДокументыНДФЛАУСН";
	Обработчик.Комментарий         = НСтр("ru = 'Заполняет записи в регистре сведений ДокументыНДФЛАУСН'");
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Идентификатор       = Новый УникальныйИдентификатор("f802ac2a-8478-4729-9d1f-e706fc6c45e9");
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.199.9";
	Обработчик.Процедура           = "Константы.ОтображатьРасчетыНДФЛАУСН.УстановитьКонстантуПриОбновленииИнформационнойБазы";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.199.10";
	Обработчик.Процедура           = "Справочники.ВидыНалоговИПлатежейВБюджет.ВосстановитьОбеспечительныйПлатежПриВвозеТоваровИзЕАЭС";
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия               = "3.0.200.5";
	Обработчик.Процедура            = "Справочники.Номенклатура.ЗаполнитьОписаниеНоменклатурыИС";
	Обработчик.Комментарий          = НСтр("ru = 'Заполняет сведения о маркировке в регистре ОписаниеНоменклатурыИС"".'");
    Обработчик.НачальноеЗаполнение  = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.200.5";
	Обработчик.Процедура           = "Справочники.Номенклатура.ОчиститьВидМаркировки";
	Обработчик.Комментарий         = НСтр("ru = 'Очищает вид маркировки в справочнике ""Номенклатура"".'");
	Обработчик.Идентификатор       = Новый УникальныйИдентификатор("d617359d-9e45-45bb-a18e-6738046a5963");
	Обработчик.РежимВыполнения     = "Отложенно";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.200.5";
	Обработчик.Процедура = "Документы.РеализацияТоваровУслуг.ЗаполнитьПередачаДляСобственныхНуждИСМП";
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Идентификатор       = Новый УникальныйИдентификатор("2c3f490c-74b6-4548-ab6c-7e773ff72f93");
	Обработчик.Комментарий         = НСтр("ru = 'Заполняет реквизит ""Передача для собственных нужд (ИСМП)"" в документе ""Реализация (акты, накладные, УПД)""'");
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.201.14";
	Обработчик.Процедура           = "Справочники.ВидыНалоговИПлатежейВБюджет.СоздатьПоставляемыеЭлементы";
	Обработчик.НачальноеЗаполнение = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Идентификатор       = Новый УникальныйИдентификатор("d2053296-ac5f-4b3b-b97d-049c814769e5");
	Обработчик.Версия              = "3.0.202.4";// исправление ранее не корректных записей описания номенклатуры
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Процедура           = "Справочники.Номенклатура.ИсправитьЗаписиОписанияНоменклатурыИС";
	Обработчик.Комментарий         = НСтр("ru = 'Исправляет ошибочные записи описания номенклатуры'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.202.7";
	Обработчик.Процедура           = "ИнтеграцияАУСН.ЗаменитьВладельцаКлючаИнтеграцииСЛК";
	Обработчик.Комментарий         = НСтр("ru = 'Заменяет владельца настройки, хранящей токен доступа к ЛК ФНС АУСН'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.203.3";
	Обработчик.Процедура           = "УчетАкцизов.ОбновитьСтавкиПоАкцизам";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.Комментарий         = НСтр("ru='Заполняет регистр сведений СтавкиАкцизаПоставляемый'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.203.12";
	Обработчик.Процедура = "ПланыСчетов.Хозрасчетный.ДобавитьОтсутствующиеСубконто_68_32_42";
	Обработчик.Комментарий = НСтр("ru = 'Проверяет виды субконто на счетах 68.32 и 68.42, если видов субконто нет - добавляет.'");
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("69a26eba-4dd2-4f5d-869c-1e2159d4f583");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия               = "3.0.203.20";
	Обработчик.Процедура            = "Документы.ЗаявлениеОВвозеТоваров.РезервированиеАкцизаПоДОПП";
	Обработчик.Комментарий          = НСтр("ru = 'Формирует проводку по резервированию суммы акциза в документе ""Документ о предстоящей поставке товаров""'");
	Обработчик.РежимВыполнения      = "Отложенно";
	Обработчик.Идентификатор        = Новый УникальныйИдентификатор("99328978-a248-49de-994e-9d1d9b3fc5b0");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия               = "3.0.203.20";
	Обработчик.Процедура            = "Документы.ЗаявлениеОВвозеТоваров.УбратьНачислениеЕНСПоЗаявлениюОВвозе";
	Обработчик.Комментарий          = НСтр("ru = 'Формирует новую схему проводок в части ЕНС и акцизов в документе ""Заявление о ввозе товаров""'");
	Обработчик.РежимВыполнения      = "Отложенно";
	Обработчик.Идентификатор        = Новый УникальныйИдентификатор("f511c6c0-a075-4e27-a2bc-2a4b28695247");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.204.8";
	Обработчик.Процедура = "УчетЗарплаты.УстановитьУчетБронированияОрганизаций";
	Обработчик.Комментарий = НСтр("ru = 'Устанавливает признак учета бронирования.'");
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("a552ec55-d07d-4431-a016-058bbb640860");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.204.13";
	Обработчик.Процедура           = "РегистрыСведений.ДокументыНДФЛАУСН.ДозаполнитьДокументыНДФЛАУСН";
	Обработчик.Комментарий         = НСтр("ru = 'Дозаполняет записи в регистре сведений ДокументыНДФЛАУСН'");
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Идентификатор       = Новый УникальныйИдентификатор("93f21a4e-34a3-4cb6-b46d-36233cf7fb74");
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.204.16";
	Обработчик.Процедура = "РегистрыСведений.ИспользованиеФункциональностиПоОрганизациям.ОбновитьЗначенияОпцииПростогоИнтерфейса";
	Обработчик.Комментарий = НСтр("ru = 'Заполняет регистр ""Использование функциональности по организациям"" функциональностью, доступной организации, по умолчанию'");
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("f75bb197-4dc9-463e-afaf-85d3bc23b26f");
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.205.3";
	Обработчик.Процедура = "РассылкаОтчетовБП.ЗаполнитьФлагОтправкиПустыхОтчетов";
	Обработчик.Комментарий = НСтр("ru = 'Заполняет признак необходимости отправки пустых отчетов для рассылок отчетов'");
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("e77cab70-ac5b-480b-a7d0-bf576f3fb5f7");
	Обработчик.НачальноеЗаполнение = Ложь;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "3.0.205.12";
	Обработчик.Процедура = "РегистрыСведений.РасчетРезервовПоСомнительнымДолгам.ЗаполнитьРесурсСомнительнаяЗадолженность";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("237586c4-ad3e-4225-881b-067a2d93a4b7");
	Обработчик.Комментарий = НСтр("ru = 'Заполняет ресурс ""СомнительнаяЗадолженность"" в регистре сведений ""РасчетРезервовПоСомнительнымДолгам""'");
	Обработчик.НачальноеЗаполнение = Ложь;
...
Процедура УстановитьДатуТекущейВерсии() Экспорт
	...
	Константы.ДатаТекущейВерсии.Установить(Дата(2026,08,26));
