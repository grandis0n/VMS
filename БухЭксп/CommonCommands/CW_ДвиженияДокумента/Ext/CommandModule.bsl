...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Иначе 
		ПараметрыФормы = ПолучитьПараметрыФормыКорректировкиДвижений(ПараметрКоманды);
...
&НаСервере
Функция ПолучитьПараметрыФормыКорректировкиДвижений(ПараметрКоманды)
	
	Возврат CW_БухгалтерияЭкспедитораСерверПереопределяемый.ПолучитьПараметрыФормыКорректировкиДвижений(ПараметрКоманды);
