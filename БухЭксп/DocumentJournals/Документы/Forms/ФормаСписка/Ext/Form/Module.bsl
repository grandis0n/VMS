...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РазместитьКомандыДокументыНаПодпись();
...
&НаСервере
Процедура РазместитьКомандыДокументыНаПодпись()
	
	Если Элементы.Найти("КомандаДокументыНаПодписьИсходящие") <> Неопределено Тогда
		Элементы.Переместить(Элементы.КомандаДокументыНаПодписьИсходящие, Элементы.КомандыЭДОИсходящие);
	КонецЕсли;
	Если Элементы.Найти("КомандаДокументыНаПодписьВходящие") <> Неопределено Тогда
		Элементы.Переместить(Элементы.КомандаДокументыНаПодписьВходящие, Элементы.КомандыЭДОВходящие);
	КонецЕсли;
...
Процедура АдаптироватьМКСписокФормы()
	...
	КонецЕсли;
	Если Элементы.Найти("СостояниеЭДО") <> Неопределено
		И ЭлектронноеВзаимодействиеБП.НастроенОбменЭДО() Тогда
		МобильныйКлиентБПФормаСписка.ВстроитьЭлементВГруппуМК_Строка(ЭтотОбъект, Элементы.СостояниеЭДО, 2);
	КонецЕсли;
