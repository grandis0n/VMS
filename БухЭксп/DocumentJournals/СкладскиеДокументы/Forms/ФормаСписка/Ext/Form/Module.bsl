...
&НаКлиенте
Процедура СоздатьОбесценениеЗапасов(Команда)
	
	РасширенныйФункционалКлиент.ОткрытьОбесценениеЗапасов(ЭтотОбъект, ПолучитьПараметрыФормыДокумента());
...
Процедура НастроитьОперацииПодменюСоздать()
	...
	РасширенныйФункционал.ДобавитьДокументыПоСкладу(ПроверяемыеДокументы);
