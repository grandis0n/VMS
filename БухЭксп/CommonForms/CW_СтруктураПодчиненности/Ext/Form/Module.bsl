...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("ИмяКритерияОтбора"					, ИмяКритерияОтбора);
	Параметры.Свойство("ПоказатьКнопкуВывестиДляТекущего"	, ПоказатьКнопкуВывестиДляТекущего);
	
	Элементы.ФормаВывестиДляТекущего.Видимость	= ПоказатьКнопкуВывестиДляТекущего;
	...
	Если ЗначениеЗаполнено(ОбъектСсылка) и ЗначениеЗаполнено(ИмяКритерияОтбора) Тогда
...
Процедура ВывестиРодительскиеОбъекты(ТекущийОбъект, ДеревоРодитель)
	...
	Для Каждого Реквизит Из МетаданныеОбъекта.Реквизиты Цикл
		...
		Если Не Метаданные.КритерииОтбора[ИмяКритерияОтбора].Состав.Содержит(Реквизит) Тогда
			Продолжить;
		КонецЕсли;
		...
		Для Каждого ТекущийТип Из Реквизит.Тип.Типы() Цикл
			...
			Если МетаданныеРеквизита.Имя = "CW_РасходыПоГрузоперевозке" и Не ПросмотрРасходов Тогда
				Продолжить;
			КонецЕсли;
			Если МетаданныеРеквизита.Имя = "CW_ДоходыПоГрузоперевозке" и Не ПросмотрДоходов Тогда
				Продолжить;
			КонецЕсли;
...
Функция ОбъектыПоКритериюОтбора(ЗначениеКритерияОтбора)
	...
	Если Не Метаданные.КритерииОтбора[ИмяКритерияОтбора].Тип.СодержитТип(ТипЗнч(ЗначениеКритерияОтбора))  Тогда
	...
	|ИЗ
	|	КритерийОтбора."+ИмяКритерияОтбора+"(&ЗначениеКритерияОтбора) КАК СвязанныеДокументы";
