...
Процедура ПродажиЗаголовок1(Команда)
	...
	ОткрытьОтчетСПорядком("ПродажиПоКонтрагентам", 1, ГруппировкаОтчетаПродажи());
...
Процедура ПродажиЗаголовок2(Команда)
	...
	ОткрытьОтчетСПорядком("ПродажиПоКонтрагентам", 2, ГруппировкаОтчетаПродажи());
...
Процедура ПродажиЗаголовок3(Команда)
	...
	ОткрытьОтчетСПорядком("ПродажиПоКонтрагентам", 3, ГруппировкаОтчетаПродажи());
...
Процедура ПродажиЗаголовок4(Команда)
	...
	ОткрытьОтчетСПорядком("ПродажиПоКонтрагентам", 4, ГруппировкаОтчетаПродажи());
...
Функция ГруппировкаОтчетаПродажи()
	
	ГруппировкаОтчета = Новый Массив;
	
	ДобавитьГруппировку(ГруппировкаОтчета, "Организация", НСтр("ru ='Организация'"), Ложь, 0);
	ДобавитьГруппировку(ГруппировкаОтчета, "Подразделение", НСтр("ru ='Подразделение'"), Ложь, 0);
	ДобавитьГруппировку(ГруппировкаОтчета, "Ответственный", НСтр("ru ='Ответственный'"), Ложь, 0);
	ДобавитьГруппировку(ГруппировкаОтчета, "Контрагент", НСтр("ru ='Контрагент'"), Истина, 0);
	ДобавитьГруппировку(ГруппировкаОтчета, "Документ", НСтр("ru ='Документ'"), Ложь, 0);
...
Процедура ОткрытьОтчет(Расшифровка)
	...
	Если Расшифровка.Свойство("ПрочиеДоходыИРасходы") Тогда
		ДополнительныеСвойства.Вставить("ПрочиеДоходыИРасходы", Расшифровка.ПрочиеДоходыИРасходы);
	КонецЕсли;
