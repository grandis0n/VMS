...
&НаКлиенте
Процедура ДанныеВоинскогоУчетаОрганизацийРегистрационныйНомерПриИзменении(Элемент)
...
&НаКлиенте
Процедура ДанныеВоинскогоУчетаОрганизацийНеосновныеКодыОКВЭДПриИзменении(Элемент)
...
&НаКлиенте
Процедура ВедетсяУчетБронированияПриИзменении(Элемент)
	
	ДанныеВоинскогоУчетаОрганизаций.ВедетсяТолькоВоинскийУчет = Не ВедетсяУчетБронирования;
...
Процедура ПрочитатьДанные()
	...
	ВедетсяУчетБронирования = Не ДанныеВоинскогоУчета.ВедетсяТолькоВоинскийУчет;
...
Процедура СохранитьДанныеНаСервере()
	...
	ДанныеВоинскогоУчета.Организация = ОрганизацияСсылка;
	Если Не ЗначениеЗаполнено(ДанныеВоинскогоУчета.ВышестоящаяОрганизация) Тогда
		ДанныеВоинскогоУчета.ВышестоящаяОрганизация = "Нет";
	КонецЕсли;
