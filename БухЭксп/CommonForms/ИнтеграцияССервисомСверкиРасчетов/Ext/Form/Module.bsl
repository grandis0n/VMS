...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ПодключенныеОрганизации.Видимость = Форма.СервисПодключен или КоличествоОрганизацийДляПовторногоПодключения > 0;
	
	Элементы.ЗаявлениеНаПереключение.Видимость = Форма.СервисПодключен или КоличествоОрганизацийДляПовторногоПодключения > 0;
	...
	Если КоличествоОрганизацийДляПовторногоПодключения >= 1 И СтатусыОрганизаций.Количество > 0 Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы,
