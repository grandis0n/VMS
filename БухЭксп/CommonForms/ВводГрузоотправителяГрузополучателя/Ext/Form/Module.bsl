...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЕстьПравоДоступаКДОПП = ПравоДоступа("Чтение", Метаданные.Документы.ЗаявлениеОВвозеТоваров);
...
Процедура УправлениеФормой(Форма)
	...
	Элементы.ДОПП.Видимость = Форма.ПоставщикРезидентТаможенногоСоюза И Форма.ЕстьПравоДоступаКДОПП;
