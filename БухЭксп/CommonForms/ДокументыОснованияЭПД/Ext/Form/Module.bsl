...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ТипДокумента", ТипДокумента) Тогда
		...
		ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ЭлектронноеПоручениеЭкспедитору") Тогда
			ОписаниеТипа = Метаданные.ОпределяемыеТипы.ДокументыОснованияЭПЭ_ЭПД.Тип;
		ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ЭлектроннаяЭкспедиторскаяРасписка") Тогда
			ОписаниеТипа = Метаданные.ОпределяемыеТипы.ДокументыОснованияЭЭР_ЭПД.Тип;
		ИначеЕсли ТипДокумента = Тип("ДокументСсылка.ЭлектроннаяCкладскаяРасписка") Тогда
			ОписаниеТипа = Метаданные.ОпределяемыеТипы.ДокументыОснованияЭСР_ЭПД.Тип;
		КонецЕсли;
