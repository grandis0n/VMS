...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПроверитьВозможностьПечати(ОбъектыПечати, СведенияОПолучателеКонверта);
...
&НаСервере
Процедура ПроверитьВозможностьПечати(ОбъектыПечати, СведенияОПолучателеКонверта)
	
	ЕстьДанныеОПолучателе =
		ЗначениеЗаполнено(ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(СведенияОПолучателеКонверта, "Адрес", ""))
		И ЗначениеЗаполнено(ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(СведенияОПолучателеКонверта, "Индекс", ""))
		И ЗначениеЗаполнено(ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(СведенияОПолучателеКонверта, "Представление", ""));
	Если ЕстьДанныеОПолучателе Тогда
		Возврат;
	КонецЕсли;
