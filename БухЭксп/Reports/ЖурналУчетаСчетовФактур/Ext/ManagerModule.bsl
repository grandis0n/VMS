			...
			Пока ГруппировкаПоКонтрагенту.Следующий() Цикл
				Если УчетНДС.ВыводитьСтроку(СтруктураПараметров, ГруппировкаПоКонтрагенту, Истина) Тогда
					...
					Пока ГруппировкаПоИсходнымИИсправительнымЗаписям.Следующий() Цикл
						...
						ГруппировкаПоРегистратору = ГруппировкаПоИсходнымИИсправительнымЗаписям.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
						Пока ГруппировкаПоРегистратору.Следующий() Цикл
							
							ГруппировкаПоСчетамФактурам = ГруппировкаПоРегистратору.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
							Пока ГруппировкаПоСчетамФактурам.Следующий() Цикл
								
								ГруппировкаПоКонтрагентуСчетаФактуры = ГруппировкаПоСчетамФактурам.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
								Пока ГруппировкаПоКонтрагентуСчетаФактуры.Следующий() Цикл
									
									ГруппировкаПоПризнакуСторно = ГруппировкаПоКонтрагентуСчетаФактуры.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
		...
		Пока ГруппировкаПоИсходнымИИсправительнымЗаписям.Следующий() Цикл
			...
			Пока ГруппировкаПоРегистратору.Следующий() Цикл
				...
				Пока ГруппировкаПоСчетамФактурам.Следующий() Цикл
					...
					ГруппировкаПоКонтрагенту = ГруппировкаПоСчетамФактурам.Выбрать(ОбходРезультатаЗапроса.ПоГруппировкам);
					Пока ГруппировкаПоКонтрагенту.Следующий() Цикл
