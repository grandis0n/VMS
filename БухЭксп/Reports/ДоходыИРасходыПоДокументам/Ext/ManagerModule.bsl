...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	ПрочиеДоходыИРасходы = ПараметрыОтчета.ПрочиеДоходыИРасходы;
	
	БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ПрочиеДоходыИРасходы", ПрочиеДоходыИРасходы);
	...
	Если ПрочиеДоходыИРасходы Тогда
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(КомпоновщикНастроек.Настройки.Выбор, "ПрочиеДоходы");
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(КомпоновщикНастроек.Настройки.Выбор, "ПрочиеРасходы");
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(КомпоновщикНастроек.Настройки.Выбор, "ПрибыльДоНалогообложения");
	КонецЕсли;
