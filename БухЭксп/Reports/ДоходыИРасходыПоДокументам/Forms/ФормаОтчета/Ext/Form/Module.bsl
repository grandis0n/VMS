...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("АдресНастроек") Тогда
		...
		ЭтотОбъект.ОкруглениеСумм = Настройки.Объект.ОкруглениеСумм;
	КонецЕсли;
...
Процедура ПриЗагрузкеПользовательскихНастроекНаСервере(Настройки, ИспользуютсяСтандартныеНастройки)
	...
	Если ИспользуютсяСтандартныеНастройки Тогда
		...
		Если Не ПустаяСтрока(ОкруглениеСумм) Тогда
...
Функция ПодготовитьПараметрыОтчетаНаСервере()
	...
	ПараметрыОтчета.Вставить("ПрочиеДоходыИРасходы"             , Отчет.ПрочиеДоходыИРасходы);
