...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если НЕ БезОткрытияФормы Тогда
		...
		Элементы.ГруппаПредставлениеФормы.Видимость = ТекущаяДатаСеанса() < '20260601';
	КонецЕсли;
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ТекущаяДатаСеанса() < '20260601' Тогда
		
		СообщитьВТС("До 31.05.2026 (включительно) представление декларации доступно только по форме "
...
Процедура СформироватьСлужебныеДанные()
	...
	ДанныеРазделов.Добавить(Новый Структура("Раздел,Подраздел,Уровень,Индекс", "Раздел3"	, "Подраздел33"	, 1, 1));
...
//Процедура ПроверкаКС_3_38() удалена
...
//Процедура ПроверкаКС_3_39() удалена

//Процедура ПроверкаКС_3_40() удалена

//Процедура ПроверкаКС_3_41() удалена

//Процедура ПроверкаКС_3_42() удалена

//Процедура ПроверкаКС_3_43() удалена
