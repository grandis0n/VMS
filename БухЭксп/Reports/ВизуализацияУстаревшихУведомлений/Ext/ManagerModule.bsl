...
Функция ПечатьУведомления(МассивОбъектов, ОбъектыПечати)
	...
	ИначеЕсли Реквизиты.ИмяОтчета = "РегламентированноеУведомлениеПрекращениеУСН" Тогда
		Возврат ПечатьРегламентированноеУведомлениеПрекращениеУСН(Реквизиты, ОбъектыПечати);
	ИначеЕсли Реквизиты.ИмяОтчета = "РегламентированноеУведомлениеУтратаПраваУСН" Тогда
		Возврат ПечатьРегламентированноеУведомлениеУтратаПраваУСН(Реквизиты, ОбъектыПечати);
	ИначеЕсли Реквизиты.ИмяОтчета = "РегламентированноеУведомлениеОтказОтУСН" Тогда
		Возврат ПечатьРегламентированноеУведомлениеОтказОтУСН(Реквизиты, ОбъектыПечати);
	КонецЕсли;
...
Функция ПечатьРегламентированноеУведомлениеПрекращениеУСН(Реквизиты, ОбъектыПечати)
	ДанныеДляЗагрузкиМакетов = Новый Структура("ИмяОтчета", "ВизуализацияУстаревшихУведомлений");
	СписокИспользуемыхМакетов = УведомлениеОСпецрежимахНалогообложения.ЗагрузитьМакетыИзАрхива(ДанныеДляЗагрузкиМакетов, "", "МакетыПечатиБСП");
	...
	МакетУведомления = СписокИспользуемыхМакетов["ПрекращениеУСН"];
	ПараметрыМакета = МакетУведомления.Параметры;
	СтруктураПараметров = Реквизиты.ДанныеУведомления.Получить();
...
Функция ПечатьРегламентированноеУведомлениеУтратаПраваУСН(Реквизиты, ОбъектыПечати)
	ДанныеДляЗагрузкиМакетов = Новый Структура("ИмяОтчета", "ВизуализацияУстаревшихУведомлений");
	СписокИспользуемыхМакетов = УведомлениеОСпецрежимахНалогообложения.ЗагрузитьМакетыИзАрхива(ДанныеДляЗагрузкиМакетов, "", "МакетыПечатиБСП");
	...
	МакетУведомления = СписокИспользуемыхМакетов["УтратаПраваУСН"];
	ПараметрыМакета = МакетУведомления.Параметры;
	СтруктураПараметров = Реквизиты.ДанныеУведомления.Получить();
...
Функция ПечатьРегламентированноеУведомлениеОтказОтУСН(Реквизиты, ОбъектыПечати)
	ДанныеДляЗагрузкиМакетов = Новый Структура("ИмяОтчета", "ВизуализацияУстаревшихУведомлений");
	СписокИспользуемыхМакетов = УведомлениеОСпецрежимахНалогообложения.ЗагрузитьМакетыИзАрхива(ДанныеДляЗагрузкиМакетов, "", "МакетыПечатиБСП");
	...
	МакетУведомления = СписокИспользуемыхМакетов["ОтказОтУСН"];
	ПараметрыМакета = МакетУведомления.Параметры;
	СтруктураПараметров = Реквизиты.ДанныеУведомления.Получить();
