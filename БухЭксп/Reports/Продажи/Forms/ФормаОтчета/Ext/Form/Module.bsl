...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	СписокПолей.Добавить("Контрагент.КонтактнаяИнформация");
	СписокПолей.Добавить("Контрагент.ДополнительныеРеквизиты");
	СписокПолей.Добавить("Контрагент.ИсторияКПП");
	СписокПолей.Добавить("Контрагент.ИсторияНаименований");
	СписокПолей.Добавить("Контрагент.ИсторияКонтактнойИнформации");
