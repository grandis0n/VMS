...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	КорСчетИнвестиционногоВычета = ПланыСчетов.Хозрасчетный.ТекущийНалогНаПрибыль;
	Если ВедетсяУчетУсловногоРасхода Тогда
		КорСчетИнвестиционногоВычета = ПланыСчетов.Хозрасчетный.УсловныйРасходПоНалогуНаПрибыль;
	ИначеЕсли ВариантУчетаОтложенногоНалога = Перечисления.ВариантыУчетаОтложенногоНалога.Нет Тогда
		КорСчетИнвестиционногоВычета = ПланыСчетов.Хозрасчетный.ПрибылиИУбыткиНеЕНВД;
	КонецЕсли;
	
	БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "КорСчетИнвестиционногоВычета", КорСчетИнвестиционногоВычета);
