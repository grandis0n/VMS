...
Процедура РасчетРеглОтчетУСНФормаОтчета2025Кв1(РазделыОтчета, ИмяРаздела = "", ДопПараметры)
	...
	ИначеЕсли ИмяРаздела = "Раздел21" Тогда
		...
		ДанРазд.Вставить("П002120016003", Мин(ДанРазд["П002120016003"],
			Окр(ДанРазд["П002110013003"]) - Окр(ДанРазд["П002110014003"])));
		...
		ДанРазд.Вставить("П002120016103", Мин(ДанРазд["П002120016103"],
			Окр(ДанРазд["П002110013103"]) - Окр(ДанРазд["П002110014103"])));
		...
		ДанРазд.Вставить("П002120016203", Мин(ДанРазд["П002120016203"],
			Окр(ДанРазд["П002110013203"]) - Окр(ДанРазд["П002110014203"])));
		...
		ДанРазд.Вставить("П002120016303", Мин(ДанРазд["П002120016303"],
			Окр(ДанРазд["П002110013303"]) - Окр(ДанРазд["П002110014303"])));
