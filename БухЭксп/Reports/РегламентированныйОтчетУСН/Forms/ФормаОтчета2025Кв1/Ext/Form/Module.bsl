...
Процедура ПоказатьПериод()
	...
	Если СокрЛП(ТабличныйДокумент.Области.Период.Значение) = "" ИЛИ СтруктураРеквизитовФормы.мСкопированаФорма <> Неопределено Тогда
		...
		ИначеЕсли РегламентированнаяОтчетность.ОрганизацияУтратилаПравоНаУСН(СтруктураПараметров) Тогда
			
			ТабличныйДокумент.Области.Период.Значение = "95";
...
Процедура Расчет(Форма, ИмяРаздела = "", ОбластьИмя = "")
	...
	ИначеЕсли ИмяРаздела = "Раздел21" Тогда
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
			...
			ТДО["П002120016003"].Значение = Мин(ТДО["П002120016003"].Значение,
				ОкрЧФ(Форма, ТДО["П002110013003"].Значение) - ОкрЧФ(Форма, ТДО["П002110014003"].Значение));
		Иначе
			...
			ДанРазд.Вставить("П002120016003", Мин(ДанРазд["П002120016003"],
				ОкрЧФ(Форма, ДанРазд["П002110013003"]) - ОкрЧФ(Форма, ДанРазд["П002110014003"])));
		КонецЕсли;
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
			...
			ТДО["П002120016103"].Значение = Мин(ТДО["П002120016103"].Значение,
				ОкрЧФ(Форма, ТДО["П002110013103"].Значение) - ОкрЧФ(Форма, ТДО["П002110014103"].Значение));
		Иначе
			...
			ДанРазд.Вставить("П002120016103", Мин(ДанРазд["П002120016103"],
				ОкрЧФ(Форма, ДанРазд["П002110013103"]) - ОкрЧФ(Форма, ДанРазд["П002110014103"])));
		КонецЕсли;
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
			...
			ТДО["П002120016203"].Значение = Мин(ТДО["П002120016203"].Значение,
				ОкрЧФ(Форма, ТДО["П002110013203"].Значение) - ОкрЧФ(Форма, ТДО["П002110014203"].Значение));
		Иначе
			...
			ДанРазд.Вставить("П002120016203", Мин(ДанРазд["П002120016203"],
				ОкрЧФ(Форма, ДанРазд["П002110013203"]) - ОкрЧФ(Форма, ДанРазд["П002110014203"])));
		КонецЕсли;
		...
		Если Форма.СтруктураРеквизитовФормы.НаимТекущегоРаздела = "Раздел21" Тогда
			...
			ТДО["П002120016303"].Значение = Мин(ТДО["П002120016303"].Значение,
				ОкрЧФ(Форма, ТДО["П002110013303"].Значение) - ОкрЧФ(Форма, ТДО["П002110014303"].Значение));
		Иначе
			...
			ДанРазд.Вставить("П002120016303", Мин(ДанРазд["П002120016303"],
				ОкрЧФ(Форма, ДанРазд["П002110013303"]) - ОкрЧФ(Форма, ДанРазд["П002110014303"])));
		КонецЕсли;
