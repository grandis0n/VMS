...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	Если ПараметрыОтчета.Интервалы.Количество() = 0 Тогда
		ЗаполнитьИнтервалыПоУмолчанию(ПараметрыОтчета.Интервалы);
	КонецЕсли;
...
Функция НастройкиОтчетаСохраняемыеВРассылке() Экспорт
	...
	КоллекцияНастроек.Вставить("ПоказательСтоимость"              , Истина);
	...
	КоллекцияНастроек.Вставить("Период"                           , '00010101');
...
Функция ЗаполнитьИнтервалыПоУмолчанию(Интервалы) Экспорт
	
	Интервалы.Очистить();
	
	ДобавитьИнтервал(Интервалы, 90,  "ru = 'До 90 дней'");
	ДобавитьИнтервал(Интервалы, 180, "ru = 'От 91 до 180 дней'");
	ДобавитьИнтервал(Интервалы, 365, "ru = 'От 181 до 365 дней'");
	ДобавитьИнтервал(Интервалы, 545, "ru = 'От 366 до 545 дней'");
	ДобавитьИнтервал(Интервалы, 730, "ru = 'От 546 до 730 дней'");
	
КонецФункции

Процедура ДобавитьИнтервал(Интервалы, Значение, Представление)
