...
Процедура Инициализация(БезОткрытияФормы = Ложь) Экспорт
	...
	Если НЕ БезОткрытияФормы Тогда
		...
		Элементы.ГруппаПредставлениеФормы.Видимость = ТекущаяДатаСеанса() < '20260901';
...
Процедура СформироватьСпискиВыбора()
	...
	МакетСоставаПоказателей = ОбъектОтчета(ИмяФормы).ПолучитьМакет("СпискиВыбора2026Кв3");
	...
	ИначеЕсли ИмяРаздела = "Приложение7" Тогда
		...
		Если ЗаполненыСведенияОбОбъектеИРасходах Тогда
			...
			Стр140 = Стр140
				...
				- Окр(ВеткаДрРазд.Данные["П000П50025003"], 2) - Окр(ВеткаДрРазд.Данные["П000П50025503"], 2);
