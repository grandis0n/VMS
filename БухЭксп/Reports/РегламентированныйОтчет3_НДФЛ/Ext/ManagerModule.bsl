...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ФормаОтчета        = "ФормаОтчета2026Кв3";
	НоваяФорма.ОписаниеОтчета
		= "Утверждена приказом ФНС России от 20.10.2025 № ЕД-7-11/913@ (в ред. приказа ФНС России от 25.05.2026 № ЕД-1-11/333@).";
	НоваяФорма.РедакцияФормы      = "от 25.05.2026 № ЕД-1-11/333@.";
	...
	НоваяФорма.ДатаНачалоДействия = '2025-01-01';
	НоваяФорма.ДатаКонецДействия  = '2026-12-31';
...
Функция ДанныеРеглОтчета(ЭкземплярРеглОтчета) Экспорт
	...
	Если ВРег(ИмяФормы) = ВРег("ФормаОтчета2026Кв3")
		ИЛИ ВРег(ИмяФормы) = ВРег("ФормаОтчета2025Кв4") Тогда
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Форма2026Кв3 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы,
		"1151020", '2026-05-25', "ЕД-1-11/333@", "ФормаОтчета2026Кв3");
	ОпределитьФорматВДеревеФормИФорматов(Форма2026Кв3, "5.21");
...
Функция ВидНалогаПоКБК(КБК, ИмяФормы)
	...
	Если ВРег(ИмяФормы) = ВРег("ФормаОтчета2026Кв3") Тогда
		ИмяМакета = "СпискиВыбора2026Кв3";
