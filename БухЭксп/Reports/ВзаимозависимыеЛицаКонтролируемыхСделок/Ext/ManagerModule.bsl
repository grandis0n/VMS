...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Возврат "Сведения о взаимозависимых лицах за " + Формат(ПараметрыОтчета.ОтчетныйГод, "ЧГ=0") + " г.";
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "СписокОфшоров", КонтролируемыеСделки.СписокОфшоров(ОтчетныйГодДатой));
	...
	ПараметрыДляВыводаПолей.Вставить("ПоддерживаетсяЕНВД", ОтчетныйГодДатой < КонтролируемыеСделки.ДатаОтказаОтЕНВД());
