...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если КонецДня(СтруктураРеквизитовФормы.мСохраненныйДок.ДатаОкончания) >= КонецДня('20260630')
		И СтруктураРеквизитовФормы.мСохраненныйДок.Вид = 0 И ТекущаяДатаСеанса() >= '20260730' Тогда
		
		СообщитьВТС("С 30.07.2026 представление первичной декларации, начиная с отчета за июнь 2026 года, доступно только "
			+ "по форме, утвержденной приказом ФНС России от 08.05.2026 № КЧ-1-3/299@", "Титульный", "НомерКорректировки");
