...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Утверждена приказом ФНС России от 08.05.2026 № КЧ-1-3/299@.";
	НоваяФорма.РедакцияФормы      = "от 08.05.2026 № КЧ-1-3/299@.";
	НоваяФорма.ДатаНачалоДействия = '2026-06-01';
	...
	НоваяФорма.ДатаКонецДействия  = '2026-07-31';
...
Функция ДеревоФормИФорматов() Экспорт
	...
	"1151088", '20260508', "КЧ-1-3/299@", "ФормаОтчета2026Кв2");
	ОпределитьФорматВДеревеФормИФорматов(Форма2026Кв2, "5.05");
...
Процедура ПоказателиОценкиРискаВыезднойНалоговойПроверки(ТаблицаПоказателей, ОписаниеОтчета) Экспорт 
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2026Кв2" Тогда
	...
	ИначеЕсли ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2023Кв3"
