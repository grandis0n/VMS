...
Процедура ДополнитьРеквизитыФормы()
	...
	ИсхКолвоСтрокРазделов    = 3;
	
	ТипКолонкиСтрока    = Новый ОписаниеТипов("Строка");
	ТипКолонкиЧисло15_2 = Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 2));
	
	МнгЧастьНомер = 0;
	Для Каждого Стр Из КатегорииКлассификатора Цикл
		
		МнгЧастьНомер = МнгЧастьНомер + 1;
		...
		Если Раздел = "1" Тогда
			ИсхКолвоКолонокРазделов = 16;
			Для Инд = 1 По ИсхКолвоКолонокРазделов Цикл
				
				Если Инд < 7 Или Инд > 12 Тогда
					ТипКолонки = ТипКолонкиСтрока;
				Иначе
					ТипКолонки = ТипКолонкиЧисло15_2;
				КонецЕсли;
		...
		ИначеЕсли Раздел = "2" Тогда
			...
			Для Инд = 16 По 23 Цикл
				...
				Если Инд = 16 Тогда
					ТипКолонки = ТипКолонкиЧисло15_2;
				ИначеЕсли Инд = 17 Тогда
					ТипКолонки = ТипКолонкиСтрока;
				ИначеЕсли Инд > 17 И Инд < 20 Тогда
					ТипКолонки = ТипКолонкиЧисло15_2;
				ИначеЕсли Инд > 19 Тогда
					ТипКолонки = ТипКолонкиСтрока;
				КонецЕсли;
		...
		ИначеЕсли Раздел = "3" Тогда
			...
			ИсхКолвоКолонокРазделов = 10;
			
			ДобавляемыйРеквизит = Новый РеквизитФормы(
				ИмяДобавляемогоРеквизита + "01", ТипКолонкиСтрока, ИмяДобавляемогоРеквизита);
			ДобавляемыеРеквизиты.Добавить(ДобавляемыйРеквизит);
			
			Для Инд = 23 По 31 Цикл
				
				Если Инд = 26 Или Инд = 28 Тогда
					ТипКолонки = ТипКолонкиСтрока;
				Иначе
					ТипКолонки = ТипКолонкиЧисло15_2;
				КонецЕсли;
		...
		ИзменитьРеквизиты(ДобавляемыеРеквизиты);
		СтруктураРеквизитовФормы.Вставить("мИдГруппы" + МнгЧастьНомер, ИмяДобавляемогоРеквизита);
		...
		СтруктураРеквизитовФормы.мСоответствияМнгЧ.Вставить(ИмяДобавляемогоРеквизита, "МногострочнаяЧасть" + МнгЧастьНомер);
...
Функция ПолучитьМассивКатегорий()
	МнгЧасти = "П0010010001;П0010010002;П0010010003;П0010020001;П0010020002;П0010020003;П0010030001;П0010030002;П0010030003";
	Возврат СтроковыеФункцииКлиентСервер.РазложитьСтрокуВМассивПодстрок(МнгЧасти, ";", Истина);
КонецФункции
...
Процедура ВставитьДополнительнуюСтроку(Форма, ТекущаяСтраница)
	...
	Если ИмяГруппы = "П0010010001" Тогда
		ИмяГруппыСинхронизируемой1 = "П0010020001";
		ИмяГруппыСинхронизируемой2 = "П0010030001";
	ИначеЕсли ИмяГруппы = "П0010020001" Тогда
		ИмяГруппыСинхронизируемой1 = "П0010010001";
		ИмяГруппыСинхронизируемой2 = "П0010030001";
	ИначеЕсли ИмяГруппы = "П0010030001" Тогда
		ИмяГруппыСинхронизируемой1 = "П0010010001";
		ИмяГруппыСинхронизируемой2 = "П0010020001";
	ИначеЕсли ИмяГруппы = "П0010010002" Тогда
		ИмяГруппыСинхронизируемой1 = "П0010020002";
		ИмяГруппыСинхронизируемой2 = "П0010030002";
	ИначеЕсли ИмяГруппы = "П0010020002" Тогда
		ИмяГруппыСинхронизируемой1 = "П0010010002";
		ИмяГруппыСинхронизируемой2 = "П0010030002";
	ИначеЕсли ИмяГруппы = "П0010030002" Тогда
		ИмяГруппыСинхронизируемой1 = "П0010010002";
		ИмяГруппыСинхронизируемой2 = "П0010020002";
	ИначеЕсли ИмяГруппы = "П0010010003" Тогда
		ИмяГруппыСинхронизируемой1 = "П0010020003";
		ИмяГруппыСинхронизируемой2 = "П0010030003";
	ИначеЕсли ИмяГруппы = "П0010020003" Тогда
		ИмяГруппыСинхронизируемой1 = "П0010010003";
		ИмяГруппыСинхронизируемой2 = "П0010030003";
	ИначеЕсли ИмяГруппы = "П0010030003" Тогда
		ИмяГруппыСинхронизируемой1 = "П0010010003";
		ИмяГруппыСинхронизируемой2 = "П0010020003";
	КонецЕсли;
...
Процедура УдалитьДополнительнуюСтрокуИзГруппы(Форма, СпециальноеДобавление, ИмяКолонкиНомера, ТекущаяСтраница, ИмяГруппы, НомУдаляемойСтроки, НомерСтрокиТаблицы)
	...
	Если ИмяГруппы = "П0010010001" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П001002000101_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П001003000101_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0010020001" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П001001000101_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П001003000101_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0010030001" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П001001000101_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П001002000101_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0010010002" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П001002000201_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П001003000201_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0010020002" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П001001000201_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П001003000201_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0010030002" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П001001000201_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П001002000201_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0010010003" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П001002000301_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П001003000301_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0010020003" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П001001000301_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П001003000301_" + Сред(ИмяЯчейки, 15);
	ИначеЕсли ИмяГруппы = "П0010030003" Тогда
		ИмяЯчейкиСинхронизируемой1 = "П001001000301_" + Сред(ИмяЯчейки, 15);
		ИмяЯчейкиСинхронизируемой2 = "П001002000301_" + Сред(ИмяЯчейки, 15);
	КонецЕсли;
...
Процедура ОчиститьТабличноеПолеНаСервере()
	...
	СписокПоказателей.Добавить(ВыбТабПоле.Области["Расшифровка"].Значение,            "Расшифровка");
	СписокПоказателей.Добавить(ВыбТабПоле.Области["Этап"].Значение,                   "Этап");
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Для Раздел = 1 По 3 Цикл
		...
		ВерхМногострочнойЧасти = ТабличныйДокумент.Области["ОсновнаяЧасть" + Раздел + "_4"].Низ + 1;
		НизМногострочнойЧасти = ТабличныйДокумент.Области["ДобавлениеСтроки" + ДобСтрокаНом].Верх - 1;
		...
		Пока ТекущийВерх <= НизМногострочнойЧасти Цикл
			...
			МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть" + Раздел + "_5"));
			Если ПечатнаяФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечатнаяФорма.Вывести(ТекущаяОбластьМногострочнойЧасти);
			Иначе
				СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4д");
				ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
		...
		ДобСтрокаНом = ДобСтрокаНом + 1;
		ВерхМногострочнойЧасти = ТабличныйДокумент.Области["ОсновнаяЧасть" + Раздел + "_6"].Низ + 1;
		НизМногострочнойЧасти = ТабличныйДокумент.Области["ДобавлениеСтроки" + ДобСтрокаНом].Верх - 1;
		ТекущийВерх = ВерхМногострочнойЧасти;
		ТекущаяОбластьМногострочнойЧасти = ПолеТабличногоДокументаФормаОтчета.ПолучитьОбласть(ТекущийВерх, , ТекущийВерх);
		
		МассивПроверки.Очистить();
		МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть" + Раздел + "_6"));
		МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
		...
		МассивПроверки = Новый Массив;
		ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть" + Раздел + "_6"));
		ВерхМногострочнойЧасти = ТабличныйДокумент.Области["ОсновнаяЧасть" + Раздел + "_6"].Низ + 1;
		НизМногострочнойЧасти = ТабличныйДокумент.Области["ДобавлениеСтроки" + ДобСтрокаНом].Верх - 1;
		ТекущийВерх = ВерхМногострочнойЧасти;
		Пока ТекущийВерх <= НизМногострочнойЧасти Цикл
			...
			ТекущаяОбластьМногострочнойЧасти = ПолеТабличногоДокументаФормаОтчета.ПолучитьОбласть(ТекущийВерх, , ТекущийВерх);
			МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
			МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть" + Раздел + "_7"));
			Если ПечатнаяФорма.ПроверитьВывод(МассивПроверки) Тогда
				ПечатнаяФорма.Вывести(ТекущаяОбластьМногострочнойЧасти);
			Иначе
				СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4д");
			...
			ТекущийВерх = ТекущийВерх + 1;
		КонецЦикла;
		ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть" + Раздел + "_7"));
		
		//Многострочная часть 3
		ДобСтрокаНом = ДобСтрокаНом + 1;
		ВерхМногострочнойЧасти = ТабличныйДокумент.Области["ОсновнаяЧасть" + Раздел + "_9"].Низ + 1;
		НизМногострочнойЧасти = ТабличныйДокумент.Области["ДобавлениеСтроки" + ДобСтрокаНом].Верх - 1;
		ТекущийВерх = ВерхМногострочнойЧасти;
		ТекущаяОбластьМногострочнойЧасти = ПолеТабличногоДокументаФормаОтчета.ПолучитьОбласть(ТекущийВерх, , ТекущийВерх);
		
		МассивПроверки.Очистить();
		МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть" + Раздел + "_8"));
		МассивПроверки.Добавить(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть" + Раздел + "_9"));
		МассивПроверки.Добавить(ТекущаяОбластьМногострочнойЧасти);
		...
		МассивПроверки = Новый Массив;
		ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть" + Раздел + "_8"));
		ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть" + Раздел + "_9"));
		ВерхМногострочнойЧасти = ТабличныйДокумент.Области["ОсновнаяЧасть" + Раздел + "_9"].Низ + 1;
		НизМногострочнойЧасти = ТабличныйДокумент.Области["ДобавлениеСтроки" + ДобСтрокаНом].Верх - 1;
		ТекущийВерх = ВерхМногострочнойЧасти;
		Пока ТекущийВерх <= НизМногострочнойЧасти Цикл
		...
		ИначеЕсли Раздел = 3 Тогда
			...
			Если Не ПечатнаяФорма.ПроверитьВывод(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть4_1")) Тогда
				СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4д");
				ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
			КонецЕсли;
			ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть4_1"));
			
			Если Не ПечатнаяФорма.ПроверитьВывод(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть4_2")) Тогда
				СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4д");
				ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
			КонецЕсли;
			ПечатнаяФорма.Вывести(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть4_2"));
			
			Если Не ПечатнаяФорма.ПроверитьВывод(ТабличныйДокумент.ПолучитьОбласть("ОсновнаяЧасть4_3")) Тогда
				СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 4д");
				ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
			КонецЕсли;
...
Функция ПроверитьВозможностьВыгрузки(ПараметрыВыгрузки, ДеревоВыгрузки)
	...
	Если ПустаяСтрока(ПараметрыВыгрузки.Расшифровка) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(ЭтотОбъект,
			"Не указана расшифровка затрат",
			ИмяПоляТаблДокумента, "Расшифровка");
		СтатусПроверки = Ложь;
	КонецЕсли;
...
Функция СформироватьСтруктуруПараметров() Экспорт 
	...
	ПараметрыВыгрузки.Вставить("Расшифровка", СокрЛП(ТабДокумент.Расшифровка));
