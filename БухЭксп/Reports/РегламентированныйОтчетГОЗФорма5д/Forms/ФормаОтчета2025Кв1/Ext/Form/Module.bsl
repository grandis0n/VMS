...
Функция ПолучитьМассивКатегорий()
	МнгЧасти = "П0010010001;П0010010002;П0010020001;П0010020002;П0010030001;П0010030002";
...
Функция ПечатьНаСервере(ВидПечати)
	...
	Для Раздел = 1 По 3 Цикл
		...
		Пока ТекущийВерх <= НизМногострочнойЧасти Цикл
			...
			Иначе
				СтруктураРеквизитовФормы.мПечатныеФормы.Добавить(ПечатнаяФорма, "Форма 5д");
				ПечатнаяФорма = РегламентированнаяОтчетность.НоваяСтраница();
