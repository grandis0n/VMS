...
// Возвращает виды переданных договоров (без повторов)
// Параметры:
//  Договоры - Массив из СправочникСсылка.ДоговорыКонтрагентов
//
// Возвращаемое значение:
//  Массив из ПеречислениеСсылка.ВидыДоговоровКонтрагентов
//
Функция ВидыДоговоров(Договоры) Экспорт
	...
	ВидыДоговоров = Запрос.Выполнить().Выгрузить().ВыгрузитьКолонку("ВидДоговора");
