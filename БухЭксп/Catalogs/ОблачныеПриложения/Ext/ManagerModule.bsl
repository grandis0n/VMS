...
Функция ВидПриложения(ИмяВидаПриложения) Экспорт
	...
	ИменаКонфигурацийБП = ОбщегоНазначенияБП.ИменаКонфигурацийБП();
	Если ИменаКонфигурацийБП.Найти(ИмяВидаПриложения) <> Неопределено Тогда
		Возврат Перечисления.ВидыОблачныхПриложений.Бухгалтерия;
	ИначеЕсли Найти(НРег(ИмяВидаПриложения), "зарплата") Тогда
