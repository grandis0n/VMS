...
Функция СчетУчетаРасчетовПоУмолчанию(ТипОплаты) Экспорт
	...
	ИначеЕсли ТипОплаты = Перечисления.ТипыОплат.ПлатежнаяКарта
		ИЛИ ТипОплаты = Перечисления.ТипыОплат.ЦифровойРубль
...
Функция ДанныеКонтрагентаПлатформаЦифровогоРубля(Создавать = Ложь) Экспорт
	
	ДанныеЦБ = ЦифровойРубль.РеквизитыОператораПлатформыЦифровогоРубля();
	ДанныеЦБ.Вставить("НаименованиеПолное", ДанныеЦБ.Наименование);
	
	ДанныеБанка = РаботаСБанкамиБП.ПолучитьДанныеКонтрагентаБанка(ДанныеЦБ, Создавать);
	
	Возврат ДанныеБанка;
	
КонецФункции

Функция ВидОплатыЦР(Организация) Экспорт
	
	ВидОплаты = Справочники.ВидыОплатОрганизаций.ПустаяСсылка();
	
	ДанныеБанка = ДанныеКонтрагентаПлатформаЦифровогоРубля(Ложь);
	...
	Если ЗначениеЗаполнено(ДоговорКонтрагента) Тогда
		ТипОплаты = Перечисления.ТипыОплат.ЦифровойРубль;
		ВидОплаты = ВидОплатыПоДоговоруИТипуОплаты(Организация, Контрагент, ДоговорКонтрагента, ТипОплаты);
	КонецЕсли;
