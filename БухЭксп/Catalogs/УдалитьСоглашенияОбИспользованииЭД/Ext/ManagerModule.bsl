...
Процедура ОбработатьДанные_ЗаполнитьКонтрагентаПоРеквизитам(Объект, Записать)
	...
	РеквизитыКонтрагента.ИНН = Объект.ИННКонтрагента;
	РеквизитыКонтрагента.КПП = Объект.КППКонтрагента;
	РеквизитыКонтрагента.Наименование = Объект.НаименованиеКонтрагента;
