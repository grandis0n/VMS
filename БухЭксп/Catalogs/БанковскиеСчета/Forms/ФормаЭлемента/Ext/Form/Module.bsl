...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "ИзмененаНастройкаОбменаСБП" Или ИмяСобытия = "ИзмененаНастройкаОбменСБанками" Тогда
...
Процедура ПоказатьЭлементыНастроекПодключения(Форма, ТекущийТекстНомераСчета = "")
	...
	Если ВидимостьИзмененияПодключенияДиректБанка Тогда
		ПодсказкаИзменения = ПодсказкаИзмененияПодключенияДиректБанка(Объект.Владелец, Объект.Банк);
...
Процедура ПослеПодключенияСБП(Результат, ДополнительныеПараметры) Экспорт
	...
	Оповестить("ИзмененаНастройкаОбменаСБП");
...
&НаСервереБезКонтекста
Функция ПодсказкаИзмененияПодключенияДиректБанка(Организация, Банк)
