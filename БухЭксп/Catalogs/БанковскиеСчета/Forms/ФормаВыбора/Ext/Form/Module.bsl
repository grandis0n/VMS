	...
	Для каждого ЭлементСписка Из Строки Цикл
		...
		Если СтатусСчетБезИнтеграции И НЕ ЗначениеЗаполнено(ТекущиеДанные.ДатаЗакрытия)
			...
			Если ИнформацияОНастройкахПрямогоОбмена <> Неопределено
				...
				НазваниеБанкаИнтегратора = ИнформацияОНастройкахПрямогоОбмена.ИнтеграторВыписки;
			КонецЕсли;
			...
			Если ЕстьНастройка И ЗначениеЗаполнено(НазваниеБанкаИнтегратора) Тогда
				ЭлементСписка.Значение.Оформление["ДиректБанкСтатус"].УстановитьЗначениеПараметра("Видимость", Ложь);
				ЭлементСписка.Значение.Оформление["ДиректБанкИнтеграторВыписки"].УстановитьЗначениеПараметра("Видимость", Истина);
				ТекущиеДанные.ДиректБанкИнтеграторВыписки = СтрШаблон(НСтр("ru = '(через %1)'"), НазваниеБанкаИнтегратора);
			Иначе
				ЭлементСписка.Значение.Оформление["ДиректБанкСтатус"].УстановитьЗначениеПараметра("Видимость", НЕ ЕстьНастройка);
				ЭлементСписка.Значение.Оформление["ДиректБанкИнтеграторВыписки"].УстановитьЗначениеПараметра("Видимость", Ложь);
			КонецЕсли;
