...
Процедура НадписьСтатусОтправкиНажатие(Элемент)
	...
	УдалитьДокументооборотСБанкомРоссииКлиент.ПоказатьПротокол(Объект.Ссылка);
...
Процедура Обновить(Команда)
	...
	УдалитьДокументооборотСБанкомРоссииКлиент.ПолучитьСтатусОтчета(Оповещение, Объект.Ссылка, ЭтаФорма);
