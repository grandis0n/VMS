...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ДанныеЗаполнения.Свойство("СвойствЦенообразованияМетода") Тогда
		Для Каждого СтрокаСвойствЦенообразования Из Параметры.ДанныеЗаполнения.СвойствЦенообразованияМетода Цикл
