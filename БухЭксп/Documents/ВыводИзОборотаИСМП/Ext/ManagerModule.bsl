...
Функция СформироватьТелоЗапросаОСУ(ПараметрыФормирования, ТелоЗапроса)
	...
	ДанныеПоТоварам.Свернуть("GTIN", "Количество,КоличествоПотребительскихУпаковок,Сумма");
...
Функция ДополнитьТелоЗапросаДаннымиМОД(ПараметрыФормирования, ТелоЗапроса)
	...
	Если Шапка.ИспользуетсяМОД И ЗначениеЗаполнено(Шапка.АдресПлощадкиСтрокой) Тогда
