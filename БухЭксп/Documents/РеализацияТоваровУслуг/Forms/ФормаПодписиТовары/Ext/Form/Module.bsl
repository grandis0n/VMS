...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаРегистрацияИСМП.Видимость = Параметры.Свойство("ПередачаДляСобственныхНуждИСМП", ПередачаДляСобственныхНуждИСМП);
	Элементы.ГруппаРегистрацияИСМП.ЗаголовокСвернутогоОтображения = ?(ПередачаДляСобственныхНуждИСМП = 0, 
		НСтр("ru = 'Контрагент зарегистрирован в ИСМП'"), 
		НСтр("ru = 'Контрагент не зарегистрирован в ИСМП'"));
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если ПеренестиВДокумент И Модифицированность Тогда
		СтруктураРезультат = Новый Структура("
			...
			|ГлавныйБухгалтер, ЗаГлавногоБухгалтераНаОсновании,
			|ОтпускПроизвел, ЗаЗаказчикаНаОсновании, ПередачаДляСобственныхНуждИСМП,
...
&НаКлиенте
Процедура ЗарегистрированИСМППриИзменении(Элемент)
	Элементы.ГруппаРегистрацияИСМП.ЗаголовокСвернутогоОтображения = ?(ПередачаДляСобственныхНуждИСМП = 0, 
			НСтр("ru = 'Контрагент зарегистрирован в ИСМП'"), 
			НСтр("ru = 'Контрагент не зарегистрирован в ИСМП'"));
КонецПроцедуры
