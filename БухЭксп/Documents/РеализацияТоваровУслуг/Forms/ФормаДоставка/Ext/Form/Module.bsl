...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтаФорма, Параметры,
		...
		|ДатаДокумента, СведенияОТранспортировкеИГрузе, ПараметрыТранспортногоСредства,
	...
	Элементы.ПараметрыТранспортногоСредства.Видимость = НЕ Параметры.ЕстьЭЗЗ И ИспользоватьДоставкуАвтотранспортом;
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если ПеренестиВДокумент И Модифицированность Тогда
		СтруктураРезультат = Новый Структура("
			...
			|Перевозчик, МаркаАвтомобиля, РегистрационныйЗнакАвтомобиля,
			|МаркаПрицепа, РегистрационныйЗнакПрицепа,
			|СведенияОТранспортировкеИГрузе, ПараметрыТранспортногоСредства,
...
&НаКлиенте
Процедура ПараметрыТранспортногоСредстваНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	ОбменСГИСЭПДБПКлиент.ПараметрыТранспортаНачалоВыбора(ЭтотОбъект, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка);
КонецПроцедуры 

&НаКлиенте
Процедура ПараметрыТранспортногоСредстваСоздание(Элемент, СтандартнаяОбработка)
