...
Процедура ДекорацияЭПДНажатие(Элемент)
	РеализацияТоваровУслугФормыКлиент.ОткрытьСписокЭПД(ЭтотОбъект);
КонецПроцедуры

&НаКлиенте
Процедура ДекорацияОформитьЭПДНажатие(Элемент)
	РеализацияТоваровУслугФормыКлиент.ОформитьЭПД(ЭтотОбъект, Элемент);
КонецПроцедуры
...
Процедура ТоварыПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	...
	СобытияФормИСКлиент.ПриИзмененииЭлемента(ЭтаФорма, Элемент, ДополнительныеПараметры);
...
Процедура СоздатьЭлектроннуюТранспортнуюНакладную(Команда)
	РеализацияТоваровУслугФормыКлиент.СоздатьЭлектроннуюТранспортнуюНакладную(ЭтотОбъект);
КонецПроцедуры 
...
Процедура СоздатьЭлектроннуюЗаказЗаявку(Команда)
	РеализацияТоваровУслугФормыКлиент.СоздатьЭлектроннуюЗаказЗаявку(ЭтотОбъект);
КонецПроцедуры
...
Процедура УправлениеФормой(Форма)
	...
	ЭтоПередачаТоваров = Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийРеализацияТоваров.ПередачаТоваров");
	...
	Элементы.НомерВходящегоДокумента.Видимость = ЭтоПередачаТоваров;
...
Процедура ЗаполнитьПризнакМаркируемойПродукцииТаблицыТовары(Товары, ИспользоватьКонтрольныеЗнакиГИСМ, ВестиУчетМаркируемойПродукцииИСМП)
	...
	Если ВестиУчетМаркируемойПродукцииИСМП И ИнтеграцияИСМПБП.ЕстьДобавленныеКолонкиИСМП(Товары) Тогда
		ИнтеграцияИСМПБП.ЗаполнитьДобавленныеКолонкиИСМП(Товары, ИспользоватьКонтрольныеЗнакиГИСМ); 
	КонецЕсли;
...
Процедура ДекорацияПодписиНажатие(Элемент)
	...
	Если ВестиУчетМаркируемойПродукцииИСМП Тогда
		ПараметрыФормы.Вставить("ПередачаДляСобственныхНуждИСМП",	Объект.ПередачаДляСобственныхНуждИСМП);
	КонецЕсли;
...
Процедура АдаптироватьМКСписокФормыТовары()
	...
	//Поддерживается сценарий интеграции Бгосис по умолчанию - 0
	КомандыПоля.КомандыТаблицыПрочие.Добавить("ПодобратьИПроверитьПродукциюГосИС0");
