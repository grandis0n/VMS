...
Процедура АдаптироватьМКСписокФормы()
	...
	МобильныйКлиентБПФормаСписка.ПодготовитьСписокФормы(ЭтотОбъект, "Список", 4);
	...
	Если Элементы.Найти("СостояниеЭДО") <> Неопределено
		...
		МобильныйКлиентБПФормаСписка.ВстроитьЭлементВГруппуМК_Строка(ЭтотОбъект, Элементы.СостояниеЭДО, 4);
	КонецЕсли;
