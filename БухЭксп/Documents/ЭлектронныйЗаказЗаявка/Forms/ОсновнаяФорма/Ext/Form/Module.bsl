...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.Свойство("ФормаБезОбработки") Тогда
		...
		Если Объект.ЭтоВходящий = Ложь Тогда	
			...
			СсылкаНаЧерновик = ОбменСГИСЭПДКлиентСервер.ПолучитьЗначениеРеквизитаИзСтруктурыФормы(ЭтотОбъект,"СсылкаТитулГрузоотправителяЧерновик");
			ХранимыеДанныеПараметрыТранспортногоСредства = ОбменСГИСЭПДКлиентСервер.ПолучитьЗначениеРеквизитаИзСтруктурыФормы(
				ЭтотОбъект,"ХранимыеДанныеТитулГрузоотправителяПараметрыТранспортногоСредства");
			
			Если Не ЗначениеЗаполнено(СсылкаНаЧерновик) 
				Или ТипЗнч(ХранимыеДанныеПараметрыТранспортногоСредства) <> Тип("Строка") Тогда
...
Процедура СкопироватьИныхПолучателейИзТитулаГрузоотправителя()
	...
	Если ЗначениеЗаполнено(Объект.ТекущийТитул) Тогда
		...
		КлючОткуда = "ТитулГрузоотправителяИдентификаторыИныхПолучателейФайла__" + ИтераторСтрокиОткуда + "__" + "ИдентификаторИногоПолучателя";
