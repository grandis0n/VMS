...
Процедура ПодборВладельцаПункта_Завершение(Значение, ТекущаяСтрока) Экспорт
	...
	Если Значение <> Неопределено Тогда  
		...
		СтрокаВвода.ВладелецПунктаПогрузкиНаименование = РеквизитыКонтрагента.Наименование;
	КонецЕсли;
...
Функция РеквизитыКонтрагента(Контрагент)
	...
	Возврат ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Контрагент, "ИНН, Наименование");
