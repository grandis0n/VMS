...
Функция ТекстЗапросаТаблицаВключенныйВСтоимостьНДСУСН(НомераТаблиц, ПараметрыПроведения, Реквизиты)
	...
	НомераТаблиц.Вставить("ВременнаяТаблицаРаспределениеНДСУслуги", НомераТаблиц.Количество());
	...
	|ПОМЕСТИТЬ ВТ_РаспределениеНДСУслуги
	|ИЗ
	|	Документ.РаспределениеНДС КАК РаспределениеНДС
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.РаспределениеНДС.РаспределяемыйНДС КАК РаспределениеНДСРаспределяемыйНДС
	...
	|	И РаспределениеНДСРаспределяемыйНДС.ВидЦенности = ЗНАЧЕНИЕ(Перечисление.ВидыЦенностей.ПрочиеРаботыИУслуги)
	|
	|СГРУППИРОВАТЬ ПО
	|	РаспределениеНДС.Организация,
	...
	|					(ВЫБРАТЬ РАЗЛИЧНЫЕ
	|						ВТ_РаспределениеНДСУслуги.Партия
	|					ИЗ
	|						ВТ_РаспределениеНДСУслуги КАК ВТ_РаспределениеНДСУслуги)
	...
	|
	|ВЫБРАТЬ
	|	ВТ_РаспределениеНДСУслуги.Организация,
	|	ВТ_РаспределениеНДСУслуги.СчетФактура,
	|	ВТ_РаспределениеНДСУслуги.Поставщик,
	|	ВТ_РаспределениеНДСУслуги.Партия,
	...
	|	ВЫБОР
	|		КОГДА ВТ_РаспределениеНДСУслуги.НДС <> 0
	|			ТОГДА ВТ_РаспределениеНДСУслуги.НДСУчитываетсяВCтоимости * ВТ_ПоступлениеРасходовПоУслугам.НДСПриход / ВТ_РаспределениеНДСУслуги.НДС
	|		ИНАЧЕ 0
	|	КОНЕЦ
	|ИЗ
	|	ВТ_РаспределениеНДСУслуги КАК ВТ_РаспределениеНДСУслуги
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_ПоступлениеРасходовПоУслугам КАК ВТ_ПоступлениеРасходовПоУслугам
	|		ПО ВТ_РаспределениеНДСУслуги.Организация = ВТ_ПоступлениеРасходовПоУслугам.Организация
	|			И ВТ_РаспределениеНДСУслуги.Партия = ВТ_ПоступлениеРасходовПоУслугам.РасчетныйДокумент
	|			И ВТ_РаспределениеНДСУслуги.СчетЗатрат = ВТ_ПоступлениеРасходовПоУслугам.СчетУчета
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
