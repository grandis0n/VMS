...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ФормаБезОбработки") = Ложь Тогда
		...
		Если  ЭтотОбъект.ЗапретитьИзменение = Ложь Тогда
			...
			Элементы.СсылкаСвЛицПриемГрХран.ОграничениеТипа = КонтрагентОписаниеТипов;
...
&НаКлиенте
Процедура ТитулЭкспедитораГрузУслПриемГрВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)

	ИменаПолей = Новый Массив;
	ИменаПолей.Добавить("ЗаполнитьТитулЭкспедитораГрузУслПриемГрОснДовПриемГрХран"); 
...
&НаКлиенте
Процедура СсылкаСвЛицПриемГрХранПриИзменении(Элемент)
	...
	ОбменСГИСЭПДКлиентСервер.ЗаполнитьРеквизитыПоСсылке(Элемент, ЭтотОбъект,
		Элементы.ТитулЭкспедитораГрузУслПриемГр.ТекущиеДанные , "ТитулЭкспедитораГруз", ПараметрыЗаполнения);
