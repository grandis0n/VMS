...
&НаКлиенте
Процедура ТитулЭкспедитораГрузыСвСтрахУслСтрахПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораГрузыСвСтрахУслСтрахПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
