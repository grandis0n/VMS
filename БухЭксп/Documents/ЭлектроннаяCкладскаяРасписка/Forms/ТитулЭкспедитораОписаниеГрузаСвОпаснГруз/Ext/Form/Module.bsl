...
Процедура Сохранить(Команда)
	...
	НайденныеСтроки = ТитулЭкспедитораОписаниеГрузаСвОпаснГруз.НайтиСтроки(Отбор);

	ПрзОпаснГруз = НайденныеСтроки.Количество() > 0;
...
Процедура СсылкаДОПОГПриИзменении(Элемент)
	ОбменСГИСЭПДКлиентСервер.ЗаполнитьРеквизитыПоСсылке(Элемент, ЭтотОбъект, Элементы.ТитулЭкспедитораОписаниеГрузаСвОпаснГруз.ТекущиеДанные);
КонецПроцедуры  

&НаКлиенте
Процедура ТитулТитулЭкспедитораОписаниеГрузаСвОпаснГрузПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулТитулЭкспедитораОписаниеГрузаСвОпаснГрузПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
