...
&НаКлиенте
Процедура ТитулЭкспедитораОписаниеГрузаСвСтрПроисхПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораОписаниеГрузаСвСтрПроисхПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
...
Процедура ТитулЗаказчикаОписаниеГрузаСвСтрПроисхСсылкаСтранаПриИзменении(Элемент)
	...
	ОбменСГИСЭПДКлиентСервер.ЗаполнитьРеквизитыПоСсылке(Элемент, ЭтотОбъект, 
		Элементы.ТитулЭкспедитораОписаниеГрузаСвСтрПроисх.ТекущиеДанные);
