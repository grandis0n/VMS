...
&НаКлиенте
Процедура ТитулЭкспедитораГрузыРеквЗакПостВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	Если Поле.Имя = "ЗаполнитьТитулЭкспедитораГрузРеквЗаказПокРеквизитыСторон"  Тогда
