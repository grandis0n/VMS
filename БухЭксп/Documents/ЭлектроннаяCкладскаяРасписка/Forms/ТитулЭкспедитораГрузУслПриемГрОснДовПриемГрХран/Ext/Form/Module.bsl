...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспСвОплатаДокОплУслРеквИдРекСостПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспСвОплатаДокОплУслРеквИдРекСостПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЭкспедитораГрузУслПриемГрОснДовПриемГрХранРеквизитыСторон.ТекущиеДанные);
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументОткрытие(Элемент, СтандартнаяОбработка)
	...
	Если ТипЗнч(Элементы.ТитулЭкспедитораГрузУслПриемГрОснДовПриемГрХранРеквизитыСторон.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент) <> Тип("СправочникСсылка.ХранимыеДанныеЭПД") Тогда
		СтандартнаяОбработка = Ложь;
		ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЭкспедитораГрузУслПриемГрОснДовПриемГрХранРеквизитыСторон.ТекущиеДанные, Ложь);
	КонецЕсли;
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулЭкспедитораГрузУслПриемГрОснДовПриемГрХранРеквизитыСторон.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	...
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулЭкспедитораГрузУслПриемГрОснДовПриемГрХранРеквизитыСторон.ТекущиеДанные);
