...
Процедура ПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если НоваяСтрока Тогда   
		...
		ТекущиеДанные.НомКонтейн = ТитулЭкспедитораГрузСвКонтейн.Количество();
...
Процедура ТитулЭкспедитораГрузыСвКонтейнИдКонтейнМеждПриИзменении(Элемент)
	ТекущиеДанные = Элементы.ТитулЭкспедитораГрузСвКонтейн.ТекущиеДанные;
	Если ТекущиеДанные <> Неопределено Тогда
...
Процедура ТитулЗаказчикаГрузыСвКонтейнВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ЗаполнитьТитулЭкспедитораГрузСвКонтейнНомПломб"  Тогда
