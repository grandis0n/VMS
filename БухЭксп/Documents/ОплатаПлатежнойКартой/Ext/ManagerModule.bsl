...
Функция ТекстЗапросаПараметрыФормированияЧекаНПД(ИменаТаблиц) Экспорт
	
	Возврат ТекстЗапросаРеквизитыФормированияЧекаНПД(ИменаТаблиц)
		+ Документы.СчетНаОплатуПокупателю.ТекстЗапросаУслугПродукцииНПД(ИменаТаблиц);
...
Функция ТекстЗапросаРеквизитыФормированияЧекаНПД(ИменаТаблиц)
	
	ИменаТаблиц.Добавить("ВТ_РеквизитыДокумента");
	ИменаТаблиц.Добавить("ВТ_РасшифровкаПлатежа");
	ИменаТаблиц.Добавить("НоменклатураБезСчетов");
	ИменаТаблиц.Добавить("РеквизитыДокумента");
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	РасшифровкаПлатежа.УслугаНПД КАК Услуга,
	...
	|	МАКСИМУМ(РасшифровкаПлатежа.НомерСтроки) КАК НомерТЧ
	|ПОМЕСТИТЬ ВТ_РасшифровкаПлатежа
	|ИЗ
	...
	|ВЫБРАТЬ
	|	ВЫБОР
	|		КОГДА НЕ РасшифровкаПлатежа.Услуга.НаименованиеПолное ПОДОБНО """"
	|			ТОГДА РасшифровкаПлатежа.Услуга.НаименованиеПолное
	|		ИНАЧЕ РасшифровкаПлатежа.Услуга.Наименование
	|	КОНЕЦ КАК Наименование,
	|	РасшифровкаПлатежа.Услуга.Услуга КАК Услуга,
	|	РасшифровкаПлатежа.Услуга.ПериодичностьУслуги КАК ПериодичностьУслуги,
	|	РасшифровкаПлатежа.НомерТЧ КАК НомерТЧ,
	|	РасшифровкаПлатежа.СуммаПлатежа КАК Цена
	|ИЗ
	...
	|ИЗ
	|	ВТ_РеквизитыДокумента КАК РеквизитыДокумента";
