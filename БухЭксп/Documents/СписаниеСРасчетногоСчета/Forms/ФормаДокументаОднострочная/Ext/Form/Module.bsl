...
&НаКлиенте
Процедура СтатусРасчетаНДФЛАУСННажатие(Элемент, СтандартнаяОбработка)
	
	СписаниеСРасчетногоСчетаФормыКлиент.СтатусРасчетаНДФЛАУСННажатие(ЭтотОбъект, Элемент, СтандартнаяОбработка);
