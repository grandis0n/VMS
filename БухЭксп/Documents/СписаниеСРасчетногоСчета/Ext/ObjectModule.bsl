...
Процедура ПриЗаписи(Отказ)
	...
	РегистрыСведений.ДокументыНДФЛАУСН.ОбновитьДокументНДФЛАУСНПриЗаписи(ЭтотОбъект, Отказ);
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	// Обновление документа НДФЛ АУСН выполняем всегда для учета возможных изменений в учетной политике.
	РегистрыСведений.ДокументыНДФЛАУСН.ОбновитьДокументНДФЛАУСНПередЗаписью(ЭтотОбъект, Отказ, РежимЗаписи);
...
Процедура ЗаполнитьПоДокументуОснованию(Основание, СуммаКОплате = Неопределено, ДанныеПлПоручение = Неопределено)
	...
	ИначеЕсли ТипЗначенияОснования = Тип("ДокументСсылка.ЗаявлениеОВвозеТоваров") Тогда
		...
		ВидНалога            = Перечисления.ВидыНалогов.ОбеспечительныйПлатежПриВвозеТоваровИзЕАЭС;
