...
&НаСервере
Процедура ОчиститьПанельСоставаПакета()
	
	ЭлементыКУдалению = Новый Массив;
	Для Каждого ПодчиненныйЭлемент Из Элементы.ГруппаСоставПакета.ПодчиненныеЭлементы Цикл
		ЭлементыКУдалению.Добавить(ПодчиненныйЭлемент);
	КонецЦикла;
