...
&НаКлиенте
Процедура СоздатьДокументПоЧерновику(Команда)
	
	ЧерновикиЭДОКлиент.СоздатьДокументПоЧерновику(Объект.Ссылка, Объект.ЧерновикВладелец);
...
Процедура ПриСозданииЧтенииНаСервере()
	...
	НастроитьВидимостьКомандыСозданияДокументаНаОснованииЧерновика();
...
Процедура УстановитьЗаголовокФормы()
	...
	ПараметрыПредставления.ПредставлениеЧерновика = Объект.ПредставлениеЧерновика;
...
&НаСервере
Процедура НастроитьВидимостьКомандыСозданияДокументаНаОснованииЧерновика()
	
	Элементы.КнопкаСоздатьДокументПоЧерновику.Видимость = Ложь;
	...
	Если ТипДокумента <> Перечисления.ТипыДокументовЭДО.Черновик
		Или Не ЗначениеЗаполнено(Объект.ЧерновикВладелец) Тогда
		Возврат;
	КонецЕсли;
	
	РеквизитыЧерновика = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Объект.ЧерновикВладелец,
		"ВидЧерновика.ТипДокумента");
	ТипДокументаЧерновика = РеквизитыЧерновика.ВидЧерновикаТипДокумента;
	
	КомандаВидна = Ложь;
	ЧерновикиЭДО.ПриОпределенииВидимостиКомандыСозданияДокументаНаОснованииЧерновика(КомандаВидна,
		ТипДокументаЧерновика);
		
	Элементы.КнопкаСоздатьДокументПоЧерновику.Видимость = КомандаВидна;
