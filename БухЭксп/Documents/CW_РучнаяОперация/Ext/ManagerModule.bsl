...
Функция ПечатьБухгалтерскаяСправка(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Пока Выборка.СледующийПоЗначениюПоля("Ссылка") Цикл
		...
		ДанныеФизлица = УчетЗарплаты.ДанныеФизическихЛиц(Выборка.Организация, Выборка.Ответственный, Выборка.Дата);
		...
		СведенияОбОрганизации = CW_БухгалтерияЭкспедитораСерверПереопределяемый.СведенияОЮрФизЛице(Выборка.Организация, Выборка.Дата);
