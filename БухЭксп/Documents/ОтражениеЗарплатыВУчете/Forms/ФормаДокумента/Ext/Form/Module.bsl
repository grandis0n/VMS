...
Процедура ОтражениеВУчетеЯвляетсяОснованиемОформленияКассовогоЧекаПриИзменении(Элемент)
	...
	Если Не ДанныеСтроки.ЯвляетсяОснованиемОформленияКассовогоЧека Тогда
		ДанныеСтроки.ОписаниеУдержанияДляЧека = "";
		ДанныеСтроки.ФизическоеЛицо           = "";
		ДанныеСтроки.ВидОперации              = "";
	Иначе
		ДанныеСтроки.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийПоЗарплате.ПрочиеУдержания");
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	// ОтражениеВУчетеФизическоеЛицо, ОтражениеВУчетеОписаниеУдержанияДляЧека, ОтражениеВУчетеВидОперации
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ОтражениеВУчетеВидОперации");
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
	...
	// ОтражениеВУчетеВидОперации

	ЭлементУО = УсловноеОформление.Элементы.Добавить();

	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "ОтражениеВУчетеВидОперации");
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.ПериодРегистрации", ВидСравненияКомпоновкиДанных.Меньше, УчетЗарплаты.ДатаВыделенияВЧекеСотрудникамРасчетовПоПроцентам());
