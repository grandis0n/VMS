...
&НаКлиенте
Процедура ИдентификаторПроизводственнойТранзакцииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	ИнтеграцияВЕТИСКлиентПереопределяемый.НачалоВыбора(ЭтотОбъект, Элемент, ОтборПродукция(Объект), СтандартнаяОбработка);
	
КонецПроцедуры

&НаКлиенте
Процедура ИдентификаторПроизводственнойТранзакцииОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	
	ИнтеграцияВЕТИСКлиентПереопределяемый.ОбработкаВыбора(ЭтотОбъект, Элемент, ВыбранноеЗначение, СтандартнаяОбработка);
	
КонецПроцедуры

&НаКлиенте
Процедура ИдентификаторПроизводственнойТранзакцииСоздание(Элемент, СтандартнаяОбработка)
	
	ИнтеграцияВЕТИСКлиентПереопределяемый.Создание(ЭтотОбъект, Элемент, СтандартнаяОбработка);
