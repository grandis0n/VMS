...
Функция СвойстваУниверсальныхСообщенийЭДО(Сообщения) Экспорт
	...
	ТипыУниверсальныхСообщений.Добавить(Перечисления.ТипыЭлементовРегламентаЭДО.УС_ОтзывЧерновика);
	ТипыУниверсальныхСообщений.Добавить(Перечисления.ТипыЭлементовРегламентаЭДО.УС_ОтправленДокументПоЧерновику);
