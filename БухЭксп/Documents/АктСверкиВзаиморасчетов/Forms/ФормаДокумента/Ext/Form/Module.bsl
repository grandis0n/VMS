...
Процедура АдаптироватьМКШапкаФормы()
	...
	Элементы.СОбособленнымиПодразделениями.ВидФлажка = ВидФлажка.Авто;
	Элементы.СтатусДокумента.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Авто;
	Элементы.СтатусАкта.Ширина = 0;
	Элементы.ГруппаСостояниеЭДО.Группировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяВсегда;
	...
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаПодвал(Элементы,
		Элементы.ГруппаВЭлектронномВиде);
	МобильныйКлиентБПФормаОбъекта.ВстроитьЭлементФормыВГруппаМКФормаПодвал(Элементы,
		Элементы.СтатусАкта);
