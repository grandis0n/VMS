...
Процедура РасшифровкаПлатежаСчетНаОплатуПриИзменении(Элемент)
	ПриходныйКассовыйОрдерФормыКлиент.РасшифровкаПлатежаСчетНаОплатуПриИзменении(ЭтотОбъект, Элемент);
	РасшифровкаПлатежаСчетНаОплатуПриИзмененииНаСервере();
КонецПроцедуры
...
&НаСервере
Процедура РасшифровкаПлатежаСчетНаОплатуПриИзмененииНаСервере()
