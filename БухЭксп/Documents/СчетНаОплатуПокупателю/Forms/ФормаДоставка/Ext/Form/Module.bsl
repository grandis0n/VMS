...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, Параметры,
		"Склад, АдресДоставки, АдресДоставкиЗначение, ТолькоПросмотр, ПараметрыТранспортногоСредства");
	...
	Элементы.ПараметрыТранспортногоСредства.Видимость = Параметры.ПоказыватьРеквизитыЭПД;
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если ПеренестиВДокумент И Модифицированность Тогда
		...
		СтруктураРезультат = Новый Структура("Склад, АдресДоставки, АдресДоставкиЗначение, ПараметрыТранспортногоСредства");
...
&НаКлиенте
Процедура ПараметрыТранспортаНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	ОбменСГИСЭПДБПКлиент.ПараметрыТранспортаНачалоВыбора(ЭтотОбъект, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка);
КонецПроцедуры 

&НаКлиенте
Процедура ПараметрыТранспортаСоздание(Элемент, СтандартнаяОбработка) 
	ОбменСГИСЭПДБПКлиент.ПараметрыТранспортаСоздание(ЭтотОбъект, СтандартнаяОбработка);
КонецПроцедуры
