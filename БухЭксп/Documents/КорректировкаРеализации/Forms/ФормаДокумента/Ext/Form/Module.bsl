...
&НаСервереБезКонтекста
Функция ДоступенВводНаОсновании(ДокументРеализации)
	
	Возврат ЗначениеЗаполнено(ДокументРеализации)
		И Метаданные.Документы.КорректировкаРеализации.ВводитсяНаОсновании.Содержит(ДокументРеализации.Метаданные());
...
Процедура ДокументРеализацииПриИзмененииНаКлиенте()
	...
	Если Объект.КорректироватьБУиНУ Или ДоступенВводНаОсновании(Объект.ДокументРеализации) Тогда
