...
&НаКлиенте
Процедура ТитулЗаказчикаГрузыСопрДокПартВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	Если Поле.Имя = "ЗаполнитьТитулЗаказчикаГрузыРеквизитыСторонСопрДокПарт"  Тогда
