...
&НаКлиенте
Процедура ТитулЗаказчикаИныеДанныеИОговоркиКлиентаПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЗаказчикаИныеДанныеИОговоркиКлиентаПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
