...
&НаКлиенте
Процедура ТитулЗаказчикаОписаниеГрузаКодГрузГНГПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЗаказчикаОписаниеГрузаКодГрузГНГПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
