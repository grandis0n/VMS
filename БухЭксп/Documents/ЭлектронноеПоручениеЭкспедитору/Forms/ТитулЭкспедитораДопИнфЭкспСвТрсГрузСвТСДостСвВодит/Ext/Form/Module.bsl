...
Процедура ХранимыеДанныеВодительПриИзменении(Элемент)  
	...
	ТекущиеДанные = Элементы.ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодит.ТекущиеДанные;
...
&НаКлиенте
Процедура ХранимыеДанныеВодительНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	ОбменСГИСЭПДКлиент.ХранимыеДанныеНачалоВыбора(ЭтотОбъект, Элемент, ДанныеВыбора, СтандартнаяОбработка, Элементы.ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодит.ТекущиеДанные);
КонецПроцедуры
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодитПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодитВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	Если Поле.Имя = "ЗаполнитьТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодитПутевойЛист" Тогда
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодитПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли СтрНачинаетсяС(ИмяСобытия, "Запись_") И Источник <> Неопределено Тогда
		Если ТипЗнч(Источник) = Тип("СправочникСсылка.ХранимыеДанныеЭПД") Тогда
			Для Каждого СтрокаВодитель Из ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодит Цикл
