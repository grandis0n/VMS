...
&НаКлиенте
Процедура ТитулЗаказчикаЗаявкиНаТранспортировкуПередУдалением(Элемент, Отказ)
...
Процедура ЗаполнитьТитулЗаказчикаРеквизитыСторонСопроводительныхДокументовНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЗаказчикаЗаявкиНаТранспортировку.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ТитулЗаказчикаЗаявкиНаТранспортировкуВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)

	Если Поле.Имя = "ЗаполнитьТитулЗаказчикаРеквизитыСторонЗаявокНаТранспортировку" Тогда
...
&НаКлиенте
Процедура ТитулЗаказчикаЗаявкиНаТранспортировкуПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
