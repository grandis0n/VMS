...
Процедура Сохранить(Команда)
	...
	НайденныеСтроки = ТитулЗаказчикаОписаниеГрузаСвОпаснГруз.НайтиСтроки(Отбор);
...
Процедура СсылкаДОПОГПриИзменении(Элемент)
	ОбменСГИСЭПДКлиентСервер.ЗаполнитьРеквизитыПоСсылке(Элемент, ЭтотОбъект, Элементы.ТитулЗаказчикаОписаниеГрузаСвОпаснГруз.ТекущиеДанные);
КонецПроцедуры  

&НаКлиенте
Процедура ТитулТитулЗаказчикаОписаниеГрузаСвОпаснГрузПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулТитулЗаказчикаОписаниеГрузаСвОпаснГрузПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
