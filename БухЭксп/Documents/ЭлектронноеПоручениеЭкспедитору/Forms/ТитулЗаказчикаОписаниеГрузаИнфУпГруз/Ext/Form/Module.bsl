...
Процедура Сохранить(Команда) 
	...
	НайденныеСтроки = ТитулЗаказчикаОписаниеГрузаИнфУпГруз.НайтиСтроки(Отбор);
...
&НаКлиенте
Процедура ТитулЗаказчикаОписаниеГрузаИнфУпГрузПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЗаказчикаОписаниеГрузаИнфУпГрузПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
