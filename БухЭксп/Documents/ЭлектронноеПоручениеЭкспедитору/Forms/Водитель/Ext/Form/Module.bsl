...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбменСГИСЭПД.СоздатьЭлементыВводаЗначенийСписка(ЭтотОбъект, "ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодитНомераТелефонов", "Телефон");
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодитНомераТелефоновПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодитНомераТелефоновПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
