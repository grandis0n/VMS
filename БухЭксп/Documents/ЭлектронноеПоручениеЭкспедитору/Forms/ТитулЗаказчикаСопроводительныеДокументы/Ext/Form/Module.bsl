...
Процедура Сохранить(Команда) 
	...
	ТитулЗаказчикаДокГруз = ТитулЗаказчикаСопроводительныеДокументы.Количество() > 0;
...
&НаКлиенте
Процедура ТитулЗаказчикаСопроводительныеДокументыПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ЗаполнитьТитулЗаказчикаРеквизитыСторонСопроводительныхДокументовНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЗаказчикаСопроводительныеДокументы.ТекущиеДанные);
	
КонецПроцедуры

&НаКлиенте
Процедура ТитулЗаказчикаСопроводительныеДокументыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)

	Если Поле.Имя = "ЗаполнитьТитулЗаказчикаРеквизитыСторонСопроводительныхДокументов" Тогда
...
&НаКлиенте
Процедура ТитулЗаказчикаСопроводительныеДокументыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
