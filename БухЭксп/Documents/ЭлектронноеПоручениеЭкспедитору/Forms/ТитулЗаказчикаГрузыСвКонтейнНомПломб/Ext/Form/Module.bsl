...
Процедура Сохранить(Команда) 
	...
	НайденныеСтроки = ТитулЗаказчикаГрузыСвКонтейнНомПломб.НайтиСтроки(Отбор);
...
&НаКлиенте
Процедура ТитулЗаказчикаГрузыСвКонтейнНомПломбПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	ОбменСГИСЭПДКлиент.ТаблицаПриНачалеРедактирования(Элемент, ЭтотОбъект, НоваяСтрока, Копирование)
КонецПроцедуры

&НаКлиенте
Процедура ТитулЗаказчикаГрузыСвКонтейнНомПломбПередУдалением(Элемент, Отказ)
