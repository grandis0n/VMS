...
&НаКлиенте
Процедура ТитулЗаказчикаОписаниеГрузаКодГрузЕТСНГПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЗаказчикаОписаниеГрузаКодГрузЕТСНГПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
