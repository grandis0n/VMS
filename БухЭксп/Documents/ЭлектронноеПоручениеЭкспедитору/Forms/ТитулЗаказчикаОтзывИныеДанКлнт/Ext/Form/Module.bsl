...
&НаКлиенте
Процедура ТитулЗаказчикаОтзывИныеДанКлнтПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЗаказчикаОтзывИныеДанКлнтПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
