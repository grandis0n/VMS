...
&НаКлиенте
Процедура ТитулЗаказчикаОписаниеГрузаНомКонтейнПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЗаказчикаОписаниеГрузаНомКонтейнПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
