...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспРеквЗакПостПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспРеквЗакПостВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)

	Если Поле.Имя = "ЗаполнитьТитулЭкспедитораДопИнфЭкспРеквЗакПостРеквИдРекСост" Тогда
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспРеквЗакПостПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
