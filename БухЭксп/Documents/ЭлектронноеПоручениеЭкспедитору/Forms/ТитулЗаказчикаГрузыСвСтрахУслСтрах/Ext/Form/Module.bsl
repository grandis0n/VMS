...
&НаКлиенте
Процедура ТитулЗаказчикаГрузыСвСтрахУслСтрахПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЗаказчикаГрузыСвСтрахУслСтрахПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
