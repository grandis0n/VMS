...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЗаказчикаДоговорРеквизитыСторон.ТекущиеДанные);
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументОткрытие(Элемент, СтандартнаяОбработка)
	...
	Если ТипЗнч(Элементы.ТитулЗаказчикаДоговорРеквизитыСторон.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент) <> Тип("СправочникСсылка.ХранимыеДанныеЭПД") Тогда
		СтандартнаяОбработка = Ложь;
		ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЗаказчикаДоговорРеквизитыСторон.ТекущиеДанные, Ложь);
	КонецЕсли;
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулЗаказчикаДоговорРеквизитыСторон.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	...
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулЗаказчикаДоговорРеквизитыСторон.ТекущиеДанные);
