...
&НаКлиенте
Процедура ТитулЗаказчикаГрузыРеквЗакПостВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	Если Поле.Имя = "ЗаполнитьТитулЗаказчикаГрузыРеквизитыСторонРеквЗакПост"  Тогда
