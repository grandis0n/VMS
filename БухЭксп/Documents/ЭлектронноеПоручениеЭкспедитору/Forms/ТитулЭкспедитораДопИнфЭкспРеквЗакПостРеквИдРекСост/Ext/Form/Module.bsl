...
Процедура ХранимыеДанныеТитулГрузоотправителяСторонаСопроводительныхДокументовНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЭкспедитораДопИнфЭкспРеквЗакПостРеквИдРекСост.ТекущиеДанные);
...
Процедура ХранимыеДанныеТитулГрузоотправителяСторонаСопроводительныхДокументовПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулЭкспедитораДопИнфЭкспРеквЗакПостРеквИдРекСост.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулЭкспедитораДопИнфЭкспРеквЗакПостРеквИдРекСост.ТекущиеДанные);
