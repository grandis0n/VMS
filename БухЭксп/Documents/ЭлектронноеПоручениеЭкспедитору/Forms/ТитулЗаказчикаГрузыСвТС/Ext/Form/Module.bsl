...
&НаКлиенте
Процедура ТитулЗаказчикаГрузыСвТСВидТСПриИзменении(Элемент)
	ТекущиеДанные = Элементы.ТитулЗаказчикаГрузыСвТС.ТекущиеДанные;
	Если ТекущиеДанные <> Неопределено 
		И ТекущиеДанные.ВидТС <> "1" Или ТекущиеДанные.ВидТС <> "4" Тогда	
		ТекущиеДанные.ТипКузов = Неопределено;		
	КонецЕсли;
