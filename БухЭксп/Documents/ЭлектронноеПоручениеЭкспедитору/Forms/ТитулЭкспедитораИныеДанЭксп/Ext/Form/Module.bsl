...
&НаКлиенте
Процедура ТитулЭкспедитораИныеДанЭкспПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораИныеДанЭкспПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
