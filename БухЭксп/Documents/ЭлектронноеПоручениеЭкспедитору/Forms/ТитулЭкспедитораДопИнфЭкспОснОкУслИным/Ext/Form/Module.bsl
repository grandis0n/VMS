...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспЗаполнитьОснОкУслИнымПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспЗаполнитьОснОкУслИнымПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЭкспедитораДопИнфЭкспОснОкУслИнымРеквИдРекСост.ТекущиеДанные);
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументОткрытие(Элемент, СтандартнаяОбработка)
	...
	Если ТипЗнч(Элементы.ТитулЭкспедитораДопИнфЭкспОснОкУслИнымРеквИдРекСост.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент) <> Тип("СправочникСсылка.ХранимыеДанныеЭПД") Тогда
		СтандартнаяОбработка = Ложь;
		ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЭкспедитораДопИнфЭкспОснОкУслИнымРеквИдРекСост.ТекущиеДанные, Ложь);
	КонецЕсли;
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулЭкспедитораДопИнфЭкспОснОкУслИнымРеквИдРекСост.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	...
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулЭкспедитораДопИнфЭкспОснОкУслИнымРеквИдРекСост.ТекущиеДанные);
