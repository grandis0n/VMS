...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЭкспедитораДопИнфЭкспСвОплатаДокОплУслРеквИдРекСост.ТекущиеДанные);
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументОткрытие(Элемент, СтандартнаяОбработка)
	...
	Если ТипЗнч(Элементы.ТитулЭкспедитораДопИнфЭкспСвОплатаДокОплУслРеквИдРекСост.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент) <> Тип("СправочникСсылка.ХранимыеДанныеЭПД") Тогда
		СтандартнаяОбработка = Ложь;
		ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЭкспедитораДопИнфЭкспСвОплатаДокОплУслРеквИдРекСост.ТекущиеДанные, Ложь);
	КонецЕсли;
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулЭкспедитораДопИнфЭкспСвОплатаДокОплУслРеквИдРекСост.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	...
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулЭкспедитораДопИнфЭкспСвОплатаДокОплУслРеквИдРекСост.ТекущиеДанные);
