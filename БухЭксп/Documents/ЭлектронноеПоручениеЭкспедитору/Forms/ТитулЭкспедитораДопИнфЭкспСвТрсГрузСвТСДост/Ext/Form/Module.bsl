...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)

	Если Поле.Имя = "ЗаполнитьТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостСвВодит" Тогда
...
&НаКлиенте
Процедура ТитулЭкспедитораДопИнфЭкспСвТрсГрузСвТСДостПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
