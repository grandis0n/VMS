...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ВидыОпераций = Перечисления.CW_ВидыОперацийДДС.ПолучитьСписокВидовОпераций();
	...
	Документы.CW_ДвижениеДенежныхСредств.ПолучитьСоответствиеВидовОперацийФормам());
...
Процедура ОткрытьДокументВида(ВыбранныйВидОперации)
	...
	ОткрытьФорму("Документ.CW_ДвижениеДенежныхСредств.Форма."+ ФормыДокумента[ВыбранныйВидОперации], СтруктураПараметров, ВладелецФормы);
