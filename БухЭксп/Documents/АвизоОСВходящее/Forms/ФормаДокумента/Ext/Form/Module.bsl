...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	ИначеЕсли ИсточникВыбора.ИмяФормы = "Документ.АвизоОСВходящее.Форма.ФормаРедактированияСтроки" Тогда
...
Процедура ИзменениеСтрокиОС(ЭтоНовый = Ложь, Копирование = Ложь)
	...
	ФормаРедактированияСтроки = ОткрытьФорму("Документ.АвизоОСВходящее.Форма.ФормаРедактированияСтроки",
...
Процедура ОснованиеПриИзмененииНаСервере()
	...
	Документы.АвизоОСВходящее.ЗаполнитьПоАвизоОСИсходящее(Объект, Объект.ДокументОснование);
