...
Процедура ЗадолженностьКонтрагента(СтруктураПараметров, АдресХранилища) Экспорт
	...
	Запрос.Текст =
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ВТ_ОстаткиВзаиморасчетов.СчетУчетаРасчетов КАК СчетУчетаРасчетов,
		|	ВТ_ОстаткиВзаиморасчетов.Сделка КАК Сделка,
		|	ВТ_ОстаткиВзаиморасчетов.Сумма КАК Сумма
		|ИЗ
		|	ВТ_ОстаткиВзаиморасчетов КАК ВТ_ОстаткиВзаиморасчетов
		|ГДЕ
		|	ВТ_ОстаткиВзаиморасчетов.Сумма > 0";
