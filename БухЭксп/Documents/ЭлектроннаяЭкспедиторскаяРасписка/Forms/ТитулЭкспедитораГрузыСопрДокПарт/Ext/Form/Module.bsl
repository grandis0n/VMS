...
&НаКлиенте
Процедура ТитулЭкспедитораГрузыСопрДокПартВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	Если Поле.Имя = "ЗаполнитьТитулЭкспедитораГрузыРеквизитыСторонСопрДокПарт"  Тогда
