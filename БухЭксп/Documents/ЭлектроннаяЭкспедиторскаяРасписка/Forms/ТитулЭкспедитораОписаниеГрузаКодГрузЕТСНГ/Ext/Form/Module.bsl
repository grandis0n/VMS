...
&НаКлиенте
Процедура ТитулЭкспедитораОписаниеГрузаКодГрузЕТСНГПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораОписаниеГрузаКодГрузЕТСНГПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
