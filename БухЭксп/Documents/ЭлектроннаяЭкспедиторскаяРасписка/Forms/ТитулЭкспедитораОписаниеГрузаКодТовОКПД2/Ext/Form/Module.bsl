...
&НаКлиенте
Процедура ТитулЗаказчикаОписаниеГрузаКодТовОКПД2ПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЗаказчикаОписаниеГрузаКодТовОКПД2ПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
