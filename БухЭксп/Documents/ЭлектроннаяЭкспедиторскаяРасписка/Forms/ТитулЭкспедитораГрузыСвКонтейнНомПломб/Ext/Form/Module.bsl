...
Процедура Сохранить(Команда) 
	...
	НайденныеСтроки = ТитулЭкспедитораГрузыСвКонтейнНомПломб.НайтиСтроки(Отбор);

	КолПломб = НайденныеСтроки.Количество();
...
&НаКлиенте
Процедура ТитулЭкспедитораГрузыСвКонтейнНомПломбПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	ОбменСГИСЭПДКлиент.ТаблицаПриНачалеРедактирования(Элемент, ЭтотОбъект, НоваяСтрока, Копирование)
КонецПроцедуры

&НаКлиенте
Процедура ТитулЭкспедитораГрузыСвКонтейнНомПломбПередУдалением(Элемент, Отказ)
