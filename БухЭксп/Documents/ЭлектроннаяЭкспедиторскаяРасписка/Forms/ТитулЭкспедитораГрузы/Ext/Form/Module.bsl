...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ФормаБезОбработки") = Ложь И  ЭтотОбъект.ЗапретитьИзменение = Ложь Тогда 
		...
		Элементы.ТитулЭкспедитораГрузыИдентПартГруз.ОграничениеТипа = ОписаниеСтрокИдентификатор;
...
&НаКлиенте
Процедура ТитулЭкспедитораГрузыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
		
	ИменаПолей = Новый Массив;
	ИменаПолей.Добавить("ЗаполнитьТитулЭкспедитораГрузыСвКонтейн");
	ИменаПолей.Добавить("ЗаполнитьТитулЭкспедитораГрузыСопрДокПарт");
	ИменаПолей.Добавить("ЗаполнитьТитулЭкспедитораГрузыРеквЗакПост");
	ИменаПолей.Добавить("ЗаполнитьТитулЭкспедитораОписаниеГруза"); 
	ИменаПолей.Добавить("ЗаполнитьТитулЭкспедитораГрузыУслПриемОбязЭксп"); 
...
&НаКлиенте
Процедура ТитулЭкспедитораГрузыПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораГрузыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли СтрНачинаетсяС(ИмяСобытия, "Запись_") Тогда
		Если ТипЗнч(Источник) = Тип("СправочникСсылка.КлассификаторДОПОГЭПД") Тогда
			Для Каждого СтрокаГруз Из ТитулЭкспедитораГрузы Цикл
