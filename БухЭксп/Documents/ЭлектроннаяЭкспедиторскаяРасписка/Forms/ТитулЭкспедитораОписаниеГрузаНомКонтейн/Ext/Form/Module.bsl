...
&НаКлиенте
Процедура ТитулЭкспедитораОписаниеГрузаНомКонтейнПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораОписаниеГрузаНомКонтейнПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
