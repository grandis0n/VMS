...
&НаКлиенте
Процедура ТитулЭкспедитораОписаниеГрузаКодГрузГНГПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораОписаниеГрузаКодГрузГНГПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
