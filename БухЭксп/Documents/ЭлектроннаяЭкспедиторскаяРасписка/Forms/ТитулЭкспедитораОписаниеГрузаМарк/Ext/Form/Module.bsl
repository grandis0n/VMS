...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ТитулЭкспедитораОписаниеГрузаМаркМаркировка.СписокВыбора.ЗагрузитьЗначения(ОбменСГИСЭПДКлиентСервер.ПолучитьМассивМаркировокГруза());
...
Процедура Сохранить(Команда)
	...
	НайденныеСтроки = ТитулЭкспедитораОписаниеГрузаМарк.НайтиСтроки(Отбор); 
	
	Если НайденныеСтроки.Количество() > 1 Тогда
		Для Каждого Строка Из НайденныеСтроки Цикл
			Если Строка.Маркировка = "Отсутствует" Тогда
				ТитулЭкспедитораОписаниеГрузаМарк.Удалить(Строка);	
			КонецЕсли;     
		КонецЦикла;
	КонецЕсли;
...
&НаКлиенте
Процедура ТитулЭкспедитораОписаниеГрузаМаркПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ТитулЭкспедитораОписаниеГрузаМаркПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
