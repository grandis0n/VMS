...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ФормаБезОбработки") = Ложь И ЭтотОбъект.ЗапретитьИзменение = Ложь Тогда
		...
		Элементы.ТитулЭкспедитораГрузыСвКонтейнИСОКонтейн.ОграничениеТипа = ОписаниеСтрокИСО;
		
		ОписаниеСтрокИдКонтейнМежд = Новый ОписаниеТипов("Строка",,Новый КвалификаторыСтроки(11,ДопустимаяДлина.Фиксированная));
		Элементы.ТитулЭкспедитораГрузыСвКонтейнИдКонтейнМежд.ОграничениеТипа = ОписаниеСтрокИдКонтейнМежд;
	КонецЕсли;
...
Процедура Сохранить(Команда) 
	...
	НайденныеСтроки = ТитулЭкспедитораГрузыСвКонтейн.НайтиСтроки(Отбор);
...
Процедура ПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если НоваяСтрока Тогда   
		...
		ТекущиеДанные.НомКонтейн = ПолучитьНовыйПорядковыйНомерДляКонтейнеров(ЭтотОбъект.ИдентификаторСтрокиРодителя, 
			ТитулЭкспедитораГрузыСвКонтейн);
...
&НаКлиенте
Процедура ТитулЭкспедитораГрузыСвКонтейнИдКонтейнМеждПриИзменении(Элемент)
	ТекущиеДанные = Элементы.ТитулЭкспедитораГрузыСвКонтейн.ТекущиеДанные;
	Если ТекущиеДанные <> Неопределено Тогда
...
&НаКлиенте
Процедура ТитулЭкспедитораГрузыСвКонтейнИдКонтейнНестПриИзменении(Элемент)
	ТекущиеДанные = Элементы.ТитулЭкспедитораГрузыСвКонтейн.ТекущиеДанные;
	Если ТекущиеДанные <> Неопределено Тогда
...
Процедура ТитулЗаказчикаГрузыСвКонтейнВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ЗаполнитьТитулЭкспедитораГрузыСвКонтейнНомПломб"  Тогда
