...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЭкспедитораСвЛицПогрГрРеквДокЛицоРеквизитыСторон.ТекущиеДанные);
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументОткрытие(Элемент, СтандартнаяОбработка)
	...
	Если ТипЗнч(Элементы.ТитулЭкспедитораСвЛицПогрГрРеквДокЛицоРеквизитыСторон.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент) <> Тип("СправочникСсылка.ХранимыеДанныеЭПД") Тогда
		СтандартнаяОбработка = Ложь;
		ОбменСГИСЭПДКлиент.ВывестиФормуВводаДанных(ЭтотОбъект, Элемент.Имя, Элементы.ТитулЭкспедитораСвЛицПогрГрРеквДокЛицоРеквизитыСторон.ТекущиеДанные, Ложь);
	КонецЕсли;
...
Процедура ХранимыеДанныеСторонаПодписавшаяДокументПриИзменении(Элемент)
	...
	ЗначениеРеквизита = Элементы.ТитулЭкспедитораСвЛицПогрГрРеквДокЛицоРеквизитыСторон.ТекущиеДанные.ХранимыеДанныеСторонаПодписавшаяДокумент;
	...
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		...
		ВходящийКонтекст.Вставить("ТекущиеДанные", Элементы.ТитулЭкспедитораСвЛицПогрГрРеквДокЛицоРеквизитыСторон.ТекущиеДанные);
...
&НаКлиенте
Процедура ТитулЭкспедитораСвЛицПогрГрЛицоПогрузПриИзменении(Элемент)
	
	Если ТитулЭкспедитораСвЛицПогрГрЛицоПогруз = "1" Тогда  
		
		ТитулЭкспедитораСвЛицПогрГрРеквДокЛицоДатаДокумента = Неопределено;
		ТитулЭкспедитораСвЛицПогрГрРеквДокЛицоДополнительныеСведения  = Неопределено;
		ТитулЭкспедитораСвЛицПогрГрРеквДокЛицоНаименованиеДокумента  = Неопределено;
		ТитулЭкспедитораСвЛицПогрГрРеквДокЛицоНомерДокумента  = Неопределено;
		
		ТитулЭкспедитораСвЛицПогрГрРеквДокЛицоРеквизитыСторон.Очистить();
