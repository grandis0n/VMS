...
Функция СформироватьПечатнуюФормуЭД(СообщениеОбмена, СсылкаНаДвоичныеДанныеФайла, ИдентификаторПечати, ДляПечати)
	...
	РеквизитыСообщенияОбмена = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
		СообщениеОбмена, "Идентификатор, ВидЭД, ФорматФайла, ПрограммаБанка");
	
	Если ОбменСБанкамиСлужебный.ЭтоЗарплатныйПроект(РеквизитыСообщенияОбмена.ВидЭД) Тогда
		
		ТабличныйДокументЗП = ТабличныйДокументЗарплатногоПроекта(СсылкаНаДвоичныеДанныеФайла, РеквизитыСообщенияОбмена.ПрограммаБанка);
...
Функция ТабличныйДокументЗарплатногоПроекта(СсылкаНаДвоичныеДанныеФайла, ПрограммаБанка)
	
	ДанныеЭД = ПолучитьИзВременногоХранилища(СсылкаНаДвоичныеДанныеФайла);
	Если ПрограммаБанка = Перечисления.ПрограммыБанка.SberAPI Тогда
