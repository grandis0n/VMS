...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, ДополнительныеСвойства, Отказ) Экспорт
	...
	ПараметрыПроведения.Вставить(
		"СозданПомощникомПереходаНаОСНО", СозданПомощникомПереходаНаОСНО(ДокументСсылка, ДополнительныеСвойства));
...
Процедура СформироватьДвижения_ОС(
	...
	Если Реквизиты.ОтражатьПоСпециальнымРегистрам И ПараметрыПроведения.СозданПомощникомПереходаНаОСНО Тогда
	...
	ИначеЕсли Реквизиты.ОтражатьПоСпециальнымРегистрам Тогда
...
Процедура СформироватьДвижения_НДСПоАвансам(
	...
	ПлательщикНДС = УчетнаяПолитика.ПлательщикНДС(Реквизиты.Организация, Реквизиты.Период + 86400)
		Или УчетнаяПолитика.ПлательщикНДСПрименяющийУСН(Реквизиты.Организация, Реквизиты.Период + 86400);
...
Функция СозданПомощникомПереходаНаОСНО(ДокументСсылка, ДополнительныеСвойства)
	
	ЕстьРеквизитСозданПомощникомПереходаНаОСНО = ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(
		ДополнительныеСвойства, "СозданПомощникомПереходаНаОСНО");
	Если ЕстьРеквизитСозданПомощникомПереходаНаОСНО Тогда
		Результат = Истина;
	Иначе
		Результат = Обработки.ПомощникПереходаСУСННаОСНО.ДокументСозданПомощником(ДокументСсылка);
	КонецЕсли;
