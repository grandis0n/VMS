...
Процедура УправлениеФормой(Форма)
	...
	ДокументСозданПомощникомПереходаНаОСНО = Форма.ДокументСозданПомощникомПереходаНаОСНО;
	Форма.Элементы.ГруппаБухгалтерскийУчет.Видимость = Не ДокументСозданПомощникомПереходаНаОСНО;
	Форма.Элементы.ИнвентарныйНомерРегл.Видимость = Не ДокументСозданПомощникомПереходаНаОСНО;
	Форма.Элементы.ГруппаСобытия.Видимость = Не ДокументСозданПомощникомПереходаНаОСНО;
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДокументСозданПомощникомПереходаНаОСНО = Параметры.ДокументСозданПомощникомПереходаНаОСНО;
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ДокументСозданПомощникомПереходаНаОСНО Тогда
		МассивНепроверяемыхРеквизитов.Добавить("СпособНачисленияАмортизацииБУ");
		МассивНепроверяемыхРеквизитов.Добавить("ИнвентарныйНомерРегл");
		МассивНепроверяемыхРеквизитов.Добавить("СрокПолезногоИспользованияБУ");
		МассивНепроверяемыхРеквизитов.Добавить("ПорядокВключенияСтоимостиВСоставРасходовНУ");
		МассивНепроверяемыхРеквизитов.Добавить("ПервоначальнаяСтоимостьБУ");
		МассивНепроверяемыхРеквизитов.Добавить("ТекущаяСтоимостьБУ");
		МассивНепроверяемыхРеквизитов.Добавить("ПорядокПогашенияСтоимостиБУ");
		МассивНепроверяемыхРеквизитов.Добавить("ПараметрВыработкиБУ");
		МассивНепроверяемыхРеквизитов.Добавить("ОбъемПродукцииРаботБУ");
		МассивНепроверяемыхРеквизитов.Добавить("КоэффициентАмортизацииБУ");
		МассивНепроверяемыхРеквизитов.Добавить("НомерДокументаПринятияКУчетуРегл");
		МассивНепроверяемыхРеквизитов.Добавить("СостояниеПринятияКУчетуРегл");
		МассивНепроверяемыхРеквизитов.Добавить("СпособНачисленияАмортизацииБУ");
		МассивНепроверяемыхРеквизитов.Добавить("ДатаПринятияКУчетуРегл");
		МассивНепроверяемыхРеквизитов.Добавить("НазваниеДокументаПринятияКУчетуРегл");
	КонецЕсли;
