...
Функция ТекстЗапросаДанныеДляПечатиЧека(ИменаТаблиц) Экспорт
	...
	|	НЕОПРЕДЕЛЕНО КАК ДоговорПлатежногоАгента,
	|	НЕОПРЕДЕЛЕНО КАК ПлатежныйАгент,
	|	ОписаниеНоменклатурыИС.КлючВидовПродукции.ВидПродукцииГИСМТ <> ЗНАЧЕНИЕ(Справочник.ВидыПродукцииИС.ПустаяСсылка) КАК МаркируемаяПродукция
	...
	|	ВТ_ОплачиваемаяНоменклатура.МаркируемаяПродукция КАК МаркируемаяПродукция,
	...
	|	ВТ_ОплачиваемаяНоменклатура.МаркируемаяПродукция
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
