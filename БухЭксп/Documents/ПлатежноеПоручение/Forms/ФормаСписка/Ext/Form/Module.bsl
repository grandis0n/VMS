...
Процедура СогласованиеПлатежей(Команда)
	...
	Иначе
		...
		Если ТекущаяСтрока <> Неопределено Тогда
			ПараметрыОткрытия.Вставить("Организация", ТекущаяСтрока.Организация);
		КонецЕсли;
	КонецЕсли;
	...
	Иначе
		ТекущаяСтрока = Элементы.Список.ТекущиеДанные;
		Если ТекущаяСтрока <> Неопределено Тогда
			ПараметрыОткрытия.Вставить("БанковскийСчет", ТекущаяСтрока.СчетОрганизации);
		КонецЕсли;	
	КонецЕсли;
...
Процедура АдаптироватьМКСписокФормы()
	...
	Элементы.НазначениеПлатежа.Ширина = 0;
	Элементы.НазначениеПлатежа.РастягиватьПоГоризонтали = Истина;
