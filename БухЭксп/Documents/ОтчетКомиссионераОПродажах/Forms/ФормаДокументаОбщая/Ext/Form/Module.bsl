...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НастроитьЭлементыРедактированияСчетаФактуры(ЭтотОбъект);
...
Процедура УправлениеФормой(Форма)
	...
	НастроитьЭлементыРедактированияСчетаФактуры(Форма);
		
	Элементы.СчетФактураРедактирование.Видимость = Объект.СпособРасчетаКомиссионногоВознаграждения
...
&НаКлиентеНаСервереБезКонтекста
Процедура НастроитьЭлементыРедактированияСчетаФактуры(Форма)
	
	Элементы = Форма.Элементы;
	Объект = Форма.Объект;
	
	Элементы.СчетФактураРедактирование.Видимость = (Форма.ИтогВсегоВознаграждение <> 0);
