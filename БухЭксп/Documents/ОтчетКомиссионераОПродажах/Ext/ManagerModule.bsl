...
Процедура ЗаполнитьСтрокиТЧЗагрузкаИзФайла(ТаблицаТовары, ИмяТаблицы, ДанныеОбъекта)
	...
	Для Каждого СтрокаТовара Из ТаблицаТовары Цикл
		...
		Если ДанныеОбъекта.ВидОперации = Перечисления.ВидыОперацийОтчетКомиссионера.ОтчетОбОприходовании
			ИЛИ ДанныеОбъекта.ВидОперации = Перечисления.ВидыОперацийОтчетКомиссионера.ОтчетОСписании Тогда
			СтрокаТовара.СтавкаНДС = Перечисления.СтавкиНДС.БезНДС;
		КонецЕсли;
