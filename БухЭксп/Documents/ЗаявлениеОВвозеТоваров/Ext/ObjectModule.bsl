...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Документы.ЗаявлениеОВвозеТоваров.СоздатьНалогиПоКБК(
		ПараметрыПроведения.ТаблицаСозданиеНалогов);
	...
	// Учет акцизов
	УчетАкцизов.СформироватьДвиженияНачисленияАкцизовПриВвозеИзЕАЭС(
