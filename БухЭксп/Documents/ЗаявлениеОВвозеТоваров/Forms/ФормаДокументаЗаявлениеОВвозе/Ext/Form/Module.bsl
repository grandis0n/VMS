...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	ДанныеСтрокиТаблицы = Новый Структура(
		...
		|КоэффициентПересчета,ОкруглятьДоЦелого,ПодакцизныйТовар,СубконтоАкцизы,КодВидаПодакцизногоТовара,КБК,МаркируемаяПродукция,
...
Процедура ОбработкаВыбораАкцизы(ВыбранноеЗначение)
	...
	ДанныеСтрокиТаблицы = Новый Структура(
		"ДатаПринятияНаУчет,ФактурнаяСтоимость,НалоговаяБазаНДС,СтавкаНДС,СуммаНДС,СтатСтоимостьДолларыСША,КодВидаПодакцизногоТовара,КБК,МаркируемаяПродукция,
		|НалоговаяБазаАкцизы,ЕдиницаИзмеренияАкциза,ТвердаяСтавкаАкциза,АдвалорнаяСтавкаАкциза,СуммаАкциза,АналитикаАкциза");
