...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Договоры.Количество() = 0 И Объект.ПлатежныеПоручения.Количество() = 0 Тогда
...
Процедура ДоговорыПредставлениеЗначенийРеквизитовНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОткрытьФорму("ПланОбмена.ОбменБухгалтерияПредприятияДокументооборот20.Форма.ФормаВыбораЗначенийРеквизитов",
