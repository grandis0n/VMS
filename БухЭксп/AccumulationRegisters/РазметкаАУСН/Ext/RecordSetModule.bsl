...
Функция ПрошлыйНаборЗаписей(МетаданныеРегистра, Замещение)
	...
	Для Каждого Запись Из НаборЗаписей Цикл
		Операция = Запись.БанковскаяОперация;
		Если ЗначениеЗаполнено(Операция) И БанковскиеОперации.Найти(Операция) = Неопределено Тогда
			БанковскиеОперации.Добавить(Операция);
		КонецЕсли;
	КонецЦикла;
